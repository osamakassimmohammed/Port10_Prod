...
class Pdf_create {
	...
	$this->order_datetime = date('Y-m-d H:i:s');
		...
		public function get_print_pdf_list($order_id)
		{
			...
			extract($data);
			$transaction = $shipp = 0;$item_vendor = $payment_mode = '';
				...
				<table>
					...
					<thead>
						<tr>
							...
							?> 
							<th style="text-align: left;" colspan="5">Name : <?php echo $name; ?></th>
						...
						<td colspan="3">
							<p><?php echo $data[0]['address_1']  ?> , <?php echo $data[0]['address_1']  ?>, <?php echo $data[0]['address_2']  ?>, <?php echo $data[0]['state']  ?>, <?php echo $data[0]['pincode']  ?> </p>
						</td>
					...
					<tbody>
						...
						<tr>
							...
							<!-- <td style="display: none"><?php //echo $product_cust_data; ?></td> -->
		...
		<html>
		   ...
		   <body>
		      <div style="text-align: center; background: #f3f3f3; " >
		         <div style="width: 96%;; background: #fff; box-shadow: 0px 0px 4px 1px #cccccc25; display: inline-block; margin: 20px 0px; padding: 0px 15px 10px 15px; border-radius: 8px; border-top: 5px solid #3f006f; border-bottom: 5px solid #3f006f; " >
		            ...
		            <div style="float: left;width: 45%; text-align: left;  " >
		               <div style="width: 100%;">
		                  ...
		                  <div style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; " > <?php echo $orders_invoice[0]['order_no']; ?> </div>
		               </div>
		            </div>
		            <div style="float: right;width: 25%; text-align: left;  " >
		               <div style="width: 100%;">
		                  ...
		                  <div style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; " > <?php echo date('M-d-Y' ,strtotime($orders_invoice[0]['created_date'])); ?> </div>
		               </div>
		            </div>
		            <div style="clear:both;"></div>
		            <div style="width: 100%;">
		               <div style="width: 100%; font-weight: 600; margin-top: 30px;" >  <?php echo lang('INVOICE'); ?>  </div>
		            ...
		            <div style="margin-top: 20px; margin-bottom: 30px; " >
		               ...
		               <div style="float: right;width: 45%; text-align: left;  " >
		                  <div style="width: 100%;">
		                     ...
		                     <div style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; " > <?php echo $currency; ?> <?php echo $orders_invoice[0]['in_sub_total']; ?> </div>
		                  </div>
		               </div>
		               <div style="clear: both;"></div>
		            </div>
		            <div style="margin-top: 20px; margin-bottom: 40px; " >
		               ...
		               <?php if(!empty($order))
	    					{ ?>
		               <a href="<?php echo base_url($language.'/admin/invoice/order_invoice/').$orders_invoice[0]['order_no'] ?>" style="display: inline-block; background: #dadada; margin-top: 30px; text-decoration: none; padding: 12px 18px; font-size: 14px; font-weight: 600; border-radius: 3px; color: #353535; " > <?php echo lang('aDownload_Invoice'); ?> </a>
               			<div style="clear: both;"></div>
               		<?php  } ?>
		            </div>
		         </div>
