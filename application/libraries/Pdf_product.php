...
class Pdf_product
{
        ...
        <div class="container">
            <table>
                <caption style="line-height: 1;color: #5b5b5b;">
                    ...
                    <br>
                    Order invoice <a style="text-decoration:none"
                                     href="<?php echo base_url('invoice/product/') . $item_id ?>">Download
                        Invoice</a>
                </caption>
                <thead>
                <tr>
                    <th style="text-align: left;" colspan="4">Name
                        : <?php echo $order_items[0]['first_name'] . ' ' . $order_items[0]['last_name']; ?></th>
                    <th colspan="2">Transaction
                        Reference: <?php echo $order_items[0]['trans_ref']; ?></th>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4"><?php echo $order_items[0]['product_name']; ?>
                        (<?php echo $order_items[0]['unit_name']; ?>)
                    </td>
    ...
    public function get_print_pdf_new($order_items, $order, $item_id)
    {
        ...
        <div style="text-align: center; background: #f3f3f3; ">
            <div
                style="width: 100%; background: #fff; box-shadow: 0px 0px 4px 1px #cccccc25; display: inline-block; margin: 20px 0px; padding: 0px 15px 10px 15px; border-radius: 8px; border-top: 5px solid #3f006f; border-bottom: 5px solid #3f006f; ">
                ...
                <div style="float: left;width: 45%; text-align: left;  ">
                    <div style="width: 100%;">
                        ...
                        <div
                            style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; "> <?php echo $order_items[0]['item_id']; ?> </div>
                    </div>
                </div>
                <div style="float: right;width: 25%; text-align: left;  ">
                    <div style="width: 100%;">
                        ...
                        <div
                            style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; "> <?php echo date('M-d-Y', strtotime($order_items[0]['created_date'])); ?> </div>
                    </div>
                </div>
                ...
                <div style="margin-top: 20px; margin-bottom: 30px; ">
                    ...
                    <div style="float: right;width: 45%; text-align: left;  ">
                        <div style="width: 100%;">
                            ...
                            <div
                                style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; "><?php echo $currency; ?><?php echo $order_items[0]['sub_total']; ?> </div>
                        </div>
                    </div>
                    <div style="clear: both;"></div>
                </div>
                <div style="margin-top: 20px; margin-bottom: 40px; ">
                    ...
                    <div style="float: right;width: 45%; text-align: left;  ">
                        <div style="width: 100%;">
                            ...
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; "> <?php echo $currency; ?><?php echo $order_items[0]['tax']; ?> </div>
                        </div>
                        <div style="clear:both;"></div>
                        <div style="width: 100%;">
                            <div
                            ...
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; "> <?php echo $currency; ?><?php echo $order_items[0]['commision']; ?> </div>
                        </div>
                        <div style="clear:both;"></div>
                        <div style="width: 100%; margin-top: 10px; ">
                            ...
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; font-size: 16px; "><?php echo $currency; ?><?php echo $total; ?> </div>
                        </div>
                    </div>
                    <div style="clear: both;"></div>
                    <?php if (!empty($order)) { ?>
                        <a href="<?php echo base_url('invoice/product/') . $item_id ?>"
        ...
        <div style="text-align: center; background: #f3f3f3; ">
            <div
                ...
                <div style="float: left;width: 45%; text-align: left;  ">
                    <div style="width: 100%;">
                        <div
                            style="float: left; width:100%; text-align: left; font-weight: 600; line-height: 20px; font-size: 18px; ">
                            INVOICE NUMBER /رقم فاتورة
                            <br>
                            <!--  رقم الفاتورة -->
                        </div>
                        <div
                            style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; "> <?php echo $order_items[0]['display_order_id'] ?> </div>
                    </div>
                </div>
                <div style="float: right;width: 25%; text-align: left;  ">
                    <div style="width: 100%;">
                        ...
                        <div
                            style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px; "> <?php echo date('M-d-Y', strtotime($order_items[0]['order_datetime'])); ?> </div>
                    </div>
                </div>
                <div style="clear:both;"></div>
                <div style="width: 100%;">
                    <div
                        style="width: 100%; font-weight: 600; margin-top: 30px; font-size: 20px; ">
                        INVOICE/فاتورة
                    </div>
                    <div style="width: 100%; font-weight: 600; margin-top: 5px;">
                        <!-- فاتورة   --> </div>
                ...
                <div style="margin-top: 40px;">
                    <div style="float: left;width: 45%; text-align: left;  ">
                        <div style="width: 100%;">
                            <div
                                style="float: left; width:100%; font-size: 18px; text-align: left; font-weight: 600; ">
                                BUYER NAME /أسم المشتري
                                <br>
                                <!-- أسم المشتري -->
                            </div>
                            <div
                                style="float: left; width: 100%; text-align:left; padding-left: 00px; line-height:18px;  font-weight: 400 ">
                                <?php echo $order_items[0]['first_name'] . ' ' . $order_items[0]['last_name']; ?>
                            </div>
                            <div style="clear:both;"></div>
                        </div>
                        <div style="width: 100%; margin-top: 25px; ">
                            <div
                                style="float: left; width:100%; text-align: left; font-weight: 600; font-size: 18px; ">
                                ADDRESS /عنوان
                                <br>
                                <!-- عنوان -->
                            </div>
                ...
                <div style="width:100%; margin-top: 20px; ">
                    <table
                        style="border: 2px solid #ccc; width: 100%; font-size: 14px; text-align: center; "
                        cellpadding="0" cellspacing="0">
                        <tr style="font-weight: 600; background:#ccc;  ">
                            <td style="padding:6px 00px; width: 100px; ">
                ...
                <div style="margin-top: 20px; margin-bottom: 30px; ">
                    ...
                    <div style="float: right;width: 45%; text-align: left;  ">
                        <div style="width: 100%;">
                            ...
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; "> <?php echo $currency; ?><?php echo $order_items[0]['sub_total']; ?> </div>
                        </div>
                    </div>
                    <div style="clear: both;"></div>
                </div>
                <div style="margin-top: 20px; margin-bottom: 40px; ">
                    ...
                    <div style="float: right;width: 45%; text-align: left;  ">
                        <div style="width: 100%;">
                            ...
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; "><?php echo $currency; ?><?php echo $Commission; ?>  </div>
                        </div>
                        <div style="clear:both;"></div>
                        <div style="width: 100%;">
                            <div
                        ...
                        <div style="width: 100%; margin-top: 10px; ">
                            ...
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; font-size: 16px; "><?php echo $currency; ?><?php echo $order_items[0]['net_total']; ?> </div>
                        </div>
                    </div>
                    <div style="clear: both;"></div>
                    <?php if (!empty($order)) { ?>
                        <a href="<?php echo base_url('invoice/order/') . $item_id ?>"
                           style="display: inline-block; background: #dadada; margin-top: 30px; text-decoration: none; padding: 12px 18px; font-size: 14px; font-weight: 600; border-radius: 3px; color: #353535; ">
                            Download Invoice </a>
                        <div style="clear: both;"></div>
                    <?php } ?>
                ...
                <div style="margin-top: 20px; margin-bottom: 40px; ">
                    ...
                    <div style="float: right;width: 45%; text-align: left;  ">
                        <div style="width: 100%;">
                            <div
                                style="float: left; width:40%; text-align: left; font-weight: 600; line-height: 20px;">
                                Total (Excluding VAT) /الإجمالي (غير شاملة ضريبة القيمة
                                المضافة)
                            </div>
                            <div
                                style="float: left; width: 60%; text-align:left; padding-left: 00px; line-height:18px; font-weight: 600; "><?php echo $currency; ?><?php echo $Commission; ?>  </div>
                        ...
                        <div style="width: 100%; margin-top: 10px; ">
                            <div
                                style="float: left; width:40%; text-align: left; font-weight: 600; line-height: 20px;">
                                Total Taxable Amount (Excluding VAT) / الإجمالي الخاضع
                                الضريبة (غير شاملة ضريبة القيمة المضافة)
                                <br>
                                <!-- المبلغ الإجمالي -->
                            </div>
                            <div
                    ...
                    <div style="clear: both;"></div>
                    <?php if (!empty($order)) { ?>
                        <a href="<?php echo base_url('invoice/order_new/') . $item_id ?>"
                           style="display: inline-block; background: #dadada; margin-top: 30px; text-decoration: none; padding: 12px 18px; font-size: 14px; font-weight: 600; border-radius: 3px; color: #353535; ">
                            Download Invoice </a>
                        <div style="clear: both;"></div>
                    <?php } ?>
