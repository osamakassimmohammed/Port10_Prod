  ...
  <div class="row justify-content-around mt-4">
    ...
    <div class="col-md-8 col-sm-12 row justify-content-center row align-items-end m-md-4 m-lg-0 m-sm-4 sm-space">
      <div class="data-cards mx-2 sm-space">
        ...
        <h3 class="text-light text-center p-2 bolder"><?php echo $user_account_details['balance'] - $used_balance ?></h3>
      </div>
      <div class="data-cards mx-2 sm-space">
      ...
      <table class="tabl_tr_th" style="margin-top: 0px; margin-bottom: 20px; ">
        ...
        { ?>
          <tr class="remove">
            ...
            <td class="sn5">
            <?php $status = $this->db->get_where('tbl_transaction_status', array('id' => $value['status']))->result(); echo $status[0]->eng_name; ?>
            </td>
          </tr>
