    ...
    <div class="container container_detl_wdth">
      ...
      <?php if (!empty($data_res) && $data_res['status'] == 1) { ?>
              ...
              <table class="table cart-table table-responsive-xs ">
                ...
                foreach ($data_res['data'] as $d_key => $dvalue) {
                  ...
                  <tr class="remove_pro<?php echo $dvalue['id']; ?>">
                    ...
                    <td class="th_crt2">
                      ...
                      <div class="img_sec_lft">
                        <a href="<?php echo base_url($language . '/home/detail/') . $dvalue['id']; ?>"><img
                            src="<?php echo base_url('assets/admin/products/') . $dvalue['product_image']; ?>" alt=""></a>
                        <div class="clear"></div>
                      ...
                      <div class="nme_sec_right">
                        ...
                        <?php if (!empty($dvalue['unit_list'])) { ?>
                          <select class="form-control select_unit  unite1 change_unit" name="unit">
                            <?php
                      ...
                      <div class="qty qty-changer qty-changer_cart">
                        <fieldset>
                          <span type="button" value="‒" class="decrease" onclick="productQty(this)"
                            data-target="<?php echo $dvalue['id']; ?>" data-key="<?php echo $dvalue['id']; ?>"
                            data-sale-value="<?php echo decnum($price); ?>" data-product-id="<?php echo $pid; ?>"></span>
                          <input type="text" class="qty-input" value="<?php echo $qty; ?>" data-min="1" data-max=""
                            id="<?php echo $dvalue['id']; ?>" data-value="<?php echo $qty ?>" name="quantity"
                            onkeypress="return /[0-9]/i.test(event.key)">
                          <span type="button" value="+" class="increase" onclick="productQty(this)"
                            data-target="<?php echo $dvalue['id']; ?>" data-key="<?php echo $dvalue['id']; ?>"
                            data-sale-value="<?php echo decnum($price); ?>" data-product-id="<?php echo $pid; ?>"></span>
                        </fieldset>
                        <input type="hidden" name="pid" value="<?php echo $dvalue['id']; ?>">
                      </div>
                    </td>
                    <td class="th_crt5">
                      <h2>
                        <?php echo $currency_symbol; ?> <span id="qp<?php echo $dvalue['id']; ?>"><?php echo decnum($price * $qty); ?></span>
                      </h2>
                    ...
                    <td class="th_crt6">
                      <h2 class="td-color">
                        <?php echo $currency_symbol; ?> <span id="p<?php echo $dvalue['id']; ?>"><?php echo decnum($pro_total); ?></span>
                      </h2>
                    </td>
                  </tr>
                <?php } ?>
        ...
        <div class="row cart-buttons hide_cart_div">
          ...
          <!-- <div class="col-12"> -->
          <button style="margin-right: 4%; position: absolute; margin-top: 10px; float: right; right: 0; "
            class="btn btn-solid">
