               ...
               <table class="table cart-table table-responsive-xs ">
                  ...
                  <tbody>
                     ...
                     <tr class="remove_prom1m7">
                        ...
                        <td class="th_crt5">
                           <h2> <a href="<?php echo base_url($language.'/order/reorder/').$oi_val['item_id']; ?>" class="invoic reorder_btn" > Reorder </a>/ <a href="<?php echo base_url('invoice/product/').$oi_val['item_id']; ?>/order" class="invoic" > Invoice </a> </h2>
                        </td>
                     </tr>
                     <?php } ?>
