                        ...
                        <?php if (!empty($data)) { ?>
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                <div class="checkout-title">
                                    ...
                                    <div class="clear"></div>
                                    <hr style="width: 60%; margin-left: 17%;" size="3" ,
                                        color=black>
                                ...
                                <div
                                    ...
                                    <div class="cliclb_pymnt">
                                        ...
                                        <label
                                            for="ck_cod"><?php echo lang('Virtual_Account_Transfer'); ?></label>
                                    ...
                                    <div class="cliclb_pymnt">
                                        ...
                                        <label
                                            for="ck_online"><?php echo lang('Card'); ?>
                                            <span class="image">
                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                <div class="checkout-details">
                                    <div class="order-box chck_bx">
                                        ...
                                        <ul class="total">
                                            <li><?php echo lang('Subtotal_s'); ?> <span
                                    ...
                                    <div class="payment-box">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <button type="button"
                                                    class="btn-solid btn pl_ordr_chckbtn"><?php echo lang('Place_Order'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
