                                        ...
                                        <tr>
                                            ...
                                            <td class="sn5">
                                                <?php if ($il_val['invoice_status'] == 'Confirmed') { ?>
                                                    <span
                                                        class="label label-success"><?php echo $il_val['invoice_status']; ?></span>
                                                <?php } else if ($il_val['invoice_status'] == 'Cancelled') { ?>
                                                    <span
                                                        class="label label-danger"><?php echo $il_val['invoice_status']; ?></span>
                                                <?php } else if ($il_val['invoice_status'] == 'Rejected') { ?>
                                                    <span
                                                        class="label label-warning"><?php echo $il_val['invoice_status']; ?></span>
                                                <?php } else { ?>
                                                    <span
                                                        class="label label-primary"><?php echo $il_val['invoice_status']; ?></span>
                                                <?php } ?>
                                            </td>
                                            <td class="sn6">
                                                <?php if ($currency == "USD") {
                                                    ...
                                                    echo $price;
                                                } ?><?php echo $currency_symbol; ?></td>

                                            <td class="sn6">
                                                <a href="<?php echo base_url($language . '/my_account/received_invoice/') . $il_val['in_id']; ?>"
                                                   class="detl_info">
