             ...
             <div class="col-lg-4">
                <div class="header-contact wow " data-wow-duration="3s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3s; animation-delay: 0s;">
                   <ul>
                      ...
                      <li>
                         <a style="color:white" href="mailto:<?php echo @$footer_content[0]['email_id']; ?>"><img src="<?php echo base_url(); ?>assets/frontend/images/mail.png" class="num_con_a"><?php echo @$footer_content[0]['email_id']; ?></a>
                      </li>
                   </ul>
                </div>
             </div>
                ...
                <ul class="header-dropdown wrap_main_right">
                   ...
                   <?php if (empty($uid)) { ?>
                      <li class=" mobile-account">
                         <a href="<?php echo base_url($language . '/login'); ?>"><span class="login"> Login
                            </span></a>
                      </li>
                   <?php } else { ?>
                      <li class=" mobile-account">
                         <a href="<?php echo base_url($language . '/login/logout'); ?>"><span class="login"> Logout
                            </span></a>
                      </li>
                   <?php } ?>
                   ...
                   <li class=" mobile-account">
                      <img class="lang_img" src="<?php echo base_url(); ?>assets/frontend/images/news.png">
             ...
             <div class="main-menu">
                <div class="menu-left">
                      ...
                      <div id="mySidenav" class="sidenav">
                         ...
                         <nav class="side_left_a">
                            ...
                            <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                               ...
                               <li><a href="<?php echo base_url($language) ?>">Home</a></li>
                                        ...
                                        <?php foreach ($main_category as $mc_key => $mc_val) { ?>
                                           <li>
                                              <a href="<?php echo base_url($language . '/home/listing/') . $mc_val['id']; ?>">
                                                 <i class="fa fa-cubes" aria-hidden="true"></i><?php echo $mc_val['display_name']; ?></a>
                                              <?php if (!empty($mc_val['sub_category'])) { ?>
                                                 <ul>
                                                    <?php foreach ($mc_val['sub_category'] as $mcs_key => $mcs_val) { ?>
                                                       <li><a href="<?php echo base_url($language . '/home/listing/') . $mc_val['id'] . '/' . $mcs_val['id']; ?>"><?php echo $mcs_val['display_name']; ?></a>
                                                       </li>
                                                    <?php } ?>
                                                 </ul>
                                              <?php } ?>
                               ...
                               <li><a href="javascript:void(0)">News & Social</a></li>

                               <li><a href="javascript:void(0)">Blog & Resources</a></li>
                   ...
                   <div class="brand-logo wow " data-wow-duration="3.5s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3.5s; animation-delay: 0s;">
                      <a href="<?php echo base_url($language); ?>"><img src="<?php echo base_url(); ?>assets/frontend/images/icon/logo.png" class="img-fluid blur-up lazyload logo_white" alt=""></a>
                                  ...
                                  <select>
                                     ...
                                     <?php if (!empty($main_category)) {
                                          foreach ($main_category as $mc_key => $mc_val) { ?>
                                           <option value="<?php echo $mc_val['id']; ?>">
                                              <?php echo $mc_val['display_name']; ?></option>
                                     <?php }
                                       }  ?>
                                  </select>
                               </div>
                   ...
                   <div class="headr_sech_right">
                      <div class="icon-nav " style="display: inline-block;width: 100%;">
                         <ul>
                            ...
                            <li class="onhover-div mobile-cart" style="width: 20%">
                               <div class="acnt_ri_menu">
                                  <a href="<?php echo base_url($language . '/my_account/wishlist') ?>">
                                     <img src="<?php echo base_url(); ?>assets/frontend/images/view.png">
                            ...
                            <li class="onhover-div mobile-cart">
                               <div class="acnt_ri_menu">
                                  <a href="<?php echo base_url($language . '/my_account/order_history') ?>">
                                     <img src="<?php echo base_url(); ?>assets/frontend/images/order.png">
                            ...
                            <li class="onhover-div mobile-cart">
                               <div class="acnt_ri_menu">
                                  <a href="<?php echo base_url($language . '/home/view_cart') ?>">
                                     <img src="<?php echo base_url(); ?>assets/frontend/images/cart.png">
                            ...
                            <li class="onhover-div mobile-cart">
                               <div class="acnt_ri_menu">
                                  ...
                                  <a class="login_check">
                                     <img src="<?php echo base_url(); ?>assets/frontend/images/reqst_blue.png">
                            ...
                            <li class="onhover-div mobile-cart" style="display: none;">
                               <div><img src="<?php echo base_url(); ?>assets/frontend/images/icon/cart.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-shopping-cart"></i>
                               </div>
                               <ul class="show-div shopping-cart">
                                  <li>
                                     <div class="media">
                                        <a href="#"><img alt="" class="mr-3" src="<?php echo base_url(); ?>assets/frontend/images/fashion/product/1.jpg"></a>
                                  ...
                                  <li>
                                     <div class="media">
                                        <a href="#"><img alt="" class="mr-3" src="<?php echo base_url(); ?>assets/frontend/images/fashion/product/2.jpg"></a>
                                        <div class="media-body">
                                           <a href="#">
                                              <h4>item name</h4>
                                           </a>
