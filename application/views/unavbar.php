            ...
            <div class="col-lg-4">
               <div class="header-contact wow " data-wow-duration="3s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3s; animation-delay: 0s;">
                  <ul>
                     ...
                     <li>
                     <a style="color:white" href="mailto:<?php echo @$footer_content[0]['email_id']; ?>"><img src="<?php echo base_url();?>assets/frontend/images/mail.png" class="num_con_a"><?php echo @$footer_content[0]['email_id']; ?></a></li>
                  </ul>
               </div>
            </div>
            ...
            <div class="col-lg-6 text-right wow " data-wow-duration="3s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3s; animation-delay: 0s;">
               <ul class="header-dropdown wrap_main_right">
                  ...
                  <li class=" mobile-account">                    
                      <a href="<?php echo base_url($language.'/login'); ?>"><span class="login"> Login </span></a>                    
                  </li>
                  <?php }else{ ?>
                  <li class=" mobile-account">                    
                      <a href="<?php echo base_url($language.'/login/logout'); ?>"><span class="login"> Logout </span></a>                    
                  </li>
                  <?php } ?>
            ...
            <div class="main-menu">
               <div class="menu-left">
                  ...
                  <div class="brand-logo wow " data-wow-duration="3.5s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3.5s; animation-delay: 0s;">
                     <a href="<?php echo base_url($language); ?>"><img src="<?php echo base_url();?>assets/frontend/images/icon/logo.png"
                        ...
                        <ul>                                
                         ...
                         <li class="onhover-div mobile-cart" style="width: 20%" >
                          ...
                          <li class="onhover-div mobile-cart" style="display: none;" >
                            <div><img src="<?php echo base_url();?>assets/frontend/images/icon/cart.png"
