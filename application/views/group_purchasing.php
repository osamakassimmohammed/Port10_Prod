...
<section class="section-b-space">
    <div class="page-title">
        <h2><?php echo 'group purchasing'; ?></h2>
    </div>
    <div class="container container_detl_wdth container_detl_wdth_checkOut">
        <div class="checkout-page">
            <div class="checkout-form">

                <form id="form_place_order" action="<?php echo base_url($language.'/home/group_purchasing_submit') ?>"
                    method="POST">
                    <div class="row">
                        <?php if(!empty($data)){  ?>
                        <div class="col-lg-6 col-sm-12 col-xs-12">
                            <div class="checkout-title">
                                ...
                                <span class="ck_pay_step"><?php echo 'group purchasing'; ?></span>
                            ...
                            <div class="pin-code-check" style="display:none">
                                <input type="text" placeholder="Check Pin Code" id="pin_check">
                                <a class="btn btn-solid pl_ordr_chckbtn mt-10" id="pin_check_btn" style="color:#ffff">Check</a>
                            </div>
                               ...
                               ?>
                                        ...
                                        <li><img class="ck_img"
                                            ...
                                            <p class="ck_test ck_pri_qty">
                                                <?php echo $currency_symbol; echo " ";  echo $dvalue['p']['sale_price']; echo ' <i class="fa fa-times" aria-hidden="true"></i> '; echo $dvalue['c']['qty'] ?>
                              ...
                              <div class="payment-options">
                                 <ul>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button type="submit"
                                            class="btn btn-solid pl_ordr_chckbtn"><?php echo lang('Place_Order'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#pin_check_btn').click(function() {
        ...
        $.ajax({
            ...
            method: 'POST',
            data: { "pin_check": pin_check },
            success: function(response) {
                var relatedOrders = JSON.parse(response);

                // Use the relatedOrders array in the front-end to display the data
                ...
                // Use the relatedOrders array in the front-end to display the data
                    ...
                    if (Array.isArray(relatedOrders[i])) {
                        ...
                        // nestedResult.push('Order ID ' + order.id);
