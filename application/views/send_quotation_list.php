<script type="text/javascript">
   ...
   var index_g=1;
    ...
    google.maps.event.addListener(marker, 'dragend', function() 
    {
      ...
      $.ajax({
              type: 'POST',
              url: "<?php echo base_url('ajax/geolocationaddress') ?>",
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDNpNhw8Qyac0n7I7gHsVWtr4uc1VNN7dg&libraries=places" async defer></script>
<style>
   .activ_invoic a{
      ...
      <aside class="col-md-12 col-sm-12 space-bottom-20 ">
         <div class="account-details-wrap ">
            ...
            <div class="req_button">
               <button class="btn btn-info active_btn status" data-order='Open' ><?php echo lang('Open_Orders'); ?></button>
               <button class="btn btn-info status" data-order='Confirmed' ><?php echo lang('Confirmed'); ?></button>
               <button class="btn btn-info status" data-order='Cancelled' ><?php echo lang('Cancelled'); ?></button>
               <button class="btn btn-info status" data-order='Rejected' ><?php echo lang('Rejected'); ?></button>

               <button class="btn btn-success req_lab login_check"><?php echo lang('Request_Quotations'); ?></button>
            ...
            <div class="account-box  light-bg default-box-shadow recv_invoicas">               
               <div class="top_pading_sec">
                  <table class="tabl_tr_th" style="margin-top: 0px; margin-bottom: 20px; " >
                     ...
                     <tbody id="table_body">
                        ...
                        <tr class="remove<?php echo $il_val['id']; ?>">
                           <td colspan="1" class="sn1" >                        
                              <a href="javascript:void(0)" class="cancel_req" data-id="<?php echo $il_val['id']; ?>" >
                                 <i class="fa fa-times-circle" aria-hidden="true"></i>
                              </a>
                            <img width="70px" height="70px" src="<?php echo $il_val['product_image']; ?>"> 
                            <span class="name-prod"><?php echo $il_val['product_name']; ?></span>
                           </td>
                           <td class="sn3" ><?php echo $il_val['qty']; ?></td>
                           <td class="sn3" ><?php echo $il_val['unit_name']; ?></td>
                           <td class="sn5" ><?php echo $il_val['pid']; ?></td>                         
                           <td class="sn6" >
                              <a href="<?php echo base_url($language.'/my_account/quotation_detail/').$il_val['id']; ?>" class="" >
                                 <?php echo lang('See_More'); ?>
                              </a>
                           </td>
                           <td class="sndate" ><?php echo date('m/d/Y' ,strtotime($il_val['created_date'])); ?></td>                           
                           <td class="sn6" >
                              <a href="<?php echo base_url($language.'/my_account/received_invoice_list/').$il_val['id']; ?>" class="detl_info" >
                   ...
                   <div id="pagination" class="text-center margin-top-30"><?php echo $pagination; ?>          
                     </div>
                  <div class="clear"></div>              
               </div>               
            </div>
                ...
                <form id="send_quotation" action="" method="post" enctype="multipart/form-data">
                    <div class="form_wrap_qutn">                
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('product_name'); ?> </div>
                          <input type="text" class="singl_input_qutn space" name="product_name" id="qproduct_name" >
                        </div>
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Product_Group'); ?> </div>
                          <select class="singl_input_qutn" name="category_id" id="qcategory_id" >
                            <option value="0"><?php echo lang('Please_Select_Group'); ?></option>
                        ...
                        <div class="signl_form">
                          ...
                          <input type="text" class="singl_input_qutn space" name="" id="seller_id" autocomplete="off">                  
                        </div>
                        <div id="hsven_list" style="display: none;margin-left: 510px !important" >fadsf dfasdf</div>
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Purchase_Cycle'); ?> </div>
                          <div class="prch_cycl">
                            <label>
                                <input name="purchase_cycle" type="radio" value="one time"> <span> <?php echo lang('One_Time'); ?> </span>
                            </label>
                            <label>
                                <input name="purchase_cycle" type="radio" value="continuous"> <span> <?php echo lang('Continuous'); ?> </span>
                            </label>
                            <div class="clear"></div>
                          </div>
                        </div>
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Customization'); ?> </div>
                          <div class="prch_cycl">
                            <label>
                                <input name="customiz" type="radio" value="yes"> <span> <?php echo lang('Yes'); ?> </span>
                            </label>
                            <label>
                                <input name="customiz" type="radio" value="no"> <span> <?php echo lang('No1'); ?> </span>
                            </label>
                            <div class="clear"></div>
                          </div>
                        </div>
                        <div class="clear"></div>
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Deadline_for_Submission'); ?> </div>
                        ...
                        <div class="signl_form">
                          ...
                          <input type="text" class="singl_input_qutn" name="pid" id="qpid" onkeypress="return isNumberKey(event)">
                        ...
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('HS_Code'); ?> </div>
                          <input type="text" class="singl_input_qutn space" name="hscode" id="qhscode" >
                        </div>
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Unit'); ?> </div>
                          <select class="singl_input_qutn" id="qunit" name="unit" >
                            <option value="0"><?php echo lang('Please_Select_Unit'); ?></option>
                        ...
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('quantity'); ?> </div>
                          <input type="text" class="singl_input_qutn space" name="qty" id="qqty" onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="signl_form">
                        ...
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Delivery_Date'); ?> </div>
                          <input type="text" class="singl_input_qutn" id="qdelivery_date" name="delivery_date" autocomplete="off">
                        </div>
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Incoterms'); ?> </div>
                        ...
                        <div class="signl_form">
                          <div class="singl_label"> <?php echo lang('Certification'); ?>  </div>  
                          <div class="prch_cycl">
                            <label>
                                <input name="certification" type="radio" id="qcertification" value="yes"> <span> <?php echo lang('Yes'); ?> </span>
                            </label>
                            <label>
                                <input name="certification" type="radio" id="qcertification2" value="no"> <span> <?php echo lang('No1'); ?> </span>
                            </label>
                            <div class="clear"></div>
                          </div>
                        </div>
                        <div class="signl_form signl_form_full signl_form_full_infor_1">
                          <div class="singl_label"> <?php echo lang('Information'); ?> </div>
                          <textarea class="singl_input_qutn space" rows="5" id="qinformation" name="information" ></textarea>
                        </div>

                        <div class="form-group left_input_a gmap_pop_asa"  >
                           <!-- <label>Location Detection</label> -->
                           <input type="text" class="form-control" name="location" id="searchInput2" value="" placeholder="Location Detection" >
                           <div style="padding: 10%; height: 200px; position: relative; overflow: hidden; margin-top: 26px; border-radius: 10px;"  id="map"></div>
                           <!-- width: 50%;;border: 1px solid black -->
                           <div class="get-map-val">
                              <input type="hidden" class="form-control" name="area_latitude" id="latitude" placeholder="Latitude" value="" >
                              <input type="hidden" class="form-control" name="area_longitude" id="longitude" placeholder="Longitude" value="" >
                           </div>
                           <div id="map2"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <button style="" type="submit" class="btn btn-solid" ><?php echo lang('Send'); ?></button>
                    </div>            
                    <div class="clear"></div>
                </form>           
            </div>
