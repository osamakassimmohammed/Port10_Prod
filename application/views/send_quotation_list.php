...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcf4oVp2zfW5qBYMtRD54DApyRolch_qE&libraries=places" async
  defer></script>
<style>
  .activ_invoic a {
    ...
    <aside class="col-md-12 col-sm-12 space-bottom-20 ">
      <div class="account-details-wrap ">
        ...
        <div class="req_button">
          <button class="btn btn-info active_btn status" data-order='Open'>
            <?php echo lang('Open_Orders'); ?>
          </button>
          <button class="btn btn-info status" data-order='Confirmed'>
            <?php echo lang('Confirmed'); ?>
          </button>
          <button class="btn btn-info status" data-order='Cancelled'>
            <?php echo lang('Cancelled'); ?>
          </button>
          <button class="btn btn-info status" data-order='Rejected'>
            <?php echo lang('Rejected'); ?>
          </button>

          <button class="btn btn-success req_lab login_check">
            <?php echo lang('Request_Quotations'); ?>
          </button>
        ...
        <div class="account-box  light-bg default-box-shadow recv_invoicas">
          <div class="top_pading_sec">
                ...
                <?php if (!empty($quotation_list)) {
                  foreach ($quotation_list as $ql_key => $il_val) { ?>
                    <tr class="remove<?php echo $il_val['id']; ?>">
                      ...
                      <td class="sndate">
                        <?php echo date('M-d-Y', strtotime($il_val['created_date'])); ?>
                      </td>
                      <td class="sn6">
            ...
            <div id="pagination" class="text-center margin-top-30">
              <?php echo $pagination; ?>
            </div>
            <div class="clear"></div>
          </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">
          <?php echo lang('Request_for_Quotation'); ?>
        </h4>
        ...
        <form id="send_quotation" action="" method="post" enctype="multipart/form-data">
          <div class="form_wrap_qutn">
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('product_name'); ?>
              </div>
              <input maxlength="30" type="text" class="singl_input_qutn space" name="product_name" id="qproduct_name"
            ...
            <div class="signl_form">
              ...
              <select class="singl_input_qutn" name="category_id" id="qcategory_id">
                <option value="0">
                  <?php echo lang('Please_Select_Group'); ?>
                </option>
            ...
            <div class="signl_form">
              ...
              <input maxlength="30" type="text" class="singl_input_qutn space" name="" id="seller_id" autocomplete="off"
                onkeypress="return /[a-zA-Z]/i.test(event.key)">
            </div>
            <div id="hsven_list" style="display: none;margin-left: 510px !important">fadsf dfasdf</div>
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('Purchase_Cycle'); ?>
              </div>
              <div class="prch_cycl">
                <label>
                  <input name="purchase_cycle" type="radio" value="one time"> <span>
                    <?php echo lang('One_Time'); ?>
                  </span>
                </label>
                <label>
                  <input name="purchase_cycle" type="radio" value="continuous"> <span>
                    <?php echo lang('Continuous'); ?>
                  </span>
                </label>
                <div class="clear"></div>
              </div>
            ...
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('Customization'); ?>
              </div>
              <div class="prch_cycl">
                <label>
                  <input name="customiz" type="radio" value="yes"> <span>
                    <?php echo lang('Yes'); ?>
                  </span>
                </label>
                <label>
                  <input name="customiz" type="radio" value="no"> <span>
                    <?php echo lang('No1'); ?>
                  </span>
                </label>
                <div class="clear"></div>
            ...
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('Deadline_for_Submission'); ?>
              </div>
              <input type="text" onkeypress="return /[]/i.test(event.key)" class="singl_input_qutn" id="qdeadline"
            ...
            <div class="signl_form">
              ...
              <!-- <input maxlength="12" type="text" class="singl_input_qutn" name="pid" id="qpid"
                onkeypress="return isNumberKey(event)"> -->
              <select class="singl_input_qutn" id="qpid" name="pid">
                <option value="0">
                  <?php echo lang('select_product') ?>
                </option>
              </select>
            ...
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('HS_Code'); ?>
              </div>
              <input maxlength="10" type="text" class="singl_input_qutn space" name="hscode" id="qhscode">
            </div>
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('Unit'); ?>
              ...
              <select class="singl_input_qutn" id="qunit" name="unit">
                <option value="0">
                  <?php echo lang('Please_Select_Unit'); ?>
                </option>
            ...
            <div class="signl_form">
              ...
              <input maxlength="6" type="text" class="singl_input_qutn space" name="qty" id="qqty"
                onkeypress="return isNumberKey(event)">
            </div>
            <div class="signl_form">
              <div class="singl_label">
                <?php echo lang('Destination'); ?>
                <!-- <a href="javascript:void(0)" class="gps_box_a" data-toggle="tooltip" title="GPS">
                              <i class="fa fa-location-arrow" aria-hidden="true"></i>
                            </a> -->
                <div class="clear"></div>
              </div>
              <input maxlength="206" type="text" class="singl_input_qutn searchInput" id="paddress" name="address">
            </div>
            ...
            <div class="signl_form">
              ...
              <input type="text" onkeypress="return /[]/i.test(event.key)" class="singl_input_qutn" id="qdelivery_date"
            ...
            <div class="signl_form">
              ...
              <div class="prch_cycl">
                <label>
                  <input name="certification" type="radio" id="qcertification" value="yes"> <span>
                    <?php echo lang('Yes'); ?>
                  </span>
                </label>
                <label>
                  <input name="certification" type="radio" id="qcertification2" value="no"> <span>
                    <?php echo lang('No1'); ?>
                  </span>
                </label>
                <div class="clear"></div>
            ...
            <div class="form-group left_input_a gmap_pop_asa">
              ...
              <input type="text" class="form-control" name="location" id="searchInput2" value=""
              ...
              <div class="get-map-val">
                <input type="hidden" class="form-control" name="area_latitude" id="latitude" placeholder="Latitude"
                  value="">
                <input type="hidden" class="form-control" name="area_longitude" id="longitude" placeholder="Longitude"
                  value="">
              </div>
              <div id="map2"></div>
            </div>
            ...
            <button style="" type="submit" class="btn btn-solid">
              <?php echo lang('Send'); ?>
            </button>
          </div>
          <div class="clear"></div>
...
<script type="text/javascript">
  ...
  $(document).on("click", ".vendor_name", function () {
    ...
    $.ajax({
      type: 'POST',
      url: "<?php echo base_url('ajax/get_vendor_product_name'); ?>",
      data: { 'seller': g_seller_id },
