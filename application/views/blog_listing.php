                ...
                <?php if (!empty($blog_data)) { ?>
                    <?php foreach ($blog_data as $bd_key => $bd_val) { ?>
                        <div class="row blog-media">
                            <div class="col-xl-6">
                                <div class="blog-left">
                                    <a href="<?php echo base_url($language . '/blog/detail/') . $bd_val['id']; ?>"><img
                                            src="<?php echo base_url('assets/admin/blog/') . $bd_val['image']; ?>"
                    ...
                    <h2 class="text-danger text-center"><?php echo lang('blog_not_found'); ?>
                        !!!</h2>
                <?php } ?>
            </div>
                    ...
                    <form id="blog_search_form">
                        <div class="serch_blg_right">
                            ...
                            <input type="text" id="blog_search"
                                   placeholder="<?php echo lang('Search_Blog'); ?>">
                            ...
                            <ul class="recent-blog">
                                <?Php foreach ($blog_type_data as $btd_key => $btd_val) {
                                    ...
                                    <li class="blog_type_list">
                                        <a href="<?php echo base_url($language . '/blog/index/') . $btd_val['id']; ?>"
                                           class="media <?php echo $active; ?>"><?php echo $btd_val['name']; ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
