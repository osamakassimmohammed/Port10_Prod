      ...
      <aside class="col-md-8 col-sm-8 space-bottom-45">
         <div class="account-details-wrap">
            ...
            <div class="account-box  light-bg default-box-shadow">
               <form action="" class="form-delivery" id="change_pass" method="post">
                  <div class="row top_pading_sec">
                     <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                           <div class="label_new"> Old Password </div>
                           <input class="form-control" type="password" placeholder="Old Password" id="old_password" name="old_password">
                        </div>
                     </div>
                     <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                           <div class="label_new"> New Password <i class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Password Minimum six characters, at least one uppercase letter, one lowercase letter, one number and one special character"></i> </div>
                           <input class="form-control" type="password" placeholder="New Password" id="password" name="password">
                        </div>
                     </div>
                     <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                           <div class="label_new"> Confirm Password  <i class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Password Minimum six characters, at least one uppercase letter, one lowercase letter, one number and one special character"></i> </div>
