...
<section class="cart-section section-b-space" style="padding-top: 20px;">
  ...
  <div class="container container_detl_wdth">
    ...
    <div class="col-6 <?php echo $hide; ?>"><a href="<?php echo base_url($language . '/home/listing/1'); ?>"
        class="btn btn-solid pull-left"><?php echo lang('continue_shopping'); ?></a></div>
    <?php if (!empty($data)) { ?>
      <div class="row hide_cart_div">
        <div class="col-sm-12">
            ...
            <table class="table cart-table table-responsive-xs ">
              <thead>
                <tr class="table-head">
                  ...
                  <th scope="col" class="th_crt2" style="padding-left: 60px; text-align: left;">
                    <?php echo lang('Items'); ?>
                  </th>
                  <!-- <th scope="col" class="th_crt3" >product name</th> -->
                  <!-- <th scope="col" class="th_crt4" style="padding-right: 60px;" >Unit</th> -->
                  <th scope="col" class="th_crt4" style="padding-right: 0px; text-align: left; padding-left: 45px;">
                    <?php echo lang('quantity'); ?>
                  </th>
                  <th scope="col" class="th_crt5">
                    <?php echo lang('Price'); ?>
                  </th>
                  <th scope="col" class="th_crt5">
                    <?php echo lang('fees'); ?>
                ...
                <tr class="remove_pro<?php echo $dvalue['key']; ?>">
                  ...
                  <td class="th_crt2">
                    ...
                    <div class="img_sec_lft">
                      <a data-toggle="tooltip" title="<?php echo lang('Remove'); ?>" href="javascript:void(0)"
                        class="icon delete_pro" data-id="<?php echo $dvalue['key']; ?>"><i
                          class="fa fa-times-circle"></i></a>
                      <a href="<?php echo base_url($language . '/home/detail/') . $dvalue['p']['id']; ?>"><img
                          src="<?php echo base_url('assets/admin/products/') . $dvalue['p']['product_image']; ?>"
                          alt=""></a>
                      <div class="clear"></div>
                      ...
                      <div style="margin-top: 10px;">
                        <span style="display: none" class="wishlist<?php echo $pid; ?>">
                          <?php if (@$dvalue['p']['wish_list'] == 1) { ?>
                            <a style="margin-right: 7px;" data-toggle="tooltip" title="Move To Wishlist"
                              href="javascript:void(0)" class="icon" data-id=""
                    ...
                    <div class="nme_sec_right">
                      <a class="prdct_name_cart"
                        href="<?php echo base_url($language . '/home/detail/') . $dvalue['p']['id']; ?>"> <span>
                          <?php echo $dvalue['p']['product_name']; ?>
                        </span> </a>
                      <?php if (isset($dvalue['c']['metadata']) && !empty($dvalue['c']['metadata'])) { ?>
                        <br>
                        <span class="size_cart_m">Size:
                          <?php echo $dvalue['c']['metadata']['size']; ?>
                        </span>
                      <?php } ?>
                      ...
                      <?php if (!empty($dvalue['p']['unit_list'])) { ?>
                        <select class="form-control select_unit  unite1 change_unit">
                          ...
                          foreach ($dvalue['p']['unit_list'] as $uld_key => $uld_value) {
                            ...
                            ?>
                            <option data-pid="<?php echo $pid; ?>" data-unitid="<?php echo $uld_value['id'] ?>"
                              data-key="<?php echo $dvalue['key']; ?>" <?php echo $unit_selected; ?>><?php echo $uld_value['unit_name']; ?></option>
                          <?php } ?>
                        </select>
                      <?php } ?>
                  ...
                  <td class="th_crt4">
                    <div class="qty qty-changer qty-changer_cart">
                      <fieldset>
                        <span type="button" value="‒" class="decrease" onclick="productQty(this)"
                          data-target="<?php echo $dvalue['key']; ?>" data-key="<?php echo $dvalue['key']; ?>"
                          data-sale-value="<?php echo decnum($price); ?>" data-product-id="<?php echo $pid; ?>"></span>
                        <input type="text" class="qty-input" value="<?php echo $qty; ?>" data-min="1" data-max="10"
                          id="<?php echo $dvalue['key']; ?>" data-value="<?php echo $qty ?>">
                        <span type="button" value="+" class="increase" onclick="productQty(this)"
                          data-target="<?php echo $dvalue['key']; ?>" data-key="<?php echo $dvalue['key']; ?>"
                          data-sale-value="<?php echo decnum($price); ?>" data-product-id="<?php echo $pid; ?>"></span>
                      </fieldset>
                    </div>
                  ...
                  <td class="th_crt5">
                    <h2>
                      <?php echo $currency_symbol; ?> <span id="qp<?php echo $dvalue['key']; ?>"><?php echo decnum($price * $qty); ?></span>
                    </h2>
                  ...
                  <td class="th_crt6">
                    <h2 class="td-color">
                      <?php echo $currency_symbol; ?> <span id="p<?php echo $dvalue['key']; ?>"><?php echo decnum($pro_total); ?></span>
                    </h2>
                  </td>
                </tr>
              <?php } ?>
          ...
          <div
            ...
            <span
              style="margin-left: 0px; padding-top: 21px; font-size: 20px; text-transform: uppercase; display: inline-block; float: right; width: 13.9%; text-align: center;">
              <?php echo $currency_symbol; ?> <span class="total_sale_price">
                <?php echo decnum($grand_total_inc); ?>
              </span>
            </span>
            <span
            ...
            <span
              style="margin-right: 17px; padding-top: 21px; font-size: 20px; text-transform: uppercase; display: inline-block; float: right;">
      ...
      <div class="row cart-buttons hide_cart_div">
        ...
        <div class="col-6" style="display: none"><a id="vc_addlink"
            href="<?php echo base_url($language . '/home/checkout'); ?>" class="btn btn-solid"><?php echo lang('CHECKOUT'); ?></a></div>
        <!-- <div class="col-12"> -->
        <a style="margin-right: 4%; position: absolute; margin-top: 6px; float: right; right: 0; "
          href="<?php echo base_url($language . '/home/checkout_1/'); ?>" id="vc_out" class="btn btn-solid"><?php echo lang('CHECKOUT'); ?></a>
        <!-- </div> -->
