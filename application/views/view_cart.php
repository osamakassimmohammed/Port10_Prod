...
<section class="cart-section section-b-space" style="padding-top: 20px;">
    ...
    <div class="container container_detl_wdth">
        ...
        <div class="col-6 <?php echo $hide; ?>"><a
                href="<?php echo base_url($language . '/home/listing/1'); ?>"
                class="btn btn-solid pull-left"><?php echo lang('continue_shopping'); ?></a>
        </div>
        <?php if (!empty($data)) { ?>
                      ...
                      <?php } ?>
                                        ...
                                        <div class="nme_sec_right">
                                            <a class="prdct_name_cart"
                                               href="<?php echo base_url($language . '/home/detail/') . $dvalue['p']['id']; ?>">
                                                <span> <?php echo $dvalue['p']['product_name']; ?> </span>
                                            </a>
                                        ...
                                        <div class="qty qty-changer qty-changer_cart">
                                            <fieldset>
                                                <span type="button" value="‒"
                                                      ...
                                                      data-target="<?php echo $dvalue['key']; ?>"
                                                      data-key="<?php echo $dvalue['key']; ?>"
                                    ...
                                    <td class="th_crt5">
                                        <h2><?php echo $currency_symbol; ?> <span
                                                id="qp<?php echo $dvalue['key']; ?>"><?php echo decnum($price * $qty); ?></span>
                                        </h2>
                                    ...
                                    <td class="th_crt6">
                                        <h2 class="td-color"><?php echo $currency_symbol; ?>
                                            <span
                                                id="p<?php echo $dvalue['key']; ?>"><?php echo decnum($pro_total); ?></span>
                                        </h2>
                                    </td>
                                </tr>
                            <?php } ?>
            ...
            <div class="row cart-buttons hide_cart_div">
                ...
                <div class="col-6" style="display: none"><a id="vc_addlink"
                                                            ...
                                                            class="btn btn-solid"><?php echo lang('CHECKOUT'); ?></a>
                </div>
                <!-- <div class="col-12"> -->
                <a style="margin-right: 4%; position: absolute; margin-top: 6px; float: right; right: 0; "
                   ...
                   id="vc_out" class="btn btn-solid"><?php echo lang('CHECKOUT'); ?></a>
                <!-- </div> -->
