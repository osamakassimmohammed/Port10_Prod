                        ...
                        <?php if (!empty($data)) { ?>
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                <div class="checkout-title">
                                    ...
                                    <div class="clear"></div>
                                    <hr style="width: 53%; margin-left: 20%;" size="3" ,
                                        color=black>
                                ...
                                <div class="row check-out">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="ck_email" name="email"
                                               value="<?php echo $email; ?>"
                                               placeholder="<?php echo lang('Please_enter_your_email'); ?>">
                                    </div>
                                    <div
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="ck_state" name="state"
                                    ...
                                    <div
                                        class="form-group col-md-12 col-sm-6 col-xs-12">
                                        <div
                                            class="field-label"><?php echo lang('Googe_address'); ?>
                                            <i class="fa fa-info-circle"
                                               aria-hidden="true" data-toggle="tooltip"
                                               data-placement="top"
                                               title="<?php echo lang('Googe_title'); ?>"></i>
                                        </div>
