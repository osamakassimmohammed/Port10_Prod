                        ...
                        <div class="row order-success-sec">
                            ...
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    ...
                                    <li><?php echo $order_data[0]['city']; ?>, <?php echo $order_data[0]['pincode']; ?>
                                    </li>
                                    <li><?php echo $order_data[0]['state']; ?>, <?php echo $order_data[0]['country']; ?>
                                    </li>
                                    <li><?php echo lang('contact_no'); ?>: <?php echo $order_data[0]['mobile_no']; ?>
                                    </li>
                                </ul>
                            </div>
