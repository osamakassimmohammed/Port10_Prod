        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="success-text"><i class="fa fa-check-circle"
                    ...
                    <?php }else{ ?>
                    <div class="success-text"><i class="fa fa-times-circle"
                                                 aria-hidden="true"></i>
                        <h2><?php echo lang('Failed'); ?></h2>
                        <?php } ?>
                        <?php if (@$order_data[0]['payment_mode'] == 'cash-on-del') { ?>
                            <p><?php echo lang('Transfer_Amount'); ?> <?php echo number_format($order_data[0]['net_total'], 2); ?> <?php echo lang($order_data[0]['currency']); ?> <?php echo lang('To_Port10'); ?>
                                ,<?php echo lang('Account_Number'); ?> SA30 8000 0131
                                6080 1056
                                6331 <?php echo lang('With_AlRajhi_Bank'); ?> <?php echo $order_data[0]['display_order_id']; ?></p>
                        <?php } ?>
                        <?php if (!empty($tran_history)) { ?>
                            ...
                            <?php } ?>
                            <p><?php echo lang('Transaction_ID'); ?>
                                :<?php echo $tran_history[0]['track_id']; ?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
                                ...
                                <div class="total-sec">
                                    <ul>
                                        <li><?php echo lang('Subtotal_s'); ?>
                                            <span><?php echo number_format($order_data[0]['sub_total'], 2); ?><?php echo lang($order_data[0]['currency']); ?></span>
                                        </li>
                                        <li><?php echo lang('fees'); ?>
                                            <span><?php $fees = $order_data[0]['commission'] + $order_data[0]['transfer_fees'] + $order_data[0]['bank_fees'];
                                                echo number_format($fees, 2); ?><?php echo lang($order_data[0]['currency']); ?></span>
                                        </li>
                                        <li><?php echo lang('VAT'); ?>
                                            <span><?php echo number_format($order_data[0]['tax'], 2); ?><?php echo lang($order_data[0]['currency']); ?></span>
                                        </li>
                                        <li><?php echo lang('Shipping'); ?>
                                            <span><?php echo number_format($order_data[0]['shipping_charge'], 2); ?><?php echo lang($order_data[0]['currency']); ?></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="final-total">
                                    <h3><?php echo lang('total'); ?>
                                        <span><?php echo number_format($order_data[0]['net_total'], 2); ?><?php echo lang($order_data[0]['currency']); ?></span>
                                    </h3>
                                </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="row order-success-sec">
                            ...
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    ...
                                    <li><?php echo $order_data[0]['city']; ?>
                                        , <?php echo $order_data[0]['pincode']; ?></li>
                                    <li><?php echo $order_data[0]['state']; ?>
                                        , <?php echo $order_data[0]['country']; ?></li>
                                    <li><?php echo lang('contact_no'); ?>
                                        : <?php echo $order_data[0]['mobile_no']; ?></li>
                                </ul>
                            </div>
