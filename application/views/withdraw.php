...
<div class="tab-content" id="pills-tabContent">
  ...
  <div class="row my-4">
   ...
   <div class="row justify-content-around py-4">
            ...
            <div class="col-md-4 d-flex row justify-content-between">
            <div>
               <label for="product_name"><?php echo lang('aEnter_Amount'); ?></label>
               </div>
               <div>
                <h6>Empty</h6>
               </div>
...
<div class="row mb-4">
   ...
   <div class="row justify-content-center mb-2">
      <a class="product-item-price btn btn-solid float-right"><?php echo lang('awithdraw'); ?></a>
    </div>
  </div>
</diV>
</div>
...
<div class="row col-12 justify-content-center mb-2">
      <a class="product-item-price btn btn-solid"><?php echo lang('awithdraw'); ?></a>
    </div>
</diV>
  </div>
  </div>
