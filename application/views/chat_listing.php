...
<div class="breadcrumb-section">
   <div class="container container_detl_wdth my_msg_as_l">
      <div class="row">
         <div class="col-sm-6">
         ...
         <form class="theme-form" id="compose_form" method="post" enctype="multipart/form-data">
            <div class="form-row">
               ...
               <div class="col-md-6">
                  ...
                  <input type="text" class="form-control space" name="subject" id="csubject" placeholder="Subject">
               </div>
               
               <div class="col-md-12 mesg_lablas">
                  <label for="inq_message">Message</label>
                  <textarea class="form-control message_text_are space" placeholder="Write Your Message"  rows="6" id="cmessage" name="message"></textarea>
               </div>
      ...
      <div class="containera">
         <div class="messaging">
            <div class="wrap_btns_newmsg">
               <div class="cont_supl_btn" data-toggle="modal" data-target="#contc_id" >
                    ...
                    <?php if(!empty($user_data))
                    {
                      if($user_data[0]['status']==true)
                      {
                        if(!empty($user_data[0]['compose_data'])){
                         ...
                         <a href="<?php echo base_url('chat/detail/').$cd_val['id']; ?>" class="chat_list" id="compose<?php echo $cd_val['id']; ?>">
                            <div class="chat_people">
                               <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                               <div class="chat_ib">
                                  <h5><?php echo $cd_val['first_name']; ?> <span class="chat_date"><?php echo date('M d' ,strtotime($cd_val['ccreated_date'])); ?></span></h5>
                                  <div class="subject_wrp">
                                     <div class="subject_titl"> Subject <span>:</span></div>
                                   <div class="subject_text"><?php echo $cd_val['subject']; ?>
                                     </div>
                                     <div class="clear"></div>
                                  </div>
                                  <div class="clear"></div>
                                  <div class="subject_wrp">
                                     ...
                                     <div class="subject_text"><?php echo $cd_val['compose_message']; ?>
                                     </div>
                                     <div class="clear"></div>
                                  </div>                              
                               </div>
...
<script type="text/javascript">
  $(document).on("submit","#compose_form",function(e){
      ...
      if(error==1)
      {
         ...
         $.ajax({
            type: 'POST',
            url: "<?php echo base_url('chat/compose_data'); ?>",
