                        ...
                        if ($user_data[0]['status'] == true) {
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                        ...
                                                                        data-id="<?php echo $cd_val['id']; ?>"
                                                                        data-creceiver="<?php echo $cd_val['usid']; ?>"><?php echo lang('Send'); ?></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                            ...
                            <?php } else { ?>
                                ...
                                <h2 style="padding:30px;"
                                    ...
                                    id="hsc_error"> <?php echo lang('No_message_found'); ?></h2>
                ...
                <form class="theme-form" id="compose_form" method="post"
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="singl_input_qutn" name="seller_id"
                                    id="cseller_id">
                                <option
                                ...
                                <?php if (!empty($supplier_ids)) {
                                    foreach ($supplier_ids as $supi_key => $supi_value) { ?>
                                        <option
                                            value="<?php echo en_de_crypt($supi_value['id']); ?>"><?php echo $supi_value['first_name'] ?></option>
                                    <?php }
                                } ?>
                            </select>
