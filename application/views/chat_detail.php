...
<script type="text/javascript">
    $(document).on("submit", "#send_form", function (e) {
        e.preventDefault();
        var creceiver = '<?php echo $user_data[0]['compose_data'][0]['creceiver_id']; ?>';
    ...
    function message_send(message, compose_idg, creceiver) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('chat/user_chat'); ?>",
            data: {message: message, 'compose_id': compose_idg, creceiver: creceiver},
