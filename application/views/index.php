                  ...
                  <?php if (!empty($main_category)) { ?>
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <?php foreach ($main_category as $mc_key => $mc_val) {
                           ...
                           <a class="dropdown-item hselect_cat" href="javascript:void(0)"
                              data-name="<?php echo $mc_val['display_name']; ?>" data-id="<?php echo $mc_val['id']; ?>"><?php echo $mc_val['display_name']; ?></a>
                        <?php } ?>
                     </div>
                  <?php } ?>
               </div>
               ...
               foreach ($banner_data as $bd_key => $bd_val) { ?>
                  <div>
                     <div class="home  text-center">
                        <img src="<?php echo base_url('assets/admin/banner/') . $bd_val['image']; ?>" alt=""
                              ...
                              <div class="no-slider row">
                                 ...
                                 if (!empty($adds_product)) {
                                    foreach ($adds_product as $product_key => $product_value) { ?>
                                       <div class="product-box">
                                          <div class="img-wrapper">
                                             ...
                                             <div class="back">
                                                <a
                                                   href="<?php echo base_url($language . '/home/detail/') . $product_value['id']; ?>"><img
                                                      src="<?php echo base_url("assets/admin/products/") . $product_value['product_image']; ?>"
                                                      class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                             </div>
                                                ...
                                                <select class="form-control select_size get_size<?php echo $i; ?>">
                                                   ...
                                                   <?php foreach ($product_value['meta_data'] as $md_key => $md_val) { ?>
                                                      <option data-price="<?php echo $md_val['price']; ?>"
                                                         ...
                                                         value="<?php echo $md_val['item_id']; ?>"><?php echo $md_val['size']; ?>
                                                      </option>
                                                   <?php } ?>
                                                </select>
                                             <?php } ?>
                                    ...
                                    <h2 class="text-danger text-center">
                                       <?php echo lang('Product_Not_Found'); ?>
                                    </h2>
                                 <?php } ?>
                              </div>
                           </div>
            ...
            <div class="col">
               <div class="theme-tab">
                  <ul class="tabs tab-title">
                     <li class="current"><a href="tab-4">
                           <?php echo lang('New_Products'); ?>
                        </a></li>
                     <li class=""><a href="tab-5">
                           <?php echo lang('Featured_Products'); ?>
                        </a></li>
                     <li class=""><a href="tab-6">
                           <?php echo lang('Best_Sellers'); ?>
                        </a></li>
                  </ul>
                  <div class="tab-content-cls">
                                 ...
                                 <div class="product-box">
                                    ...
                                    <div class="product-detail">
                                       ...
                                       <div>
                                          ...
                                          <span class="wish_l wishlist<?php echo $product_value['id']; ?>">
                                             <?php echo $product_value['wish_list'];
