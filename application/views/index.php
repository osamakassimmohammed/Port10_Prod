        ...
        <div class="serch_hdr">
            <form action="" method="GET" id="form_search" style="">
                ...
                <div class="serch_left_a">
                    <input type="text" id="form_search_val" name="search" placeholder="" value="<?php echo $search; ?>" autocomplete="off">
                    <?php $form_catid = isset($_GET['m_catid']) ? $_GET['m_catid'] : 0;   ?>
                    <div class="dropdown dropdown_new_as">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span id='hsearch_name'><?php echo lang('Select_Category'); ?> </span>
                        </button>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item hselect_cat" href="javascript:void(0)" data-name="<?php echo $mc_val['display_name']; ?>" data-id="<?php echo $mc_val['id']; ?>"><?php echo $mc_val['display_name']; ?></a>
                            <?php } ?>
                        </div>
                        <?php } ?>
                    </div>
                ...
                <button class="serch_btn_right" > <i class="fa fa-search" aria-hidden="true"></i> </button>
                <div class="clear"></div>
            </form>
        </div>
      ...
      <div class="slide-1 home-slider">
         ...
         <div>
            <div class="home  text-center">
               <img src="<?php echo base_url('assets/admin/banner/').$bd_val['image'];?>" alt="" class="bg-img blur-up lazyload">
               <div class="container">
                  <div class="row">
                     <div class="col">
                        <div class="slider-contain">                           
                           ...
                           <div class="wrp_shop_nw">
                            ...
                            <a href="<?php echo base_url($language.'/home/listing/').$bd_val['main_cat']; ?>" class="btn btn-solid"><?php echo lang('shop_now'); ?></a>
                           </div>
            ...
            <div class="col">
               <div class="theme-tab">
                  <ul class="tabs tab-title">
                     <li class="current"><a href="tab-4"><?php echo lang('New_Products'); ?></a></li>
                     <li class=""><a href="tab-5"><?php echo lang('Featured_Products'); ?></a></li>
                     <li class=""><a href="tab-6"><?php echo lang('Best_Sellers'); ?></a></li>
                  </ul>
                  <div class="tab-content-cls">
                              ...
                              <div class="product-detail">
                               ...
                               <?php if(isset($product_value['meta_data']) && !empty($product_value['meta_data']) ) { ?>
                                 ...
                                 <div>
                                    ...
                                    <span class="wish_l wishlist<?php echo $product_value['id']; ?>">
                                      <?php if($product_value['wish_list']==1){  ?>
                                      <a  href="javascript:void(0)" onclick="remove_cart(<?php echo $product_value['id']; ?>, 1)" ><i
                                               class="ti-heart" aria-hidden="true"></i></a> 
                                      <?php }else{ ?>
                                      <a href="javascript:void(0)" onclick="move_to_wish_list(<?php echo $product_value['id']; ?>, 1)" ><i
                                               class="ti-heart" aria-hidden="true"></i></a> 
                                      <?php } ?>  
                                     </span>
