<style>
   .activ_my_acnt a {
   font-weight: 700 !important; color: #3f006f !important;
   }
      ...
      <aside class="col-md-8 col-sm-8 space-bottom-20">
         <div class="account-details-wrap">
            ...
            <div class="account-box  light-bg default-box-shadow">
               <ul>
                  <li>
                     <a href="<?php echo base_url($language.'/my_account/send_quotation_list'); ?>"> Quotations</a>
                  </li>
               </ul>
            </div>
            ...
            <div class="account-box  light-bg default-box-shadow">
               <ul>
                  <li>                                                
                     <a href="<?php echo base_url($language.'/my_account/account_info'); ?>">Edit your account information</a>
                  </li>
                  <li>                                               
                     <a href="<?php echo base_url($language.'/my_account/cng_pass'); ?>">Change your password</a>
                  </li>
                  <li>
                     <a href="<?php echo base_url($language.'/my_account/orders'); ?>">View your order history</a>
                     <!-- order_history -->
                  </li>
                  <!-- <li>                                              
            ...
            <div class="account-box  light-bg default-box-shadow">
               <ul>
                  <li>
                     <a href="<?php echo base_url('my_account/wishlist') ?>">My Wishlist</a>
                  </li>
               </ul>
            </div>
         </div>
