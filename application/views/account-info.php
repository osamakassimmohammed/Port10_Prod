    ...
    <div class="row">
        ...
        <aside class="col-lg-8 col-md-12 col-sm-12 space-bottom-20 ">
            <div class="account-details-wrap ">
                <div
                    class="title-2 sub-title-small">  <?php echo lang('EDIT_PROFILE'); ?>
                            ...
                            <div class="row top_pading_sec">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Entity_Name'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('Entity_Name'); ?>"
                                               id="sestiblishment" name="entity_name"
                                               value="<?php echo $user_data[0]['entity_name']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('CR_Number'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('CR_Number'); ?>"
                                               id="scr_number" name="username"
                                               value="<?php echo $user_data[0]['username']; ?>"
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Street_Name'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('Street_Name'); ?>"
                                               id="sstreet_name" name="street_name"
                                               value="<?php echo $user_data[0]['street_name']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Building_Num'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('Building_Num'); ?>"
                                               id="sbuilding_no" name="building_no"
                                               value="<?php echo $user_data[0]['building_no']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('City'); ?> </div>
                                        <select class="form-control " id="scity"
                                            ...
                                            <?php if (!empty($city_list)) {
                                                foreach ($city_list as $cl_key => $cl_val) {
                                                    ...
                                                    ?>
                                                    <option
                                                        value="<?php echo $cl_val['city_name']; ?>" <?php echo $bselected; ?>><?php echo $cl_val['city_name']; ?></option>
                                                <?php }
                                            } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('State_Province_Region'); ?> </div>
                                        <select class="form-control " id="sstate"
                                            ...
                                            <?php if (!empty($state_list)) {
                                                foreach ($state_list as $sl_key => $sl_val) {
                                                    ...
                                                    ?>
                                                    <option
                                                        value="<?php echo $sl_val['state_name']; ?>" <?php echo $bselected; ?>><?php echo $sl_val['state_name']; ?></option>
                                                <?php }
                                            } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Zip_Or_Postal_Code'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('Enter_Postal_Code'); ?>"
                                               id="spostal_code" name="postal_code"
                                               value="<?php echo $user_data[0]['postal_code']; ?>"
                                               onkeypress="return isNumberKey(event)">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Country'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('Country'); ?>"
                                               id="scountry"
                                               value="<?php echo $user_data[0]['country']; ?>"
                                               readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Phone'); ?> </div>
                                        <input type="text" class="form-control"
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Email'); ?> </div>
                                        <input type="text" class="form-control"
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('VAT_Number'); ?> </div>
                                        <input type="text" class="form-control"
                                               placeholder="<?php echo lang('VAT_Number'); ?>"
                                               id="svat_number" name="vat_number"
                                               value="<?php echo $user_data[0]['vat_number']; ?>"
                                               onkeypress="return isNumberKey(event)">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Preferred_Bank_Name'); ?> </div>
                                        <select class="form-control " id="sbank_name"
                                            ...
                                            <?php if (!empty($bank_details)) {
                                                foreach ($bank_details as $bd_key => $bd_val) {
                                                    ...
                                                    ?>
                                                    <option
                                                        value="<?php echo $bd_val['id']; ?>" <?php echo $bselected; ?>><?php echo $bd_val['bank_name']; ?></option>
                                                <?php }
                                            } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('IBAN'); ?> </div>
                                        <input type="text"
                                               class="form-control isSpecial"
                                               placeholder="<?php echo lang('IBAN'); ?>"
                                               id="siban" name="iban"
                                               value="<?php echo $user_data[0]['iban']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('User_Name'); ?> </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <label class="pink-btn btn_main_updt">
                                        <input class="btn btn-solid" type="submit"
        ...
        <aside class="col-lg-4 col-md-12 col-sm-12 space-bottom-45">
            <div class="account-details-wrap">
                <div
                    class="title-2 sub-title-small"> <?php echo lang('UPLOAD_LOGO'); ?> </div>
                <div class="account-box  light-bg default-box-shadow">
                    <form action="" class="form-delivery" id="" method="post">
                        <div class="row top_pading_sec">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input style="display: none" type="file" id="logo1"
                                           name="name">

                                    <label for="logo1" class="file__drop"
                                           data-image-uploader1="">
                                        <span class="text">&nbsp;</span>
                                        <img id="set_logo" data-image=""
                                             src="<?php echo $logo_url; ?>"
                                             style="width: 100px;height: 100px;padding: 10px 0;margin-top: 25px;">
                                    </label>
                                </div>
                            </div>
                ...
                <div
                    class="title-2 sub-title-small cng_title">  <?php echo lang('Change_your_password'); ?>  </div>
                <div class="account-box  light-bg default-box-shadow">
                    <form
                        action="<?php echo base_url($language . '/my_account/cng_pass') ?>"
                        class="form-delivery" id="change_pass" method="post">
                        <div class="row top_pading_sec">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <div
                                        class="label_new"> <?php echo lang('Old_Password'); ?> </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <div
                                        class="label_new"> <?php echo lang('New_Password'); ?>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <div
                                        class="label_new"> <?php echo lang('Confirm_Password'); ?>
                                        <i class="fa fa-question-circle"
                                           aria-hidden="true" data-toggle="tooltip"
                                           data-placement="top"
                                           title="Password Minimum six characters, at least one uppercase letter, one lowercase letter, one number and one special character"></i>
