<?php if (!empty($available_languages)): ?>
    <ul class=" languagepicker roundborders large top-nav-ul"
        style="position: absolute;top: 0px;right: -8%;width: 120px;z-index: 8;">
        <li><a onclick="return false;"><?php echo lang('current_language'); ?>
