                    ...
                    <div class="col-lg-6">
                        <form action="" class="form-inline subscribe-form auth-form needs-validation" method="post" id="subscribe_form">
                            <div class="form-group mx-sm-3">
                                ...
                                <button type="submit" class="btn btn-solid" id=""><?php echo lang('subscribe'); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row footer-theme partition-f">
                ...
                <div class="col ">
                    <div class=" footer_socl_logo responsiv_height">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="<?php echo base_url('assets/frontend/images/icon/foot_logo.png'); ?>" alt=""></div>
                    ...
                    <div class="sub-title responsiv_height">
                        ...
                        <div class="footer-contant">
                            <ul class="contact-list">
                                <li><i class="fa fa-map-marker"></i><?php if($language=='en'){ echo @$footer_content[0]['location']; }else{ echo @$footer_content[0]['location_arabic']; }  ?>
                                </li>
                                <li><i class="fa fa-phone"></i><?php echo lang('Call_Us'); ?>: <a href="tel:<?php echo @$footer_content[0]['mobile_no']; ?>"><?php echo @$footer_content[0]['mobile_no']; ?></a></li>
                                <li><i class="fa fa-envelope-o"></i><?php echo lang('Email_Us'); ?>: <a href="mailto:<?php echo @$footer_content[0]['email_id']; ?>"><?php echo @$footer_content[0]['email_id']; ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="footer-contant">
                            <ul>
                              <?php foreach ($main_category as $key => $val) { ?>
                                <li><a href="<?php echo base_url($language.'/home/listing/').$val['id']; ?>"><?php echo $val['display_name']; ?></a></li>
                              <?php } ?>                               
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col ">
                    <div class="sub-title responsiv_height">
                        ...
                        <div class="footer-contant">
                            <ul>
                                <li><a href="<?php echo base_url($language.'/page/index/about') ?>"><?php echo lang('About_Us'); ?></a></li>
                                <li><a href="<?php echo base_url($language.'/page/index/privacy-policy') ?>"><?php echo lang('Privacy_Policy'); ?></a></li>
                                <li><a href="<?php echo base_url($language.'/page/index/terms-of-service') ?>"><?php echo lang('Terms_Of_Service'); ?></a></li>
                    ...
                    <div class="sub-title responsiv_height">
                        ...
                        <div class="footer-contant">
                            <ul>
                                <li><a href="<?php echo base_url($language.'/login') ?>"><?php echo lang('Register'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6 col-md-6 col-sm-12">
                <div class="payment-card-bottom">
                    <p>
                        ...
                        <span>VAT Number :<?php echo @$footer_content[0]['vat_number']; ?></span></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
