        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="subscribe">
              <div>
                <h4>
                  <?php echo lang('fsub_1'); ?>
                </h4>
                <p>
                  <?php echo lang('fsub_2'); ?>
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row footer-theme partition-f">
        ...
        <div class="col ">
          <div class=" footer_socl_logo responsiv_height">
            <div class="footer-title footer-mobile-title">
              <h4>
                <?php echo lang('ABOUT_PORT10'); ?>
              </h4>
            </div>
            <div class="footer-contant">
              <div class="footer-logo"><img src="<?php echo base_url('assets/frontend/images/icon/foot_logo.png'); ?>"
                  alt=""></div>
              <p>
                <?php echo lang('Follow_Us'); ?>
              </p>
            ...
            <div class="footer-contant">
              <ul class="contact-list">
                ...
                <li><i class="fa fa-phone"></i>
                  <?php echo lang('Call_Us'); ?>: <a href="tel:<?php echo @$footer_content[0]['mobile_no']; ?>"><?php
                        echo @$footer_content[0]['mobile_no']; ?></a>
                </li>
                <li><i class="fa fa-envelope-o"></i>
                  <?php echo lang('Email_Us'); ?>: <a href="mailto:<?php echo @$footer_content[0]['email_id']; ?>"><?php
                        echo @$footer_content[0]['email_id']; ?></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col ">
          <div class="sub-title responsiv_height">
            ...
            <div class="footer-contant">
              <ul>
                <li><a href="<?php echo base_url($language . '/page/index/about') ?>"><?php echo lang('About_Us'); ?></a>
                </li>
          ...
          <div class="sub-title responsiv_height">
            <div class="footer-title">
              <h4>
                <?php echo lang('Signup_on_Port10'); ?>
              </h4>
            </div>
            <div class="footer-contant">
              <ul>
              ...
              if (response == '0') {
                ...
                if (flag == '') {
                  ...
                  if (flag == 'view_cart') {
                    ...
                    app2 = '<button class="wishlist-btn" onclick="remove_cart(' + pid + ',`detail`)"> <img class="wisl_icn_as" src="<?php echo base_url(); ?>assets/frontend/images/like.svg"> <span class="title-font">Added To WishList</span></button>';
                  }
                }
          ...
          success: function (response) {
            ...
            if (response == 'some') {
              ...
              if (pro_count == 0) {
                ...
                $(".home-page").addClass("body_fix");
                $('.wrpa_slide_toglright_3').hide();
                $(".wrpa_slide_toglright_2").html('<h3 class="ac_empty"><?php echo lang('YOUR_SHOPPING_CART_IS_EMPTY'); ?></h3><br/><div class="d-flex justify-content-center">   <a href="<?php echo base_url($language . '/home'); ?>" <button class="btn btn-solid"><?php echo lang('aAdd_Items'); ?></button></a></div>');
              } else {
