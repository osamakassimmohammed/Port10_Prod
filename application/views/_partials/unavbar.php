...
<link rel="stylesheet" type="text/css"
      href="<?php echo base_url(); ?>assets/frontend/css/main.css">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="header-contact wow " data-wow-duration="3s"
                        ...
                        <ul>
                            ...
                            <li>
                                <a style="color:white"
                                   href="mailto:<?php echo @$footer_content[0]['email_id']; ?>">
                ...
                <div class="col-lg-6 text-right wow " data-wow-duration="3s"
                    ...
                    <ul class="header-dropdown wrap_main_right">
                        ...
                        <?php if (empty($uid)) {
                            ...
                            <li class=" mobile-account">
                                <a href="<?php echo base_url($language . '/login'); ?>"><span
                                        class="login"> <?php echo lang('Login'); ?> </span></a>
                            </li>
                        <?php } else {
                            ...
                            <li class=" mobile-account logout_clas_as">
                                <a href="<?php echo base_url($language . '/login/logout'); ?>"><span
                                        class="login"> <?php echo lang('Logout'); ?> </span></a>
                            </li>
                        <?php } ?>
                        ...
                        <li class="active"><a
                                href="<?php echo base_url($language . '/price') ?>"><?php echo lang('Subscription'); ?></a>
                        </li>
                            ...
                            <div id="mySidenav" class="sidenav">
                                ...
                                <nav class="side_left_a">
                                    ...
                                    <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                        <li>
                                            <a href="<?php echo base_url($language) ?>"><?php echo lang('Home'); ?></a>
                                        </li>
                                                    ...
                                                    <?php foreach ($main_category as $mc_key => $mc_val) { ?>
                                                        <li>
                                                            <a href="<?php echo base_url($language . '/home/listing/') . $mc_val['id']; ?>">
                                                                <img height="20px"
                                                                     width="20px"
                                                                     src="<?php echo base_url('assets/admin/category/') . $mc_val['image']; ?>"><?php echo $mc_val['display_name']; ?>
                                                            </a>
                                        ...
                                        <?php } ?>
                                        <li>
                                            <a href="javascript:void(0)"><?php echo lang('Media'); ?></a>
                                        </li>
                                        <li>
                    ...
                    <div class="menu-right pull-right wow  header_serc_main_a"
                        ...
                        <div class="col-sm-12 ">
                            <nav class="main-nav ">
                                <ul class="menu">
                                    <li class="home"><a
                                            href=""><?php echo lang('Home'); ?></a></li>
                                    <?php if (!empty($main_category)) { ?>
                                        <li class="shop shop_menu"><a
                                                href="javascript:void(0)"><?php echo lang('Shop'); ?></a>
                                    ...
                                    <?php } ?>
                                    <li class="mediaa"><a
                                            href="javascript:void(0)"><?php echo lang('Media'); ?></a>
                                    </li>
                                    <li class="resourcess"><a
                                            href="<?Php echo base_url($language . '/blog'); ?>"><?php echo lang('Resources'); ?></a>
                                    </li>
                                    <li class="help"><a
                                            href="<?Php echo base_url($language . '/help'); ?>"><?php echo lang('Help'); ?></a>
                                    </li>
                                    <li class="c_us"><a
                                            href="<?Php echo base_url($language . '/contact_us'); ?>"><?php echo lang('Contact_Us'); ?></a>
                                    </li>
                                            ...
                                            <a href="#" class="dropdown-toggle"
                                               data-toggle="dropdown">
                                                <i class="fa fa-bell-o"></i><span
                                                    class="badge"><?php echo (count($noti_data) == 0) ? "" : count($noti_data); ?></span>
                                            </a>
                                                    ...
                                                    <?php foreach ($noti_data as $inn_key => $inn_val) { ?>
                                                        <li>
                                                            <a href="<?php echo $inn_val['link']; ?>">
                                                                <span
                                                                    class="notfct_titl"><?php echo $inn_val['message']; ?></span>
                                                                <div
                                                                    class="clear"></div>
                                                            </a>
                                                        </li>
                                    ...
                                    <?php if ($language == 'en') { ?>
                                        <li class="toggle_menu">
                                            <input class="radio_switch en_toggle"
                                                   type="checkbox">
                                        </li>
                                    <?php } else { ?>
                                        <li class="toggle_menu">
                                            <input
                                                class="radio_switch ar_toggle radio_on"
                                                type="checkbox">
                                        </li>
                                    <?php } ?>
    ...
    <div class="wrpa_slide_toglright">
        ...
        <div class="wrpa_slide_toglright_3">
            ...
            <div class="slid_bot_btn">
                <a class="slid_bot_btn1"
                   href="<?php echo base_url($language . '/home/checkout_1'); ?>">
