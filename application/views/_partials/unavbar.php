                 ...
                 <div class="main-menu">
                     <div class="menu-left">
                         ...
                         <div class="brand-logo wow " data-wow-duration="3.5s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3.5s; animation-delay: 0s;">
                             <a href="<?php echo base_url($language); ?>"><img src="<?php echo base_url(); ?>assets/frontend/images/icon/logo-04.png" class="img-fluid blur-up lazyload logo_white" alt=""></a>
                         ...
                         <div class="col-sm-12 ">
                             <nav class="main-nav ">
                                 <ul class="menu">
                                     ...
                                     <?php } ?>
                                     <li class="mediaa"><a href="<?Php echo base_url($language . '/blog'); ?>"><?php echo lang('Media'); ?></a></li>
                                    ...
                                    <a href="<?php echo base_url($language . '/compare') ?>" class="compr_btn_a">
                                        <div class="compr_tex"> <?php echo lang('Compare'); ?> </div>
