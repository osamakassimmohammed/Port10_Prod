                ...
                <div class="col-lg-4">
                    <div class="header-contact wow " data-wow-duration="3s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3s; animation-delay: 0s;">
                        <ul>
                            ...
                            <li>
                                <a style="color:white" href="tel:<?php echo @$footer_content[0]['mobile_no']; ?>"><img src="<?php echo base_url();?>assets/frontend/images/call.png" class="num_con_a"><?php echo @$footer_content[0]['mobile_no']; ?></a></li>
                                <li>
                                    ...
                                    <?php echo @$footer_content[0]['email_id']; ?></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 text-right wow " data-wow-duration="3s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3s; animation-delay: 0s;">
                            <ul class="header-dropdown wrap_main_right">
                                ...
                                <li class=" mobile-account">
                                    <a href="<?php echo base_url($language.'/login'); ?>"><span class="login"> <?php echo lang('Login'); ?> </span></a>
                                </li>
                                <?php }else{
                                $login_class="with_login";
                                ?>
                                <li class=" mobile-account logout_clas_as">
                                    <a href="<?php echo base_url($language.'/login/logout'); ?>"><span class="login"> <?php echo lang('Logout'); ?> </span></a>
                                </li>
                                <?php } ?>
                                <!-- language comment  <li class="onhover-dropdown mobile-account">
                                    <img class="lang_img" src="<?php //echo base_url();?>assets/frontend/images/lang.png">
                                    <span class="lang_spn"  > Language </span>
                                    <ul class="onhover-show-div">
                                        <?php //foreach ($available_languages as $abbr => $item){ ?>
                                        <li class="active"><a href="<?php //echo lang_url($abbr); ?>"><?php //echo $item['label']; ?></a></li>
                                        <?php  // } ?>
                                    </ul>
                                </li> -->
                                ...
                                <!-- currency comment <li class="onhover-dropdown mobile-account">
                                    <img class="lang_img" src="<?php //echo base_url();?>assets/frontend/images/curncy.png">
                                    ...
                                    <ul class="onhover-show-div">
                                        ...
                                        <?php // } ?>
                                        <li><a href="javascript:void(0)" class="<?php //echo $curr_aclass_sar; ?> currency_change" data-currencyname='SAR'><?php //echo lang('h_sar'); ?></a></li>
                                        <li><a href="javascript:void(0)" class="<?php //echo $curr_aclass_usd; ?> currency_change" data-currencyname='USD'><?php //echo lang('h_usd'); ?></a></li>
                                    </ul>
                                </li> -->
                    ...
                    <div class="col-sm-12 header_right_side">
                        <div class="main-menu">
                                    ...
                                    <div id="mySidenav" class="sidenav">
                                        ...
                                        <nav class="side_left_a">
                                            ...
                                            <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                                <li><a href="<?php echo base_url($language) ?>"><?php echo lang('Home'); ?></a></li>
                                                <?php if(!empty($main_category)){ ?>
                                                <li> <a href="javascript:void(0)"><?php echo lang('Shop'); ?></a>
                                                <ul class="ul_shop_a" >
                                                    <?php foreach ($main_category as $mc_key => $mc_val) { ?>
                                                    <li>
                                                        <a href="<?php echo base_url($language.'/home/listing/').$mc_val['id']; ?>">
                                                        <img height="20px" width="20px" src="<?php echo base_url('assets/admin/category/').$mc_val['image']; ?>"><?php echo $mc_val['display_name']; ?></a>
                                                        <?php if(!empty($mc_val['sub_category'])){ ?>
                                                        <ul>
                                                            <?php foreach ($mc_val['sub_category'] as $mcs_key => $mcs_val) { ?>
                                                            <li><a href="<?php echo base_url($language.'/home/listing/').$mc_val['id'].'/'.$mcs_val['id']; ?>"><?php echo $mcs_val['display_name']; ?></a></li>
                                                            <?php } ?>
                                                        </ul>
                                                        <?php } ?>
                                                    </li>
                                            ...
                                            <?php } ?>
                                            <li><a href="javascript:void(0)"><?php echo lang('Media'); ?></a></li>
                            ...
                            <div class="brand-logo wow " data-wow-duration="3.5s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3.5s; animation-delay: 0s;">
                                <a href="<?php echo base_url($language); ?>"><img src="<?php echo base_url();?>assets/frontend/images/icon/logo-04.png"
                                class="img-fluid blur-up lazyload logo_white" alt=""></a>
                                <a href="<?php echo base_url($language); ?>"><img src="<?php echo base_url();?>assets/frontend/images/icon/foot_logo.png"
...
$(document).ready(function(){
  ...
  $(".close_menu_mb").click(function(){
    $(".open_menu_mb").show();
                        ...
                        <div class="menu-right pull-right wow  header_serc_main_a" data-wow-duration="3.0s" data-wow-delay="0s" style="visibility: visible; animation-duration: 3.0s; animation-delay: 0s;">
                            <div class="col-sm-12 ">
                                <nav class="main-nav ">
                                    <ul class="menu">
                                        <li class="home"><a href=""><?php echo lang('Home'); ?></a></li>
                                        <?php if(!empty($main_category)){ ?>
                                        <li class="shop shop_menu"><a href="javascript:void(0)"><?php echo lang('Shop'); ?></a>
                                            <div class="shop_menu_show">
                                                <?php foreach ($main_category as $mc_key => $mc_val) { ?>
                                                <a href="<?php echo base_url($language.'/home/listing/').$mc_val['id']; ?>"><?php echo $mc_val['display_name']; ?></a>
                                                <?php } ?>
                                            </div>
                                        </li>
                                        <?php } ?>
                                        <li class="mediaa" ><a href="javascript:void(0)"><?php echo lang('Media'); ?></a></li>
                                        <li class="resourcess" ><a href="<?Php echo base_url($language.'/blog'); ?>"><?php echo lang('Resources'); ?></a></li>
                                        <li class="help" ><a href="<?Php echo base_url($language.'/help'); ?>"><?php echo lang('Help'); ?></a></li>
                                        <li class="c_us" ><a href="<?Php echo base_url($language.'/contact_us'); ?>"><?php echo lang('Contact_Us'); ?></a></li>
                                       ...
                                       <?php  if(!empty($uid)){ ?>
                                        ...
                                        <li class="dropdown dropdown_notfctn">
                                            ...
                                            <i class="fa fa-bell-o"></i><span class="badge"><?php echo  (count($noti_data) == 0) ? "" : count($noti_data);  ?></span>
                                            </a>
                                             ...
                                             <?php foreach ($noti_data as $inn_key => $inn_val) { ?>
                                              <li>
                                                <a href="<?php echo $inn_val['link']; ?>">
                                                    <span class="notfct_titl" ><?php echo $inn_val['message']; ?></span>
                                                    <div class="clear"></div>
                                                </a>
                                            </li>
                                            <?php } ?>
                                        ...
                                        <?php if($language=='en'){ ?>
                                            <li class="toggle_menu" >
                                                <input class="radio_switch en_toggle" type="checkbox">
                                            </li>
                                        <?php }else{ ?>
                                            <li class="toggle_menu" >
    ...
    <div class="wrpa_slide_togl">
        <div class="wrpa_slide_toglright">
            <div class="wrpa_slide_toglright_1">
                <div class="cart_titl_righ"> <?php echo lang('Cart'); ?> </div>
                <div class="clos_cart">
    ...
    <div class="clear"></div>
    <?php  if(!empty($uid)){ ?>
    <div class="headr_sech_right headr_sech_right_main" >
            ...
            <ul>
                ...
                <li class="onhover-div mobile-cart acount_option">
                    ...
                    <div class="acount_optn_panel">
                        <a href="<?php echo base_url($language.'/admin'); ?>"> <?php echo lang('Go_to_Seller_Account'); ?> </a>     
                    </div>
                </li>
                <?php }else{ ?>
                ...
                <li class="onhover-div mobile-cart"  >
                    <div class="acnt_ri_menu" >
                        <a href="<?php echo base_url($language.'/my_account/wishlist') ?>">
                            <span><?php echo lang('Wish_List'); ?></span>
                ...
                <li class="onhover-div mobile-cart">
                    <div class="acnt_ri_menu" >
                        ...
                        <a href="<?php echo base_url($language.'/chat') ?>" >
                            <span> <?php echo lang('Messaging'); ?>   </span>
...
<a href="<?php echo base_url($language.'/compare') ?>" class="compr_btn_a">
        <div class="compr_tex"> Compare </div> 
        <div class="compr_count"><?php echo $compare_count; ?></div>
    <div class="clear"></div>
</a>
