                ...
                <?php if(!empty($data)){  ?>
                  <div class="col-lg-6 col-sm-12 col-xs-12">
                     <div class="checkout-title">                    
                        ...
                        <span>Checkout</span>
                        <div class="clear"></div>
                        <hr style="width: 55%; margin-left: 20%;" size="3", color=black> 
                        ...
                        <div class="order-box chck_bx">
                           ...
                           <ul class="qty">
                             ...
                             foreach ($data as $d_key => $dvalue) {
                              ...
                              <li><label class="ck_test ch_fee">Fees</label> <span><?php echo $currency_symbol ?> <?php echo number_format($all_fees,2); ?> </span></li>
                           </ul>
                           <ul class="sub-total">
                              <li>Total before VAT <span class="count"><?php echo $currency_symbol ?> <?php echo number_format($product_fees_without_vat,2); ?> </span></li>
                              <li>Estimated VAT to be collected <span class="count"><?php echo $currency_symbol ?> <?php echo number_format($vat_calulated,2); ?> </span></li>
                              <!-- <li>Shipping
                                 <div class="shipping">
