...
<link rel="stylesheet" type="text/css"
      href="<?php echo base_url(); ?>assets/frontend/css/xzoom.css" media="all"/>
<link type="text/css" rel="stylesheet" media="all"
      href="<?php echo base_url(); ?>assets/frontend/css/magnific-popup.css"/>
<script src="<?php echo base_url(); ?>assets/frontend/js/jquery.js"></script>
<script type="text/javascript"
        src="<?php echo base_url(); ?>assets/frontend/js/xzoom.min.js"></script>
<script type="text/javascript"
        src="<?php echo base_url(); ?>assets/frontend/js/magnific-popup.js"></script>
    ...
    <div class="collection-wrapper">
        ...
        <div class="nav_main">
            <a href="<?php echo base_url($language); ?>"
               class="nav_a"> <?php echo lang('Home'); ?> </a>
            <i class="fa fa-angle-right" aria-hidden="true"></i>
            <a href="<?Php echo base_url($language . '/home/listing/') . @$product_detail[0]['category']; ?>"
               class="nav_a"> <?php echo @$product_detail[0]['category_name']; ?> </a>
            <i class="fa fa-angle-right" aria-hidden="true"></i>
                    ...
                    <div class="col-lg-4">
                        <div class="large-5 column">
                            <div class="xzoom-container">
                                ...
                                <img class="xzoom5 zoom_right_main" id="xzoom-magnific"
                                     src="<?php echo base_url("assets/admin/products/") . $product_detail[0]['product_image']; ?>"
                                     xoriginal="<?php echo base_url("assets/admin/products/") . $product_detail[0]['product_image']; ?>"/>
                                <div class="xzoom-thumbs zoomleft_main">
                                    <a href="<?php echo base_url("assets/admin/products/") . $product_detail[0]['product_image']; ?>"><img
                                            class="xzoom-gallery5" width="80"
                                            src="<?php echo base_url("assets/admin/products/") . $product_detail[0]['product_image']; ?>"
                                            xpreview="<?php echo base_url("assets/admin/products/") . $product_detail[0]['product_image']; ?>"
                                            title="<?php echo $product_detail[0]['product_name']; ?>"></a>
                                    <?php if (!empty($product_detail[0]['image_gallery'])) { ?>
                                        <?php $product_image = explode(",", $product_detail[0]['image_gallery']);
                                        foreach ($product_image as $key => $value) { ?>
                                            <a href="<?php echo base_url("assets/admin/products/") . $value; ?>"><img
                                                    class="xzoom-gallery5" width="80"
                                                    src="<?php echo base_url("assets/admin/products/") . $value; ?>"
                                                    xpreview="<?php echo base_url("assets/admin/products/") . $value; ?>"
                                                    title="<?php echo $product_detail[0]['product_name']; ?>"></a>
                                        <?php }
                                    } ?>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="product-right product-description-box">
                            ...
                            <div class="vendor_name_a">
                                <img class="vendor_name_a_img"
                                     src="<?php echo base_url(); ?>assets/frontend/images/vendor.png">
                            ...
                            <div
                                class="product-icon mb-3 wishlist<?php echo $product_detail[0]['id']; ?>">
                                <?php if ($product_detail[0]['wish_list'] == 1) { ?>
                                    <button class="wishlist-btn"
                                            onclick="remove_cart(<?php echo $product_detail[0]['id']; ?>,'detail')">
                                        <img class="wisl_icn_as"
                                             src="<?php echo base_url(); ?>assets/frontend/images/wish_icon.png">
                                        <span
                                            class="title-font"><?php echo lang('Added_To_WishList'); ?></span>
                                    </button>
                                <?php } else { ?>
                                    <button class="wishlist-btn"
                                            onclick="move_to_wish_list(<?php echo $product_detail[0]['id']; ?>,'detail')">
                                        <img class="wisl_icn_as"
                                             src="<?php echo base_url(); ?>assets/frontend/images/wish_icon.png">
                                        <span
                                            class="title-font"><?php echo lang('Added_To_WishList'); ?></span>
                            ...
                            <div class="wrp_cmpr_2">
                                <label>
                                    <input type="checkbox" class="add_check2 compare_ck"
                                           value="<?php echo $product_detail[0]['id']; ?>" <?php echo $product_detail[0]['is_compare']; ?> >
                                    <div
                                    ...
                                    <div class="accordion theme-accordion"
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne1" class="collapse show"
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        class="single-product-tables detail-section">
                                                    ...
                                                    <p class="descrp_detl_pfg">
                                                        <?php echo lang('Minimum_Order_Requirement'); ?>
                                                        : <?php echo $product_detail[0]['min_order_quantity']; ?>
                                                    </p>
                                                    <p class="descrp_detl_pfg">
                                                        <?php echo lang('PID'); ?>
                                                        : <?php echo $product_detail[0]['id']; ?>
                                                    </p>
                                                    <?php if (!empty($product_detail[0]['sku_code'])) { ?>
                                                        <p class="descrp_detl_pfg">
                                                            <?php echo lang('SKU_Information'); ?>
                                                            : <?php echo $product_detail[0]['sku_code']; ?>
                                                        </p>
                                                    <?php } ?>
                                                    ...
                                                    <?php if ($product_detail[0]['is_delivery_available'] == 0) { ?>
                                                        <div
                                                            style="margin-top: 10px;font-size: 15px;font-weight: 500;color: #7a7a7a;padding-left: 15px;"><?php echo lang('Delivery_not'); ?></div>
                                                    <?php } else { ?>
                                                        <div
                                                            style="margin-top: 10px;font-size: 15px;font-weight: 500;color: #7a7a7a;padding-left: 15px;"><?php echo lang('Delivery_to'); ?></div>
                                                    <?php } ?>
                                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="product-right product-form-box">
                            <div style="display: none;">
                                <h4>
                                    <del><?php echo $product_detail[0]['price']; ?><?php echo $currency_symbol; ?></del>
                                    <span>55% off</span></h4>
                            </div>
                            ...
                            <form id="buynow_form"
                                ...
                                <div class="product-description border-product">
                                    ...
                                    <?php if (!empty($product_detail[0]['unit_list'])) {
                                        ?>
                                        <select name="unit"
                                                class="form-control get_unit<?php echo 1; ?>">
                                            <?php
                                            foreach ($product_detail[0]['unit_list'] as $uld_key => $uld_value) {
                                                ?>
                                                <option
                                                    data-id="<?php echo $uld_value['id'] ?>"
                                                    value="<?php echo $uld_value['id'] ?>"><?php echo $uld_value['unit_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    <?php } ?>
                                    <?php if (isset($product_detail[0]['meta_data']) && !empty($product_detail[0]['meta_data'])) { ?>
                                        ...
                                        <select
                                            class="form-control select_size get_size<?php echo 1; ?>">
                           ...
                           <span class="input-group-prepend left_prpnd"><button
                                   type="button"
                                   class="btn quantity-left-minus" data-type="minus"
                                   data-field=""><i
                                       class="ti-angle-left"></i></button> </span>
                                            <input type="text" name="quantity"
                                                   class="form-control input-number detislqty"
                                                   value="<?php echo $product_detail[0]['min_order_quantity']; ?>">
                                            <span
                                                class="input-group-prepend right_prpnd"><button
                                                    type="button"
                                    ...
                                    <input type="hidden" name="pid"
                                           value="<?php echo $product_detail[0]['id']; ?>">
                                    <div class="clear"></div>
                                    <?php if ($product_detail[0]['is_stock'] == 1) { ?>
                                    ...
                                    <?php } ?>
                                    <div
                                        class="min_qty_label"><?php echo lang('Minimum_order_quantity'); ?>
                                        :<?php echo $product_detail[0]['min_order_quantity']; ?> </div>
                                    <div class="clear"></div>
                                ...
                                <div class="product-buttons">
                                    <?php if ($product_detail[0]['price_select'] == '1') { ?>
                                        <a href="javascript:void(0)"
                                           data-detislqty="detislqty"
                                           data-id="<?php echo $product_detail[0]['id']; ?>"
                                           data-unit="get_unit<?php echo 1; ?>"
                                           class="btn btn-solid add_crt_a add_to_cart2"><?php echo lang('Add_to_cart'); ?></a>
                                    <?php } else { ?>
                                        <a href="javascript:void(0)"
                                           data-detislqty="detislqty"
                                           data-class="get_size<?php echo 1; ?>"
                                           data-unit="get_unit<?php echo 1; ?>"
                                           data-id="<?php echo $product_detail[0]['id']; ?>"
                                           class="btn btn-solid add_crt_a add_to_cart2"><?php echo lang('Add_to_cart'); ?></a>
                                    <?php } ?>
                                    <input type="hidden" id="payment_mode"
                                           name="payment_mode" value="">
                                    <button type="button" id="detail_buynow"
                                            class="btn btn-solid buy_crt_a"><?php echo lang('buy_now'); ?></button>
                                </div>
                        </div>
                        </form>
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="review-top-tab" data-toggle="tab"
                               href="#top-review" role="tab"
                               aria-selected="false"><?php echo lang('Details'); ?></a>
                            <div class="material-border"></div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="rating-top-tab" data-toggle="tab"
                               href="#top-rating" role="tab" aria-selected="false">
                                <div class="3three-star new_rating">
                                    <?php echo $product_detail[0]['rating_element']; ?>
                                </div>
                            </a>
                    ...
                    <div class="tab-content nav-material" id="top-tabContent">
                        ...
                        <div class="tab-pane fade top_review_panel" id="top-review"
                             role="tabpanel" aria-labelledby="review-top-tab">
                                        ...
                                        foreach ($user_review as $ur_key => $ur_val) { ?>
                                            <div class="singl_review_as">
                                                <div class="right_review">
                                                    <div
                                                        class="revir_name">  <?php echo $ur_val['name']; ?> </div>
                        ...
                        <div class="tab-pane fade" id="top-rating" role="tabpanel"
                             aria-labelledby="rating-top-tab">
                            <div class="review_rat_giv" id="rating_div">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <label
                                            for="name"><?php echo lang('Name'); ?></label>
                                        <input type="text" class="form-control"
                                               id="rating_name"
                                               placeholder="<?php echo lang('Enter_your_name'); ?>"
                                               name="name">
                                    </div>
                                    <div class="col-md-6">
                                        <label
                                            for="email"><?php echo lang('Email'); ?></label>
                                        <input type="text" class="form-control"
                                               id="rating_email"
                                    ...
                                    <div class="col-md-12">
                                        <label
                                            for="review"><?php echo lang('Enter_Review'); ?></label>
                                        <input type="text" class="form-control"
                                               id="rating_review"
                                               placeholder="<?php echo lang('Enter_your_Review'); ?>"
                                               name="review">
                                    </div>

                                    <div class="col-md-12">
                                        <button class="btn btn-solid" id="btn_rating"
                                                type="button"><?php echo lang('Submit_your_Review'); ?></button>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="cat-top-review" role="tabpanel"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  placeholder="Wrire Your Message" id=""
                                            ...
                                            <div class="uplod_garg_pics">
                                                ...
                                                <div class="thum_view">
                                                    <div class="singl_img_up">
                                                        <img
                                                            src="https://i.insider.com/5cbf50dfd1a2f8074406a8b2?width=1100&format=jpeg&auto=webp">
                                                        <a href=""> <i
                                                                class="fa fa-times"></i>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="upld_pic_labl">
                                                    ...
                                                    <div class="ad_grg_pic_titl"> Upload
                                                        Pics
                                                    </div>
                                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="to_label_a">
                    ...
                    <div class="singl_input_right">
                        <textarea placeholder="Enter more requirements here"
                                  class="detl_msg_te" rows="3"></textarea>
                    </div>
                    <div class="clear"></div>
                </div>
...
<div class="modal fade" id="cont_suuplr_tb" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="theme-form" id="send_inquiry" method="post"
                      enctype="multipart/form-data">
                    <div class="form-row">

                        <div class="col-md-6">
                            <label for="name"><?php echo lang('To'); ?></label>
                            <input type="text" class="form-control" id="inq_name"
                                   name="vender_name"
                                   value="<?php echo $product_detail[0]['first_name']; ?>"
                                   readonly>
                            <input type="hidden" name="seller_id" id="inq_seller_id"
                                   value="<?php echo en_de_crypt($product_detail[0]['seller_id']); ?>">
                            <input type="hidden" name="pid"
                                   value="<?php echo en_de_crypt($product_detail[0]['id']); ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <label
                                for="inq_message"><?php echo lang('Message'); ?></label>
                            <textarea class="form-control message_text_are space"
                                      placeholder="<?php echo lang('Write_Your_Message'); ?>"
                                      id="inq_message" name="message"
                                      rows="6"></textarea>
                        </div>
                        <!--
                                       <div class="col-md-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label class="radio-inline">
                    <input type="radio" name="modal_payment"
                           value="<?php echo en_de_crypt('cash-on-del'); ?>"><?php echo lang('Virtual_Account_Transfer'); ?>
                </label>
                <label class="radio-inline">
                    <input type="radio" name='modal_payment'
                           value="<?php echo en_de_crypt('online'); ?>"><?php echo lang('Card'); ?>
                </label>
            </div>
            <div class="modal-footer">
                <button type="button" id="submit_model_btn"
                        class="btn btn-default submt_btn_po_dt"
                        data-dismiss="modal"><?php echo lang('aSubmit'); ?></button>
                <button type="button" class="btn btn-default clos_btn_pop_del"
        ...
        if (error == 1) {
            ...
            $.ajax({
                ...
                data: {
                    "name": rating_name,
                    "email": rating_email,
                    "comment": rating_review,
                    "rating": g_rating,
                    "pid": "<?php echo en_de_crypt($product_detail[0]['id']); ?>"
                },
                success: function (response) {
                    $('#loading').hide();
                    response = $.trim(response);
