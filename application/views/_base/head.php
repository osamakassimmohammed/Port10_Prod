...
<head>
    ...
    <link href="<?php echo base_url('assets/frontend/images/'); ?>favicon.png"
    ...
    <?php if (strpos(current_url(), base_url($language . "/admin")) !== false) {
        ...
        <script async
                src="https://www.googletagmanager.com/gtag/js?id=G-P3MV9XYRT7"></script>
        <script>
...
<body
    class="home-page is-dropdn-click has-slider <?php echo $body_class; ?> <?php echo @$language; ?>">


<div class="rotet_mode mobile" style="display: none;">
    <img class="rotet_img_en"
         src="<?php echo base_url(); ?>assets/frontend/images/rot.jpg">
    <img class="rotet_img_ar"
         src="<?php echo base_url(); ?>assets/frontend/images/rot_ar.jpg">
</div>
