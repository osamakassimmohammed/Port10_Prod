<div class="container" style="text-align: center;margin-top: 3%;margin-bottom: 12%;">
    ...
    <div class="change-password section profil_sectn_page change_pass_sectn_wrap">
        ...
        <form id="verify_form1"
              action="<?php echo base_url($language . '/login/resetpassword/'); ?><?php echo $uid; ?>/<?php echo $code; ?>"
            ...
            <?php if (!empty($this->session->flashdata('error1'))) { ?>
                <div class="alert alert-error">
                    ...
                    <strong>error
                        !</strong> <?php echo $this->session->flashdata('error1'); ?> .
                </div>
            <?php } ?>
            ...
            <div class="asd">
                <div class="form-group">
                    <p>New Password <i class="fa fa-question-circle" aria-hidden="true"
                    ...
                    <input type="password" class="form-control"
                           placeholder="Enter New Password" name="password" id="new_pw">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="submit" name="submit" onsubmit="return checkpass();"
                           class="btn vibrate1" value="Update">
                </div>
