                ...
                <div class="col-lg-6 right-login sing_up_tn_wrp">
                    ...
                    <div class="wow signup_formmn" data-wow-duration="0.7s" data-wow-delay="0.0s" style="visibility: visible; animation-duration: 0.7s; animation-delay: 0.0s;" >
                      ...
                      <div class="sub_feature">
                        <span class="sub_point"> <i class="fa fa-circle" aria-hidden="true"></i></span><?php echo $sup_val['description']; ?>
                      </div>
                      <?php } }  ?>
                      <div class="sub_btn_div">
                        <button style="width: 200px" id="next1" type="button" class="btn btn-solid dealer_check" data-id="<?php echo en_de_crypt($subs_plans[0]['id']); ?>"><?php echo lang('JOIN'); ?></button>                        
                      </div>
                    </div>
                </div>
         ...
         {            
            ...
            if(response.status==true)
            {
               // url="<?php //echo base_url($language.'/payment/index/'); ?>"+id;             
                setTimeout(function(){ window.location=response.message; },500);
            }else 
            {
              $("#loading").hide();
