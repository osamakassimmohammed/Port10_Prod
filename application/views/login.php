    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 sing_in_tn_wrp">
                ...
                <div class="cover_panl_login cove_panel_hide wow slideInRight"
                ...
                <div class="wow signin_formmn" data-wow-duration="0.7s"
                     data-wow-delay="0.0s"
                    ...
                    <div class="theme-card">
                        <form class="theme-form" method="POST" id="login_form">
                            <div class="form-group first_fld_top">
                                <label
                                    for="lcr_number"><?php echo lang('Enter_CR'); ?></label>
                                <input type="text" class="form-control" id="lcr_number"
                                       placeholder="<?php echo lang('Enter_CR'); ?>"
                                       name="cr_number"
                                       value="<?php echo $remember_arr['remember_user_name']; ?>">
                            </div>
                            <div class="form-group">
                                <label
                                    for="lpass"><?php echo lang('Enter_Your_Password'); ?></label>
                                <input type="password" class="form-control" id="lpass"
                                       placeholder="<?php echo lang('Enter_Your_Password'); ?>"
                                       name="pass"
                                       value="<?php echo $remember_arr['remember_password']; ?>">
                                <label class="">
                                    <input type="checkbox"
                                           name="remember_me" <?php echo $remember_c; ?> >
                                    <span
                                        class="login_ck_spn"><?php echo lang('Keep_Me_Signed_In'); ?></span>
                                </label>
                            </div>
                            <button
                                class="btn btn-solid sign_in"> <?php echo lang('Sign_In'); ?></button>
                            <br/>

                            <a id="forget_pss_link" href="javascript:void(0)"
                               class="forgt_pass"> <?php echo lang('Forgot_Password'); ?>
                                ? </a>
                            <div class="clear"></div>
                        </form>
                    </div>
                ...
                <div class="forget_form" style="display: none;">
                    ...
                    <div class="theme-card">
                        <form class="theme-form" method="POST" id="forget_form">
                            <div class="form-group first_fld_top">
                                <label
                                    for="lcr_number"><?php echo lang('Email_Id'); ?></label>
                            ...
                            <div class="form-group first_fld_top">
                                <label
                                    for="lcr_number"><?php echo lang('CR_Number'); ?></label>
                                <input type="text" class="form-control"
                                       id="forget_cr_number"
                                       placeholder="<?php echo lang('Enter_CR_Number'); ?>"
                                       name="cr_number">
                            </div>
                            <button
                            ...
                            <a id="sign_in_link" href="javascript:void(0)"
                               class="forgt_pass"> <?php echo lang('Sign_In'); ?>  </a>
                            <div class="clear"></div>
                        </form>
                    </div>
                    ...
                    <div class="theme-card authentication-right registr_form_main">
                        <form class="theme-form" id="signup_form" method="POST">
                            <div class="register_panl_1">
                                ...
                                <div class="form-group first_fld_top ">
                                    <label
                                        for="stype"><?php echo lang('Select_Account_Type'); ?>
                                        <span class="strict">*</span></label>
                                    <select class="form-control acount_typ_as"
                                            id="stype" name="type">
                                        <option
                                            value=""><?php echo lang('Select_Account_Type'); ?></option>
                                ...
                                <div class="form-group">
                                    <label
                                        for="sestiblishment"><?php echo lang('Entity_Name'); ?>
                                        <span class="strict">*</span><i
                                            class="fa fa-info-circle" aria-hidden="true"
                                            data-toggle="tooltip" data-placement="top"
                                            title="<?php echo lang('Name_of_the_Manufacturer_or_Wholesaler'); ?>"></i></label>
                                    <input type="text"
                                           class="form-control space"
                                           id="sestiblishment"
                                           placeholder="<?php echo lang('Entity_Name'); ?>"
                                           name="entity_name">
                                </div>
                                <div class="form-group">
                                    <label
                                        for="scr_number"><?php echo lang('CR_Number'); ?>
                                        <span class="strict">*</span></label>
                                    <input type="text" class="form-control space"
                                           id="scr_number"
                                           placeholder="<?php echo lang('CR_Number'); ?>"
                                           name="cr_number"
                                           maxlength="10"
                                ...
                                <button style="margin-right: 95px;width: 200px"
                                        id="next1" type="button"
                                        class="btn btn-solid regist_nex next_registr1"><?php echo lang('Next'); ?></button>
                            ...
                            <div class="register_panl_2">
                                <div class="form-group">
                                    <label
                                        for="sstreet_name"><?php echo lang('Street_Name'); ?> </label>
                                    <input type="text" class="form-control space"
                                           id="sstreet_name"
                                           placeholder="<?php echo lang('Street_Name'); ?>"
                                           name="street_name">
                                </div>
                                <div class="form-group">
                                    <label
                                        for="sbuilding_no"><?php echo lang('Building_Num'); ?> </label>
                                    <input type="text" class="form-control space"
                                           id="sbuilding_no"
                                           placeholder="<?php echo lang('Building_Num'); ?>"
                                           name="building_no">
                                </div>

                                <div class="form-group hlf_fld_lft">
                                    <label for="scity"><?php echo lang('City'); ?> <span
                                            class="strict">*</span></label>
                                    <select class="form-control " id="scity"
                                            name="city">
                                        <option
                                            value=""><?php echo lang('Select_City'); ?></option>
                                        <?php if (!empty($city_list)) {
                                            foreach ($city_list as $cl_key => $cl_val) { ?>
                                                <option
                                                    value="<?php echo $cl_val['city_name']; ?>"><?php echo $cl_val['city_name']; ?></option>
                                            <?php }
                                        } ?>
                                    </select>
                                ...
                                <div class="form-group hlf_fld_right">
                                    <label
                                        for="sstate"><?php echo lang('State_Province_Region'); ?>
                                        <span class="strict">*</span></label>
                                    <select class="form-control " id="sstate"
                                            name="state">
                                        <option
                                            value=""><?php echo lang('Select_State_Province_Region'); ?></option>
                                        <?php if (!empty($state_list)) {
                                            foreach ($state_list as $sl_key => $sl_val) { ?>
                                                <option
                                                    value="<?php echo $sl_val['state_name']; ?>"><?php echo $sl_val['state_name']; ?></option>
                                            <?php }
                                        } ?>
                                    </select>
                                </div>
                                ...
                                <!-- <div style="display: none;" class="form-group hlf_fld_lft">
                                    <label for="spostal_code"><?php //echo lang('Zip_Or_Postal_Code'); ?> </label>
                                    <select class="form-control " id="spostal_code1" name="postal_code1">
                                        <option value=""><?php //echo lang('Select_Zip_Or_Postal_Code'); ?></option>
                                        <?php if (!empty($postal_code_list)) {
                                    foreach ($postal_code_list as $pcl_key => $pcl_val) { ?>
                                                <option value="<?php //echo $pcl_val['postal_code']; ?>"><? php// echo $pcl_val['postal_code']; ?></option>
                                        <?php }
                                } ?>
                                    </select>
                                </div> -->
                                ...
                                <div class="form-group hlf_fld_lft">
                                    <label
                                        for="scountry"><?php echo lang('Zip_Or_Postal_Code'); ?></label>
                                    <input type="text" class="form-control space"
                                           id="spostal_code"
                                ...
                                <div class="form-group hlf_fld_right">
                                    <label
                                        for="scountry"><?php echo lang('Country'); ?></label>
                                    <input type="text" class="form-control space"
                                           id="scountry"
                                           placeholder="<?php echo lang('Country'); ?>"
                                           value="Saudi Arabia" name="country" readonly>
                                </div>
                                ...
                                <button type="button" id="next2"
                                        class="btn btn-solid regist_nex next_registr2"><?php echo lang('Next'); ?></button>
                            ...
                            <div class="register_panl_3">
                                <div class="form-group hlf_fld_lft">
                                    <label for="sphone"><?php echo lang('Phone'); ?>
                                        <span class="strict">*</span></label>

                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">+966</span>
                                        <input type="text" class="form-control space2 ccp"
                                            id="sphone"
                                ...
                                <div class="form-group hlf_fld_right">
                                    <label for="semail"><?php echo lang('Email'); ?>
                                        <span class="strict">*</span></label>
                                    <input type="text" class="form-control space"
                                           id="semail"
                                ...
                                <div class="form-group hlf_fld_lft">
                                    <label
                                        for="svat_number"><?php echo lang('VAT_Number'); ?>
                                        <span class="strict">*</span></label>
                                    <input type="text" class="form-control"
                                           id="svat_number"
                                           placeholder="<?php echo lang('VAT_Number'); ?>"
                                           name="vat_number"
                                           onkeypress="return isNumberKey(event)">
                                </div>
                                <div class="form-group hlf_fld_right">
                                    <label
                                        for="sbank_name"><?php echo lang('Preferred_Bank_Name'); ?>
                                        <span class="strict">*</span></label>
                                    <select class="form-control " id="sbank_name"
                                            name="bank_name">
                                        <option
                                            value=""><?php echo lang('Select_Preferred_Bank_Name'); ?></option>
                                        <?php if (!empty($bank_details)) {
                                            foreach ($bank_details as $bd_key => $bd_val) { ?>
                                                <option
                                                    value="<?php echo $bd_val['id']; ?>"><?php echo $bd_val['bank_name']; ?></option>
                                            <?php }
                                        } ?>
                                    </select>
                                </div>
                                <div class="clear"></div>
                                <div class="form-group hlf_fld_lft">
                                    <label for="siban"><?php echo lang('IBAN'); ?> <span
                                            class="strict">*</span></label>
                                    <input type="text" class="form-control isSpecial"
                                           id="siban"
                                           data-grouplength="4" data-maxlength="24" placeholder="e.g SA00 0000 0000 0000 0000 0000"
                                           name="iban">
                                </div>

                                <div class="form-group hlf_fld_right">
                                    <label
                                        for="sbank_name"><?php echo lang('User_Name'); ?>
                                        <span class="strict">*</span><i
                                            class="fa fa-info-circle" aria-hidden="true"
                                            data-toggle="tooltip" data-placement="top"
                                            title="<?php echo lang('Name_of_the_individual'); ?>"></i></label>
                                    <input type="text" class="form-control space"
                                           id="sfirst_name"
                                ...
                                <div class="clear"></div>
                                <div class="form-group hlf_fld_lft">
                                    <label for="spass"> <?php echo lang('Password'); ?>
                                        <span class="strict">*</span><i
                                            class="fa fa-question-circle"
                                            aria-hidden="true" data-toggle="tooltip"
                                            data-placement="top"
                                            title="<?php echo lang('password_Minimum'); ?>"></i></label>
                                ...
                                <div class="form-group hlf_fld_right">
                                    <label
                                        for="scpass"><?php echo lang('Confirm_Password'); ?>
                                        <span class="strict">*</span></label>
                                    <input type="password" class="form-control"
                                           id="scpass"
                                ...
                                <button
                                    class="btn btn-solid regist_nex next_registr3"><?php echo lang('Sign_Up'); ?></button>
...
<script type="text/javascript">
    document.querySelector("#siban").addEventListener("input", e => {
    let v = e.target.value.replaceAll(/[^0-9A-Z]/g, ""),
...
<script type="text/javascript">
    ...
    $(document).on("submit", "#forget_form", function (e) {
        ...
        if (forget_cr_number == "") {
            error = 0;
            stepthree = 0;
            invalid('#forget_cr_number');
            swal("", "<?php echo lang('Please_Enter_CR_Number'); ?>", "warning");
            return false;
        }else{
            valid('#forget_cr_number');
        }
