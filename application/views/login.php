                        ...
                        <form class="theme-form" method="POST" id="login_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="lpass"
                                    placeholder="<?php echo lang('Enter_Your_Password'); ?>" name="pass" value="<?php echo $remember_arr['remember_password']; ?>">
                                    <label  class="" > 
                            ...
                            <div class="register_panl_1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control space" id="scr_number"
                                        placeholder="<?php echo lang('CR_Number'); ?>" name="cr_number" onkeypress="return isNumberKey(event)">
            ...
            $.ajax({
                    ...
                    { 
                        ...
                        {                
                            ...
                            setTimeout(function(){ window.location = "<?php echo base_url($language.'/home') ?>" }, 3500);
            ...
            success: function(response){
              $('#loading').hide();
                switch (response) {
                    ...
                    case 'logged_user':
                     setTimeout(function(){ window.location = "<?php echo base_url($language) ?>" }, 1500);
                     break;

                    case 'success':
                        swal('',"<?php echo lang('Login_Successfully'); ?>",'success');
                        // setTimeout(function(){ },2900);
                         setTimeout(function(){ window.location = "<?php echo base_url($language.'/home') ?>" }, 1500);                        
                        break;

                    case 'success1':
                        swal('',"<?php echo lang('Login_Successfully'); ?>",'success');
                        // setTimeout(function(){ },2900);
                         setTimeout(function(){ window.location = "<?php echo base_url($language.'/admin') ?>" }, 1500);                        
                        break;
                    case 'expired':
                        plan_swal();                        
                        break;        
        ...
        closeOnCancel: true
         ...
         function(inputValue){            
          if (inputValue===true) {                        
            ...
            setTimeout(function(){ window.location = "<?php echo base_url('admin') ?>" }, 500);
          } 
        });
  } 
</script>     