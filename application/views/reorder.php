   ...
   <div class="container container_detl_wdth container_detl_wdth_checkOut">
      <div class="checkout-page">
         <div class="checkout-form">
            <?php if(isset($in_id)){ ?>
            <form id="form_place_order" action="<?php echo base_url($language.'/order/invoice_purchase/').$in_id ?>" method="POST">
            <?php }else{ ?>
              <form id="form_place_order" action="<?php echo base_url($language.'/order/place_buynow/') ?>" method="POST">
            <?php } ?>
               <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-12 col-xs-12">
                     ...
                     <div class="row check-out">
                        ...
                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                           ...
                           <input type="text" id="ck_email" name="email" value="<?php echo $email; ?>" placeholder="<?php echo lang('Enter_email_id'); ?>">
                        </div>
                        ...
                        <div class="order-box">
                           ...
                           <ul class="qty">
                             ...
                             foreach ($data_res['data'] as $d_key => $dvalue) {
                              ...
                              <li><img class="ck_img" src="<?php echo base_url('assets/admin/products/').$data_res['data'][0]['product_image'] ?>" > <label class="ck_test ch_pro"><?php echo $data_res['data'][0]['product_name'] ?></label> <p class="ck_test ck_pri_qty" ><?php echo $currency_symbol; echo " ";  echo $data_res['data'][0]['sale_price']; echo ' <i class="fa fa-times" aria-hidden="true"></i> '; echo $data_res['data'][0]['quantity'] ?></p> <span><?php echo $currency_symbol ?> <?php echo number_format($data_res['data'][0]['sale_price']*$data_res['data'][0]['quantity'] ); ?> </span></li>
                           ...
                           <ul class="sub-total">
                              <li><?php echo lang('Total_before_VAT'); ?> <span class="count"><?php echo $currency_symbol ?> <?php echo decnum($product_fees_without_vat); ?> </span></li>
                              <li><?php echo lang('Estimated_VAT_to_be_collected'); ?> <span class="count"><?php echo $currency_symbol ?> <?php echo decnum($vat_calulated); ?> </span></li>
