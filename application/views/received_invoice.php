        ...
        <aside class="col-md-12 col-sm-12 space-bottom-20 ">
            <?php if (!empty($invlice_list)) { ?>
                <div class="account-details-wrap ">
                    <div
                        class="title-2 sub-title-small"> <?php echo lang('Quotations'); ?> </div>
                            ...
                            <div class="row top_pading_sec">
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Ref_Number'); ?></div>
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Date'); ?></div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Supplier_Name'); ?></div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_12">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Address'); ?></div>
                                        <div class="ref_num_label">
                                ...
                                <div class="radio-option hide_cart_div hide_cart_div1">
                                    ...
                                    <input type="radio" class="com_mode"
                                    ...
                                    <label for="ck_online"><?php echo lang('Card'); ?>
                                        <span class="image">
                        </span></label>
                                ...
                                <table class="tabl_vat_as" id="cod_table"
                                       style="display: none">
                                    <tr>
                                        <td class="lbl_tr_tb"> <?php echo lang('Sub_total'); ?>
                                            :
                                        </td>
                                        <td class="ans_lbl_tr_tb"> <?php echo decnum($price); ?> </td>
                                    </tr>
                                    <tr>
                                        <td class="lbl_tr_tb"> <?php echo lang('fees'); ?>
                                            :
                                        </td>
                                        <td class="ans_lbl_tr_tb"> <?php echo decnum($all_feescod); ?> </td>
                                    </tr>
                                    <tr>
                                        <td class="lbl_tr_tb"> <?php echo lang('VAT'); ?>
                                            :
                                        </td>
                                        <td class="ans_lbl_tr_tb"> <?php echo decnum($vat_calulated_cod); ?> </td>
                                    </tr>
                                    <tr>
                                        <td class="lbl_tr_tb"> <?php echo lang('Total_Amount'); ?>
                                            :
                                        </td>
                                        <td class="ans_lbl_tr_tb"> <?php echo decnum($grand_total_cod); ?> </td>
                                    </tr>
                                </table>
                                <table class="tabl_vat_as" id="onlie_table"
                                       style="display: none">
                                    <tr>
                                        <td class="lbl_tr_tb"><?php echo lang('Net_Amount'); ?>
                                            :
                                        </td>
                                        <td class="ans_lbl_tr_tb"> <?php echo decnum($price); ?> </td>
                                    </tr>
                                ...
                                <?php if (empty($invlice_list[0]['invoice_status'])) { ?>
                                    <a class="purh_btn_as"
                                       href="javascript:void()"><?php echo lang('You_quotation_status_is_Pending'); ?> </a>
                                <?php } else if ($invlice_list[0]['invoice_status'] == 'Rejected') { ?>
                                    <a class="purh_btn_as" style="background:#ea0b2a"
                                       href="javascript:void()"><?php echo lang('You_quotation_Rejected_By_seller'); ?> </a>
                                <?php } else if ($invlice_list[0]['invoice_status'] == 'Cancelled') { ?>
                                    <a class="purh_btn_as" style="background:#ea0b2a"
                                       href="javascript:void()"><?php echo lang('You_Cancelled_You_Request'); ?> </a>
                                <?php } else { ?>
                                    <a class="purh_btn_as" id="vc_addlink"
                                       style="display: none"
                                       href="<?php echo base_url($language . '/order/invoice_purchase/') . $invlice_list[0]['in_id']; ?>"><?php echo lang('Purchase'); ?> </a>
                                    <a class="purh_btn_as" id="vc_out"
                                       href="javascript:void(0)"><?php echo lang('Purchase'); ?> </a>
                                <?php } ?>
                                <div class="clear"></div>
                            </div>
                        </form>
