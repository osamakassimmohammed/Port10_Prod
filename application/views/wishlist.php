         ...
         <div class="col-sm-12">
            ...
            <div class="left_cart_box hide_cart_div">
               <table class="table cart-table table-responsive-xs ">
                  <thead>
                     <tr class="table-head">
                        <th scope="col" class="th_crt2"><?php echo lang('Items'); ?></th>
                        <!-- <th scope="col" class="th_crt3" >product name</th> -->
                        <th scope="col" class="th_crt4" style="text-align: left; padding-left: 42px;"><?php echo lang('quantity'); ?></th>
                     ...
                     <tr class="remove_pro<?php echo $product_value['id']; ?> row_count">
                        <td class="th_crt2">
                           ...
                           <div class="nme_sec_right">
                              <a class="prdct_name_cart" href="<?php echo base_url($language.'/home/detail/').$product_value['id']; ?>"> <span> <?Php echo $product_value['product_name']; ?></span> </a>
                           </div>
                           <br/>
                        ...
                        <td class="th_crt4">
                           <div class="qty qty-changer qty-changer_cart">
                              <fieldset>
                                 ...
                                 <input type="text" class="qty-input detislqty<?php echo $i ?>" value="1" data-min="1" data-max="10" id="m1m7" data-value="1" disabled=""> 
