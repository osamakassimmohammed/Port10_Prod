...
<link href="<?php echo base_url(); ?>assets/frontend/fonts/icomoon/icomoon.css" rel="stylesheet">
<style type="text/css">
   .hide_data {
      display: none;
   }
   ...
   <div class="container container_detl_wdth">
      <div class="row ">
         <div class="col-sm-12 p-4">
            <h2 class="<?php echo $hide; ?> text-center text-danger"><?php echo lang('YOUR_WISHLIST_IS_EMPTY'); ?></h2>
            <div class="<?php echo $hide; ?> d-flex justify-content-center mt-4 show_compare"><a href="<?php echo base_url($language . '/home'); ?>"><button class="<?php echo $hide; ?> btn btn-solid show_compare"><?php echo lang('aAdd_Items'); ?></button></a></div>
                  ...
                  <table class="table cart-table table-responsive-xs ">
                     <thead>
                        <tr class="table-head">
                           ...
                           <th scope="col" class="th_crt4" style="text-align: left; padding-left: 42px;">
                           ...
                           <tr class="remove_pro<?php echo $product_value['id']; ?> row_count">
                              <td class="th_crt2">
                                 ...
                                 <div class="nme_sec_right">
                                    <a class="prdct_name_cart"
                                       href="<?php echo base_url($language . '/home/detail/') . $product_value['id']; ?>"> <span>
                                 ...
                                 <?php if (!empty($product_value['unit_list'])) { ?>
                                    <select class="form-control select_unit get_unit<?php echo $i; ?>">
                                       ...
                                       foreach ($product_value['unit_list'] as $uld_key => $uld_value) {
                                          ?>
                                          <option data-id="<?php echo $uld_value['id'] ?>"><?php echo $uld_value['unit_name']; ?>
                                          </option>
                                       <?php } ?>
                                    </select>
                                 <?php } ?>
                                 <?php if (isset($product_value['meta_data']) && !empty($product_value['meta_data'])) { ?>
                                    <select class="form-control select_size get_size<?php echo $i; ?>">
                                       ...
                                       <?php foreach ($product_value['meta_data'] as $md_key => $md_val) { ?>
                                          <option data-price="<?php echo $md_val['price']; ?>"
                                             data-value="<?php echo $md_val['size']; ?>" value="<?php echo $md_val['item_id']; ?>">
                                             <?php echo $md_val['size']; ?></option>
                                       <?php } ?>
                                    </select>
                                 <?php } ?>
                              ...
                              <td class="th_crt4">
                                 <div class="qty qty-changer qty-changer_cart">
                                    <fieldset>
                                       <span type="button" value="‒" class="decrease"></span>
                                       <input type="text" class="qty-input detislqty<?php echo $i ?>" value="<?php echo $product_value['min_order_quantity'] ?>" data-min="1"
                                          data-max="10" id="m1m7" data-value="1">
                                       <span type="button" value="+" class="increase"></span>
                                    </fieldset>
                                 </div>
                              </td>
                              <td class="th_crt5">
                              ...
                              <td class="th_crt6">
                                 <div>
                                    <a data-toggle="tooltip" title="" href="javascript:void(0)" class="icon delete_pro"
                                       onclick="remove_cart(<?php echo $product_value['id']; ?>,'wishlist')"
                                       data-original-title="Remove"><i class="fa fa-times-circle"
                              ...
                              <td class="th_crt7">
                                 <h2 class="td-color">
                                    <?php if ($product_value['price_select'] == '1') { ?>
                                       <a href="javascript:void(0)" class="ad_to_cart add_to_cart2"
                                          data-id="<?php echo $product_value['id']; ?>" data-unit="get_unit<?php echo $i; ?>"
                                          data-detislqty="<?php echo  $product_value['min_order_quantity'] ?>" class="add_to_cart2"> <?php echo lang('Add_to_cart'); ?> </a>
                                    <?php } else { ?>
                                       <a href="javascript:void(0)" class="ad_to_cart" data-class="get_size<?php echo $i; ?>"
                                          data-id="<?php echo $product_value['id']; ?>" data-unit="get_unit<?php echo $i; ?>"
                                          data-detislqty="<?php echo  $product_value['min_order_quantity'] ?>"> <?php echo lang('Add_to_cart'); ?></a>
                                    <?php } ?>
                                 </h2>
                              </td>
                           </tr>
