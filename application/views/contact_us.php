                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control space"
                                   id="cfirst_name" name="first_name"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control space"
                                   id="clast_name" name="last_name"
                                   placeholder="<?php echo lang('Enter_Your_Last_Name'); ?>">
                        </div>
                        <div class="col-md-6">
                            <label
                                for="review"><?php echo lang('Phone_number'); ?></label>
                            <input type="text" class="form-control" id="cphone"
                                   name="phone"
                                   placeholder="<?php echo lang('Enter_your_number'); ?>"
                                   onkeypress="return isNumberKey(event)">
                        </div>
                        <div class="col-md-6">
                            <label for="email"><?php echo lang('Email'); ?></label>
                            <input type="text" class="form-control space" id="cemail"
                                   name="email"
                                   placeholder="<?php echo lang('Please_enter_your_email'); ?>">
                        </div>
                        <div class="col-md-12">
                            <label
                                for="review"><?php echo lang('Write_Your_Message'); ?></label>
                            <textarea class="form-control space"
