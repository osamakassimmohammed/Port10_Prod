                            ...
                            <div class="row top_pading_sec">
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Quotation_Id'); ?> </div>
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('aCustomer_Name'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('product_name'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Product_Group'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Purchase_Cycle'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Customization'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Deadline_for_Submission'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Product_No_SKU'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('HS_Code'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Unit'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('quantity'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Destination'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Delivery_Date'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Incoterms'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Certification'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('aSeller_Name'); ?> </div>
                                        <div class="ref_num_label">
                                ...
                                <div class="col-md-6 col-sm-6 smal_3">
                                    <div class="form-group">
                                        <div
                                            class="label_new"> <?php echo lang('Information'); ?>  </div>
                                        <div class="ref_num_label">
