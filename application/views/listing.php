            ...
            <div class="row">
                ...
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                        ...
                        <div class="min_ord_nty">
                            ...
                            <div class="minmord_wrppls">
                                ...
                                <a class="minm_add minm_add_mins" data-type="minus"
                                   href="javascript:void(0)">-</a>
                                <input class="minmord_input" type="text" readonly
                                       onkeydown="return false">
                                <a class="minm_add" data-type="plus"
                                   href="javascript:void(0)">+</a>
                        ...
                        <div class="collection-collapse-block open singl_checkbox_lst">
                            <div
                                ...
                                <input type="checkbox"
                                       class="custom-control-input class_click"
                                       value="1" name="sample_order" id="sample_order">
                        ...
                        <div class="collection-collapse-block border-0 ">
                            ...
                            <div class="filter_cat_search">
                                <input type="text"
                                       placeholder="<?php echo lang('Sub_category'); ?>"
                                       class="filter_cat_input">
                                <i class="fa fa-search filter_cat_icon"></i>
                            </div>
                            <div class="collection-brand-filter"
                                 id="append_subcat_html">
                                <?php if (!empty($subcategory_data)) {
                                    foreach ($subcategory_data as $sscd_key => $sscd_val) { ?>
                                        <div
                                            class="custom-control custom-checkbox collection-filter-checkbox">
                                            <input type="checkbox"
                                                   class="custom-control-input class_click2"
                                                   name="s_catids"
                                                   id="s_catids<?php echo $sscd_key + 1; ?>"
                                                   value="<?php echo $sscd_val['id']; ?>">
                                            <label class="custom-control-label"
                                                   for="s_catids<?php echo $sscd_key + 1; ?>"><?php echo $sscd_val['display_name']; ?></label>
                                        </div>
                                    <?php }
                                } ?>
                        ...
                        <div class="collection-collapse-block border-0 ">
                            ...
                            <div class="filter_brand_search">
                                <input type="text"
                                       placeholder="<?php echo lang('Brand'); ?>"
                                       class="filter_brand_input">
                                <i class="fa fa-search filter_cat_icon"></i>
                            </div>
                                    ...
                                    foreach ($brand_data as $bd_key => $bd_val) { ?>
                                        <div
                                            ...
                                            <input type="checkbox"
                                                   class="custom-control-input class_click"
                                                   name="brand_id"
                                                   id="brand<?php echo $bd_key + 1; ?>"
                                                   value="<?php echo $bd_val['id']; ?>">
                                            <label class="custom-control-label"
                                                   for="brand<?php echo $bd_key + 1; ?>"><?php echo $bd_val['brand_name']; ?></label>
                                        </div>
                                    <?php }
                                } else { ?>
                                    <div
                                        class="custom-control custom-checkbox collection-filter-checkbox">
                                        <label class="custom-control-label"
                                               for="hundred"> Brand not found will
                                            update soon.!!</label>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="collection-collapse-block border-0 price_tb_as">
                            ...
                            <div class="collection-collapse-block-content "
                                 style="display: none;">
                                <input class="space2" type="text" id="min_price"
                                       style=""
                                       placeholder="<?php echo lang('Min_Price'); ?>"
                                       onkeypress="return isNumberKey(event)">
                                <input class="space2" type="text" id="max_price"
                                       style=""
                                       placeholder="<?php echo lang('Max_Price'); ?>"
                                       onkeypress="return isNumberKey(event)">
                                <div class="clear"></div>
                                <button type="button" class="btn btn-info"
                                        id="price_btn"
                                        style=""><?php echo lang('Apply_Price'); ?></button>
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="collection-sidebar-banner">
                        <a href="#"><img src="" class="img-fluid blur-up lazyload"
                                         alt=""></a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="collection-product-wrapper">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 wrap_reslt_as">
                                                ...
                                                <div class="wrap_main_right_slct">
                                                    ...
                                                    <div
                                                        class="product-filter-content serch_wrp_a">
                                                            ...
                                                            <select
                                                                ...
                                                                <?php if (!empty($main_category)) {
                                                                    foreach ($main_category as $mc_key => $mc_val) {
                                                                        ...
                                                                        <option
                                                                        value="<?php echo $mc_val['id']; ?>" <?php echo $lis_selected; ?>><?php echo $mc_val['display_name']; ?></option><?php }
                                                                } ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="serch_prodct_wrp">
                                                            <input type="text"
                                                                   placeholder="<?php echo lang('Search_Product'); ?>"
                                                                   class="searchproduct_inpt">
                                                        ...
                                                        <div
                                                            ...
                                                            <select id="sort_product">
                                                                <option
                                                                    value="0"><?php echo lang('Sorting_items'); ?></option>
                                                                <option
                                                                    value="asc"><?php echo lang('Price_Lower_to_Higher'); ?></option>
                                                                <option
                                                                    value="desc"><?php echo lang('Price_Higher_to_Lower'); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div
                                        class="product-wrapper-grid listing_page_pad new_list_pg_as">
                                        <div class="no-slider row"
                                             id="append_search_data">
                                                    ...
                                                    <div class="product-box">
                                                        ...
                                                        <div class="product-detail">
                                                            <?php if (!empty($product_value['unit_list'])) { ?>
                                                                <select
                                                                    class="form-control select_unit get_unit<?php echo $product_key; ?>">
                                                                    <?php
                                                            ...
                                                            <?php if (isset($product_value['meta_data']) && !empty($product_value['meta_data'])) { ?>
                                                                <select
                                                                    class="form-control select_size get_size<?php echo $product_key; ?>">
                                                                    <option value="0">
                                                                        Select Size
                                                                    </option>
                                                ...
                                                <?php } ?>
                                                                ...
                                                                <?php if ($product_value['price_select'] == '1') { ?>
                                                                    <button
                                                                        ...
                                                                        data-unit="get_unit<?php echo $product_key; ?>"
                                                                ...
                                                                <?php } else { ?>
                                                                    <button
                                                                        title="<?php echo lang('Add_to_cart'); ?>"
                                                                        data-class="get_size<?php echo $product_key; ?>"
                                                                        data-id="<?php echo $product_value['id']; ?>"
                                                                        data-unit="get_unit<?php echo $product_key; ?>"
                                                                        data-detislqty="<?php echo $product_value['min_order_quantity']; ?>"
                                                                        class="add_to_cart2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <h5><?php echo lang('Showing_Products'); ?>
                                                            <span
                                                                id="start"><?php echo (!empty($product_data)) ? $row + 1 : '0'; ?></span>-<span
                                                                id="total_record"><?php echo $total_rows; ?></span>
                                                            of <span
                                                                id="per_page"><?php echo (!empty($product_data)) ? $rowperpage : '0'; ?></span> <?php echo lang('Result'); ?>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
    ...
    function all_product_listing(flag = '') {
        ...
        $.ajax({
            ...
            data: {
                ...
                ajax: ajax,
                'brand_id': gbrand_id,
                'min_price': gmin_price,
                'max_price': gmax_price,
                'min_order_q': gmin_order_q,
                's_catids': gs_catids,
                'sample_order': gsample_order
            },
