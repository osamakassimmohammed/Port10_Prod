		...
		if (!empty($product_data)) {
			...
			foreach ($product_data as $product_key => $product_value) {
				...
				if ($product_value['price_select'] == '1') {
					$html_tag .= '<button title="Add to cart" data-id="' . $product_value['id'] . '" data-unit="get_unit' . $product_key . '" data-detislqty="' . $product_value['min_order_quantity'] . '" class="add_to_cart2" style="width:90%;margin-left:4%"><i class="ti-shopping-cart"></i> Add to cart           </button>';
				} else {

					$html_tag .= '<button title="Add to cart"data-class="get_size' . $product_key . '" data-id="' . $product_value['id'] . '" data-unit="get_unit' . $product_key . '" data-detislqty="' . $product_value['min_order_quantity'] . '" class="add_to_cart2" style="width:90%;margin-left:4%"><i class="ti-shopping-cart"></i> Add to cart</button>';
				}
