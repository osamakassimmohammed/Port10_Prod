...
<div class="form-group">
    <a style="" href="<?php echo base_url('admin/users/csv_dwonload') ?>"
    ...
    if (!empty($users_data)) {
        foreach ($users_data as $key => $row) { ?>
            ...
            <tr>
                ...
                <td>
                    <a style="width: auto; padding: 0px 12px;"
                       href="users/order_history/<?php echo $row['id'] ?>"
                       ...
                       role="button"><i class="material-icons">remove_red_eye</i> <span
                            style="margin-top: 0px; float: right; margin-left: 4px;">View</span>
                    </a>
                </td>
            </tr>
        <?php }
