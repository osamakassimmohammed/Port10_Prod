...
<div style="text-align: right;">
    <a class="service-image" href="<?php echo base_url($language.'/admin/users/order_history/').@$users_data[0]['id'];?>"> <button type="submit" class="btn btn-success">Back to list </button>    </a>
</div> 
