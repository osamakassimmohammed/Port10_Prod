...
<div style="text-align: right;">
    <a class="service-image" href="<?php echo base_url($language.'/admin/users/supplier_list/').$flag;?>"> <button type="submit" class="btn btn-success">Back to list </button>    </a>
</div> 
            ...
            <tr>
             ...
             <tr>
              ...
              <td><?php if($users_data[0]['is_email_verify']==1)
                { ?>
                  <button id="is_email_verify"  class="btn btn-success" >Verified</button>
                <?php }else{ ?>
                  <button id="is_email_verify" class="btn btn-danger" >Pending</button>
                <?php } ?>
              </td>
            </tr>         
      ...
      <form  action="" method="POST">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div>              
              <input type="radio" name="is_terminate" value="1" id="terminate" class="with-gap radio-col-green" <?php echo $terminate ?> >
              <label for="terminate">Terminate</label> 
              <input type="radio" name="is_terminate" value="0" id="not_terminate" class="with-gap radio-col-green" <?php echo $not_terminate ?>>
...
<script type="text/javascript">
  ...
  $(document).on("submit","form",function(e)
  {
    ...
    $.ajax({
            type: 'POST',
            url: "<?php echo base_url($language.'/admin/users/supplier_detail/').$users_data[0]['id']; ?>",
