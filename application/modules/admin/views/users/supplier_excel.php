    ...
    <div class="row space-get margin_20">
        <div class="col-md-12">
            <div class="panel panel-default main_wrap_form">
                ...
                <div class="panel-body" style="width: 50%">
                    <?php echo $form->open(); ?> 
                        ...
                        <div class="form-group" style="width: 50%">
                            <label for="bstart_date"> Select Supplier</label>
                            <select name="stype" id="stype" class="form-control">
                                <option value="">Select Type</option>
                                <option value="all">ALL</option>
                                <option value="wiban">With Iban</option>
                                <option value="wout_iban">Without Iban</option>
                            </select>
                        </div>
                       ...
                       <!--  <div class="form-group">
                        ...
                        <?php echo $form->bs3_submit('Download CSV'); ?>
                ...
                <div class="panel-body" style="width: 50%">
                    <form id="remitter_form" action="<?php echo base_url('admin/users/csv_upload') ?>"  class="wizard clearfix" method="post" enctype="multipart/form-data">
                        <div class="form-group" style="width: 30%">
                            <label for="bstart_date"> Upload CSV</label>
                            <input id="remitter_file" name="file"  type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                        </div>
                        <button type="submit" class="btn btn-primary">Upload Remitter</button>
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
 $(document).on("submit","#wizard_with_validation",function(e)
 {
    ...
    {
      error==0;
      swal("","Please Select Supplier Type","warning");
      return false;    
    }
}); 

 $(document).on('submit',"#remitter_form",function(){
    var remitter_file=$.trim($("#remitter_file").val()); 
    if(remitter_file=='')
    {
 ...
 <?php if ($this->session->flashdata('csv_insert')): ?>
  swal("","<?php echo $this->session->flashdata('csv_insert'); ?>","success");
 <?php endif; ?> 
 </script> 