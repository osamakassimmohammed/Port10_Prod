    ...
    <div class="row space-get margin_20">
        <div class="col-md-12">
            <div class="panel panel-default main_wrap_form">
                ...
                <div class="panel-body" style="width: 50%">
                    <form id="remitter_form"
                          action="<?php echo base_url('admin/users/csv_upload') ?>"
                          class="wizard clearfix" method="post"
                          enctype="multipart/form-data">
                        <div class="form-group" style="width: 30%">
                            <label for="bstart_date"> Upload CSV</label>
                            <input id="remitter_file" name="file" type="file"
                                   accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                        </div>
                        <button type="submit" class="btn btn-primary">Upload Remitter
                        </button>
                    </form>
                </div>
            </div>
