...
<link
    href="<?php echo base_url(); ?>assets/admin/js/summernote-master/dist/summernote-bs4.min.css"
    rel="stylesheet">
<script
    src="<?php echo base_url(); ?>assets/admin/js/summernote-master/dist/summernote-bs4.min.js"></script>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="box-body">
                ...
                <form id="create_form" action="<?php echo $form_url; ?>" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="subject" id="subject" name="subject"
                                   value="<?php echo $subject; ?>" class="subject">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="groups">To</label>
                        <div>
                            <select id="select_type" name='type'>
                                ...
                                <option value="newsletter">All Newsletter Subscribers
                                </option>
                    ...
                    <div class="form-group" id="customer_show" style="display: none">
                        ...
                        <div>
                            <input type="text" id="customer_search" name="" value=""
                                   class="subject">
                        </div>
                    </div>
                    <div class="items"></div>

                    <div class="well well-sm empty_wall"
                         style="height: 150px; overflow: auto; display: none">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <textarea name="message"
                                      id="ckeditor2"><?php echo $message; ?></textarea>
                        </div>
                    </div>
                    <br><br><br>
                    <?php echo $form->bs3_submit(); ?>
                    <?php if (isset($edit)) { ?>
                        <button type="button" id="re_send" data-id="<?php echo $id; ?>"
