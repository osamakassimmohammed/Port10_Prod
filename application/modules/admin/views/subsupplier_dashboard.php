                            ...
                            <a href="<?php echo base_url($language . '/admin/vorders/pending_order'); ?>">
                                <div class="card two">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p style="color: #ae60e4;"
                                           class="count"><?php echo $vorders_arr['pending_order']; ?></p>
                                    </div>
                                </div>
                            </a>
                        </div><!-- col-xs-3 -->
                            ...
                            <a href="<?php echo base_url($language . '/admin/vorders/completed_order'); ?>">
                                <div class="card one">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p style="color: #ff3f64;"
                                           class="count"><?php echo $vorders_arr['complete_order']; ?></p>
                                    </div>
                                </div>
                            </a>
                        </div><!-- col-xs-2 -->
                            ...
                            <a href="<?php echo base_url($language . '/admin/vorders/today_order'); ?>">
                                <div class="card three">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p style="color: #24d0d9;"
                                           class="count"><?php echo $vorders_arr['today_order']; ?></p>
                                    </div>
                                </div>
                            </a>
                        </div><!-- col-xs-2 -->
                            ...
                            <a href="<?php echo base_url($language . '/admin/product/list1'); ?>">
                                <div class="card four">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p style="color: #444a51;"
                                           class="count"><?php echo $product_arr['product_count']; ?></p>
                                    </div>
                                </div>
                            </a>
                        </div><!-- col-xs-2 -->
                    ...
                    <table
                        ...
                        if (!empty($vorders_arr['today_new_orders'])) {
                            foreach ($vorders_arr['today_new_orders'] as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo @$value['first_name'] . ' ' . @$value['last_name']; ?>
                                        <br><?php echo $value['mobile_no']; ?>
                                        <br><?php echo $value['email']; ?></td>

                                    <td><?php $now = date('M-d-Y', strtotime($value['order_datetime']));
                                        echo $now; ?></td>

                                    <td><?php echo $currency;
                                        echo " ";
                                        echo @$value['in_net_total']; ?></td>
                                    <td><span
                                            class="vorder_<?php echo @$value['payment_status']; ?>"><?php echo @$value['payment_status']; ?></span>
                                    </td>
                                    <td><span
                                            class="vorder_<?php echo @$value['order_status']; ?>"><?php echo @$value['order_status']; ?></span>
                                    </td>
                            ...
                            <tr class="text-center text-danger">
                                <td colspan="8"><?php echo lang('aNo_Order_Found'); ?></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="top_action">
                            <div class="col-xs-12 col pull-left">
                                ...
                                <h5>
                                    <span>Form:</span><?php echo date("l jS \of F Y", strtotime($now . "-6day")); ?>
                                    <span>To:</span><?php echo date("l jS \of F Y"); ?>
                                </h5>
                                <h5></h5>
                            </div><!--col-xs-12-->
                        </div><!--top_action-->
                                    ...
                                    <td class="detail_icona">
                                        <a class="req_btn"
                                           href="<?php echo base_url($language . '/admin/receive_quotation/receive_quotation_detail/') . $qd_val['id']; ?>"><span
                                                class="info_label"><?php echo lang('aInfo'); ?></span>
                                        </a>
                                    </td>
                                </tr>
                            <?php }
...
<?php if (!empty($product_arr) && isset($product_arr['top_selled'])) { ?>
    <div class="row asd">
        ...
        <?php if (count($product_arr['top_selled']) > 8) { ?>
            <a class="btn btn-info top_view"
               href="<?php echo base_url($language . '/admin/dashbord/all_topsold'); ?>"><?php echo lang('aView_All'); ?></a>
            <div class="clear"></div>
        <?php } ?>
                    ...
                    <div class="col-sm-3">
                        <div class="thumbnail card top_seling_sectn">
                            <div class="header pading_top_header header_with_desrctpn">
                                <a href="<?Php echo base_url() . $pro_url . $product_arr['top_selled'][$i]['product_id']; ?>"><img
                                        class="images top_seling_img"
                                        src="<?php echo $image_url; ?>"></a>

                                <!-- <h3 class="p_name_h3">Product <?php //echo ' Sold '.$top_selled[$i]['pro_count'].' times .';
                                ?> </h3>  -->
                                ...
                                <div>
                                    <button title="<?php echo lang('Add_to_cart'); ?>"
                                            data-id="4" data-unit="get_unit0"
                                            data-detislqty="3" class="add_to_carts">
                                        <i style="margin-left: 32px;margin-right: -20px;"
                                           class="material-icons">shopping_cart</i> <?php echo lang('Add_to_cart'); ?>
                                    </button>
                                </div>
                                <div class="clear"></div>
                            </div>
