...
<div class="col-md-12" style="float: right;">
    <div class="button  ">
      <a href="<?php echo  base_url($language.'/admin/blog'); ?>" class=" back_to_list btn btn-primary">Back to list</a>
    </div>
</div>
                ...
                <div class="panel-body">
                    <?php echo $form->open(); ?> 
                        ...
                        <div class="form-group" style="width: 30%">
                            ...
                            <input class="form-control space" id="heading" name="heading" placeholder="Enter First heading" type="text" value="<?php echo $heading ?>"  autocomplete="off" >
                        </div>
                        ...
                        <div class="form-group" style="width: 30%">
                            ...
                            <select id="blog_type_id" name="blog_type_id">
                                ...
                                { 
                                    ...
                                    ?>
                                    <option value="<?php echo $bt_val['id']; ?>" <?php echo $selected; ?>> <?php echo $bt_val['name']; ?></option>
                                <?php } } ?>
                            </select>
                        </div>
                         <div class="form-group" style="width: 30%">
                       ...
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-inner">
                                <?php //print_r($myimage); ?>
                                <input type="file" id="file" value="<?php echo $myimage; ?>"  accept="image/png, image/gif, image/jpeg" //>
                                <label for="file" class="file__drop" data-image-uploader>
                                    ...
                                    if (!isset($edit))
                                    { ?>
                                        <span class="choose-image "><?php echo "Choose image for <br> blog"; ?>
                                        </span>
                                    <?php } ?>
