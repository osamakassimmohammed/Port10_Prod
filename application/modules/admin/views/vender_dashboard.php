                  ...
                  <a href="<?php echo base_url($language.'/admin/vorders/pending_order'); ?>">
                    <div class="card two">
                        ...
                        <div class="card-content">
                            ...
                            <p style="color: #ae60e4;" class="count"><?php echo @$pending_order; ?></p>
                        </div>
                    </div>
                    </a>
                </div><!-- col-xs-3 -->
                ...
                <div class="col-xs-3">                 
                    ...
                    <div class="card one">                 
                      ...
                      <div class="card-content">
                         ...
                         <p style="color: #ff3f64;" class="count"><?php echo @$complete_order; ?></p>
                      </div>
                   </div>
                 </a>
                </div><!-- col-xs-2 -->
                   ...
                   <div class="card three">
                    <i class="material-icons">bookmark_border</i>
                      <div class="card-content">
                         ...
                         <p style="color: #24d0d9;" class="count"><?php echo @$today_order; ?></p>
                      </div>
                   </div>
                  </a> 
                </div><!-- col-xs-2 -->
                  ...
                  <a href="<?php echo base_url($language.'/admin/product/list1'); ?>">
                    <div class="card four">
                      ...
                      <div class="card-content">
                         ...
                         <p style="color: #444a51;" class="count"> <?php echo $product_count; ?></p>
                      </div>
                    </div>
                  </a>  
                </div><!-- col-xs-2 -->
                ...
                <table id="today" class="table table-striped table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $today_order; ?></td>
                        </tr>
                        
                        <tr>
                            <td><?php echo lang('aPending_Orders'); ?></td>
                            <td><?php echo @$today_pending; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo lang('aDelivered_Orders'); ?></td>
                            <td><?php echo @$today_complete; ?></td>
                        </tr>
                        <tr>
                            <td style="border: none;"><?php echo lang('aCanceled_Orders'); ?></td>
                            <td style="border: none;"><?php echo @$today_canceled; ?></td>
                        </tr>                        
                    </tbody>
                </table>
            ...
            <div class="table-responsive">
                <table id="week" class="table table-striped table-bordered">
                    <tbody>
                        <tr>
                        <td><?php echo lang('aTotal_Orders'); ?></td>
                            <td><?php echo @$week_order; ?></td>
                        </tr>
                        
                        <tr>
                            <td><?php echo lang('aPending_Orders'); ?></td>
                            <td><?php echo @$week_pending; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo lang('aDelivered_Orders'); ?></td>
                            <td><?php echo @$week_canceled; ?></td>
                        </tr>
                        <tr>
                            <td style="border: none;"><?php echo lang('aCanceled_Orders'); ?></td>
                            <td style="border: none;"><?php echo @$week_complete; ?></td>
                        </tr>                       
                    </tbody>
      ...
      <div class="col-sm-3">
         <div class="thumbnail card top_seling_sectn">
            <div class="header pading_top_header header_with_desrctpn">
               ...
               <h3 class="p_name_h3"><?php echo $top_selled[$i]['product_name']; ?></h3> 
