                            ...
                            <div class="card two">
                                ...
                                <div class="card-content">
                                    ...
                                    <p style="color: #ae60e4;"
                                       class="count"><?php echo @$pending_order; ?></p>
                                </div>
                            </div>
                        </a>
                    </div><!-- col-xs-3 -->
                            ...
                            <div class="card one">
                                ...
                                <div class="card-content">
                                    ...
                                    <p style="color: #ff3f64;"
                                       class="count"><?php echo @$complete_order; ?></p>
                                </div>
                            </div>
                        </a>
                    </div><!-- col-xs-2 -->
                            ...
                            <div class="card three">
                                ...
                                <div class="card-content">
                                    ...
                                    <p style="color: #24d0d9;"
                                       class="count"><?php echo @$today_order; ?></p>
                                </div>
                            </div>
                        </a>
                    </div><!-- col-xs-2 -->
                            ...
                            <div class="card four">
                                ...
                                <div class="card-content">
                                    ...
                                    <p style="color: #444a51;"
                                       class="count"> <?php echo $product_count; ?></p>
                                </div>
                            </div>
                        </a>
                    </div><!-- col-xs-2 -->
                    ...
                    <div class="top_action">
                        <div class="col-xs-12 col pull-left">
                            ...
                            <h5>
                                ...
                                <span>To:</span><?php echo date("l jS \of F Y"); ?></h5>
                            <h5></h5>
                        </div><!--col-xs-12-->
                    </div><!--top_action-->
