...
<div class="row middle_divv">
    <div class="div1_vorder">
        <button class="btn_vodere status_active"
                data-id="all"><?php echo lang('aAll'); ?></button>
    </div>
    <div class="div1_vorder">
        <button class="btn_vodere" data-id="new"><?php echo lang('aNew'); ?></button>
    </div>
    <div class="div1_vorder">
        <button class="btn_vodere"
                data-id="Pending"><?php echo lang('aPending'); ?></button>
    </div>
    <div class="div1_vorder">
        <button class="btn_vodere"
                data-id="canceled"><?php echo lang('aCancelled'); ?></button>
    </div>
    <div class="div1_vorder">
        <button class="btn_vodere"
                data-id="Delivered"><?php echo lang('aCompleted'); ?></button>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-8">
        <form id="vexcel_form" method="POST"
              action="<?php echo base_url($language . '/admin/vorders/bank_excel') ?>">
            <label class="bstart_date"><?php echo lang('aStart_Date'); ?>:</label>
            <input class="vs_date" type="" id="bstart_date" name="start_date"
                   placeholder="<?php echo lang('aSelect_Start_Date'); ?>" type="text"
                   value="" autocomplete="off">
            <label class="bend_date"><?php echo lang('aEnd_Date'); ?>:</label>
            <input class="ve_date" type="" id="bend_date" name="end_date"
                   placeholder="<?php echo lang('aSelect_End_Date'); ?>" type="text"
                   value="" autocomplete="off">
            <button type="submit" class="vorder_excel"
                    style="margin-top: 0px;margin-right: 20px"><?php echo lang('aExcel'); ?></button>
        </form>
    </div>
        ...
        foreach ($orders as $key => $value) {
            ...
            <tr>
                ...
                <td><?php $now = date('M-d-Y', strtotime($value['order_datetime']));
                    echo $now; ?></td>
                <!-- <td><?php //echo $currency; echo " "; echo @$value['net_total']-$value['coupon_price'];
                ?></td> -->
                <td><?php echo $currency;
                    echo " ";
                    echo @$value['in_sub_total']; ?></td>
                <td>
                    <span
                ...
                <td style="width: 10%">
                    <a href="vorders/view/<?php echo @$value['order_no'] ?>"
                       class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float fist_a"
                       role="button"><i class="material-icons">remove_red_eye</i> <span
                            class="material_label"><?php echo lang('aView'); ?></span></a>
                    <div class="clear"></div>
                    <a href="invoice/order_invoice/<?php echo @$value['order_no'] ?>/order"
                       class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float second_a"
                       role="button"><i class="material-icons">save_alt</i> <span
                            class="material_label"><?php echo lang('aInvoice'); ?></span></a>
...
<div id="loading" style="display: none">
    <img id="loading-image"
         src="<?php echo base_url('assets/admin/images/loader.gif') ?>"
         alt="Loading..."/>
</div>
