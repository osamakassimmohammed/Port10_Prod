<div class="col-md-12"
    ...
    <a href="<?php echo base_url($language) ?>/admin/vorders"
    ...
    <div class="x_content row">
        ...
        <div class="col-md-6">
            ...
            <?php if ($data[0]['payment_mode'] == 'online') { ?>
                <div class="panel panel-default ">
                    <div
                        class="panel-footer"><?php echo lang('aPayment_Details'); ?></div>
                    <div class="panel-body">
                        <div class="row">
            ...
            <div class="panel panel-default ">
                <form action="" method="POST">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label
                                class="control-label col-sm-5 "> <?php echo lang('aOrder_date'); ?>
                                :
                            </label>
                ...
                <div class="col-sm-7" style="padding-top: 7px;">
                   <input class="ha-input1" type="text" id="d_date" value="<?php //echo $data[0]['delivery_date']; ?>" class="form-control" name="delivery_date" placeholder="Order Date"required>
                        ...
                        <div class="form-group">
                            <label for=""
                                   class="col-sm-5 control-label"><?php echo lang('aOrder_status'); ?>
                                :</label>
                            <div class="col-sm-7">
                                <?php // echo $order_status; ?>
                                <select class="form-control" name="order_status">
                                    <option value="" disabled="">Select Order Status :
                                    </option>
                                    <?php if (isset($order_status) && $order_status == "Pending") { ?>
                                        <option
                                            value="Pending" <?php if (isset($order_status) && $order_status == "Pending") echo "Selected"; ?> ><?php echo lang('aPending'); ?></option>
                                        <!-- <option value="Dispatched">Dispatched</option> -->
                                        <option
                                            value="Delivered"><?php echo lang('aCompleted'); ?></option>
                                        <option
                                            value="canceled"><?php echo lang('aCancelled'); ?></option>
                                    <?php } else if (isset($order_status) && $order_status == "Dispatched") { ?>
                                        <option
                                            value="Dispatched" <?php if (isset($order_status) && $order_status == "Dispatched") echo "Selected"; ?> >
                                            Dispatched
                                        </option>
                                        <option
                                            value="Delivered"><?php echo lang('aCompleted'); ?></option>
                                        <option
                                            value="canceled"><?php echo lang('aCompleted'); ?></option>
                                    <?php } else if (isset($order_status) && $order_status == "Delivered") { ?>
                                        <option
                                            value="Delivered" <?php if (isset($order_status) && $order_status == "Delivered") echo "Selected"; ?> ><?php echo lang('aCompleted'); ?></option>
                                    <?php } else if (isset($order_status) && $order_status == "canceled") { ?>
                                        <option
                                            value="canceled" <?php if (isset($order_status) && $order_status == "canceled") echo "Selected"; ?> ><?php echo lang('aCompleted'); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label
                                class="col-sm-5 control-label"><?php echo lang('aPayment_Mode'); ?>
                                :</label>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="ShippingDateTime"
                                   class="col-sm-5 control-label">Shipping Date Time
                                :</label>
                            <div class="col-sm-7">
                                <input type="text" name="ShippingDateTime"
                                       id="ShippingDateTime"
                                       value="<?Php echo $invoice_data[0]['shipping_date_time']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="DueDate" class="col-sm-5 control-label">Due Date
                                :</label>
                            <div class="col-sm-7">
                                <input type="text" name="DueDate" id="DueDate"
                                       value="<?Php echo $invoice_data[0]['shipping_dub_date']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="DueDate" class="col-sm-5 control-label">Shipping
                                Id :</label>
                        ...
                        <div class="form-group" style="margin-top: 10px;">
                            <div class="col-sm-12">
                                <input type="submit" value="Create Shipments"
                                       name="submit" class="btn btn-success pull-right">
                            </div>
                        </div>
                    </div>
        ...
        <div class="x_content row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="">
                        <table id="datatable-checkbox mytable"
                            ...
                            <tr>
                                ...
                                <td colspan=""><?php echo lang($currency);
                                    echo " ";
                                    echo $invoice_data[0]['sub_total']; ?></td>
                            </tr>
