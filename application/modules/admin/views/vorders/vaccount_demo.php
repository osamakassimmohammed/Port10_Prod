...
<div class="row middle_divv" style="margin: 0 auto;display: flex;margin-bottom:3rem;justify-content: center;">
    <div class="div1_vorder">
        <button style="background-color:#6CC8C3" class="btn_vodere transt_active transt-btn"
            data-id="all"><?php echo lang('aTransactions'); ?></button>
    </div>
    <div class="div1_vorder">
...
<input  type="text" name="daterange" value="01/01/2023 - 01/31/2023" />
    ...
    <h2> <?php echo lang('aTransactions'); ?></h2>
                    ...
                    <div class="card three">
                        <div class="card-content">
                            ...
                            <p style="color: #444a51;" class="count">
                                <?php echo round($data['total_amount'], 2) ?>
                            </p>
                        </div>
                    </div>
                </a>
    ...
    <div class="dashboard row" style="overflow-x:auto;margin:0rem">
        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <?php $count=1;
                    foreach($data['last_month_transaction'] as $lmt){  if(empty($lmt->transaction_id) ){?>
            <tbody>
                <tr>
                    <td>
                        <?php echo $count++; ?>
                    ...
                    <td>
                      <?php if($lmt->user_id != 1){ if($lmt->status == 1 ){?>
                        <a style="width: 100%;"
                            ...
                            role="button"><i class="material-icons">check</i><span class="material_label "
                                data-id="<?php echo $lmt->va_transactions_id; ?>"
                                data-uid="<?php echo $lmt->user_id; ?>" data-amount="<?php echo $lmt->amount; ?>"
                                data-type="approve">
                                <?php echo lang('aApprove'); ?>
                            </span></a>
                        <a style="width: 100%; margin-top:1rem !important" href="javascript:void(0)"
                            ...
                            role="button"><i class="material-icons">close</i><span class="material_label"
                                ...
                                data-uid="<?php echo $lmt->user_id; ?>" data-amount="<?php echo $lmt->amount; ?>"
                                data-type="decline">
                                <?php echo lang('aDecline'); ?>
                            </span></a>
                            <?php }
                            else{
                              echo ($lmt->status == 2) ? lang('aApprove') : lang('aDecline');
                        }
                          }?>
                    </td>
                </tr>
        ...
        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody id="search_daterange_table">
                <tr>
                    ...
                    <td>
                        <?php $amount =  (($payment_details->total_ordered_amount)*90)/100; echo $amount; ?>
...
$(document).ready(function() {
    $(".material_label").on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url("/admin/vorders/update_approve_decline_withdrawal"); ?>",
            data: {
                dataId: dataId,
                dataUId: dataUId,
