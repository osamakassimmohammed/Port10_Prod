...
<thead>
    ...
    { 
        ...
        <tr>
            ...
            <td style="width: 10%">
                <a href="vorders/view/<?php echo @$value['order_no'] ?>"   class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float fist_a" role="button"><i class="material-icons">remove_red_eye</i></a>
                <a href="invoice/order_invoice/<?php echo @$value['order_no'] ?>/order"  class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float second_a" role="button"><i class="material-icons">save_alt</i></a>
