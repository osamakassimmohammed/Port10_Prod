...
<div class="col-md-12" style="float: right;">
    <div class="button  ">
      <a href="<?php echo  base_url('/admin/home_data/testimonial'); ?>" class=" back_to_list btn btn-primary">Back to list</a>
    </div>
</div>
                ...
                <div class="panel-body">
                    <?php echo $form->open(); ?> 
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input class="form-control" name="heading1" placeholder="Enter First heading" type="text" value="" required="" autocomplete="off" > -->                            
                            <textarea class="form-control" id="description" name="description"  rows="4" cols="50" required><?php echo $description; ?> </textarea>
                        </div>                        
