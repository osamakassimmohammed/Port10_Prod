...
<div class="sraech">
  ...
  <a class="pro_create" href="<?php echo base_url($language.'/admin/home_data/create_advertise') ?>">Create</a>  
</div>
...
//print_r($list);
  if (!empty($advertise_data)){ foreach($advertise_data as $key => $row) {?>
...
<td>
   <a style="width: 100%;" href="home_data/edit_advertise/<?php echo $row['id'] ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float brand_edit" role="button"><i class="material-icons">edit</i><span class="material_label">Edit</span></a>   

   <a href="javascript:void(0)" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float  detete_pro brand_delete" data-id="<?php echo $row['id']; ?>" role="button" ><i class="material-icons">delete</i></a>
