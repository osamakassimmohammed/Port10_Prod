            ...
            <tr>
                ...
                <td>
                    <a target="_blank"
                       ...
                       class="image-thumbnail"><img class="image-thumbnail"
                                                    src="<?php echo base_url('assets/admin/banner/') . $row['image'] ?>"
                                                    height="50px"></a>
                </td>
                ...
                <td>
                    <a style="width: 100%; background-color: #4f0381 !important;"
                       href="home_data/banner_edit/<?php echo $row['id'] ?>"
                    ...
                    <a style="width: 100%; margin: 8px 0px !important; background-color: #44871b !important; "
                       href="home_data/banner_tedit/<?php echo $row['id'] ?>"
                       class="btn bg-light-green btn-circle waves-effect waves-circle waves-float "
