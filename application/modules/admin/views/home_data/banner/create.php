...
<div class="col-md-12" style="float: right;">
    <div class="button  ">
      <a href="<?php echo  base_url($language.'/admin/home_data'); ?>" class=" back_to_list btn btn-primary">Back to list</a>
    </div>
</div>
                ...
                <div class="panel-body">
                    <?php echo $form->open(); ?> 
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control space" id="heading1" name="heading1" placeholder="Enter First heading" type="text" value="<?php echo $heading1 ?>"  autocomplete="off" >
                        </div>
                            ...
                            <select id="select_main" name="main_cat">
                                ...
                                <?php if(!empty($category_data)){
                                    foreach ($category_data as $cd_key => $cd_val) { 
                                        ...
                                        ?>
                                <option value='<?php echo $cd_val['id']; ?>' <?php echo $selected; ?>><?php echo $cd_val['display_name']; ?></option>        
                                <?php } } ?>
                            </select>
                        </div> 
                        <div class="form-group">
