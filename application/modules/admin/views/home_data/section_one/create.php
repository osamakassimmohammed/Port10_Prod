<div class="col-md-12" style="float: right;">
    <div class="button  ">
        <a href="<?php echo base_url('/admin/home_data/section_one'); ?>"
            ...
            <div class="panel panel-default main_wrap_form">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="heading1"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="heading2"
                               value="<?php echo $heading2 ?>"
                               placeholder="Enter second heading" type="text"
                        ...
                        <?php if (!empty($category_data)) { ?>
                            <select name="main_category" required="">
                                <?php foreach ($category_data as $cated_key => $cated_val) {
                                    ...
                                    ?>
                                    <option
                                        value="<?php echo $cated_val['id']; ?>" <?php echo $category_selected; ?>><?php echo $cated_val['display_name']; ?></option>
                                <?php } ?>
                            </select>
                        <?php } ?>
                    </div>
