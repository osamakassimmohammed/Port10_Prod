...
<div class="col-md-12" style="float: right;">
    <div class="button  ">
      <a href="<?php echo  base_url('/admin/home_data/section_one'); ?>" class=" back_to_list btn btn-primary">Back to list</a>
    </div>
</div>


<?php echo $form->messages();
$heading1 = $heading2 = $main_category  = $myimage  =  '' ;

if (isset($edit)){
    $heading1 = $edit['heading1'];
    $heading2 = $edit['heading2'];
    $main_category = $edit['main_category'];    
    $myimage = $edit['image'];
}
?>
                ...
                <div class="panel-body">
                    <?php echo $form->open(); ?> 
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"> Heading first</label>
                            <input class="form-control" name="heading1" placeholder="Enter First heading" type="text" value="<?php echo $heading1 ?>" required="" autocomplete="off" >
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <select name="main_category" required="">
                                <?php foreach ($category_data as $cated_key => $cated_val) { 
                                    $category_selected = ($main_category == $cated_val['id'] ) ? "selected" : "";
                                    ?>     
                                    <option value="<?php echo $cated_val['id']; ?>" <?php echo $category_selected; ?>><?php echo $cated_val['display_name']; ?></option>
                                <?php } ?>
                            </select>
                        <?php } ?>
                        </div>
