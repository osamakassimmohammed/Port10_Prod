...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand  " href="<?php echo base_url($language); ?>">
                <!-- <?php echo $site_name; ?> -->
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if (!empty($user->group_id == 5 || $user->group_id == 10)) {
                    ...
                    if ($front_login == true) {
                        ?>
                        <li style=""><a class="got_ac"
                                        href="<?php echo base_url($language) ?>"><?php echo lang('aGo_to_Buyer_Account'); ?></a>
                        </li>
                    <?php }
                } ?>
                ...
                <li class="toggle_menu">
                    <?php if ($language == 'en') { ?>
                        <img class="en_toggle toggle_cls"
                             src="<?php echo base_url('assets/admin/images/') ?>en_load.png">
                    <?php } else { ?>
                        <img class="ar_toggle toggle_cls"
                             src="<?php echo base_url('assets/admin/images/') ?>ar_load.png">
                    <?php } ?>
                ...
                <li class="dropdown" style="display:none;">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span
                            class="user_name_text hidden-xs"><?php echo $user->first_name; ?><?php echo $user->last_name; ?></span>
                    </a>
                        ...
                        <li class="footer">
                            <div class="pull-left leftaln">
                                <a href="panel/account"
                                   class="btn btn-info waves-effect t">Account</a>
                            </div>
                            <div class="pull-right rightaln">
                                <?php if ($user->group_id == 1) { ?>
                                    <a href="panel/logout"
                                       class="btn btn-danger waves-effect t">Sign
                                        out</a>
                                <?php } else { ?>
                                    <a href="<?php echo base_url('en/login/logout'); ?>"
                                       class="btn btn-danger waves-effect t">Sign
                                        out</a>
                                <?php } ?>
                            </div>
