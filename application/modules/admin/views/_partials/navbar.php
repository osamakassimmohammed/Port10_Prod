            ...
            <div class="navbar-header">
              ...
              <!-- <img style="margin-left: 10px;" src="<?php echo base_url(); ?>assets/admin/images/logo.png" height="50" width="200" > -->
                <a class="navbar-brand  " href="<?php echo base_url($language); ?>">
                  <!-- <?php echo $site_name; ?> -->
                  <img style="margin-left: 10px; width: 190px; margin-top: -10px;" src="<?php echo base_url(); ?>assets/admin/images/logo-admin.png"   > 
                </a>
            </div>
...
body.ar .hide_mouse {
    ...
    margin-left: 35px;
         ...
         <li class="dropdown dropdown_notfctn">
         	<a href="#" class="dropdown-toggle" data-toggle="dropdown">
 				   <i class="material-icons">notifications_none </i><span class="badge"><?php echo  (count($noti_data) == 0) ? "" : count($noti_data);  ?></span>
          	</a>
        ...
        <?php if($language=='en')
        { ?>
          <img class="en_toggle toggle_cls" src="<?php echo base_url('assets/admin/images/') ?>en_load.png">
        <?php }else{ ?>
