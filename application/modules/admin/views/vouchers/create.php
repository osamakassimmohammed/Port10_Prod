<div style="text-align: right;">
    <a class="service-image" href="<?php echo $back_link;?>"> <button type="submit" class="btn btn-success">Back to list </button>    </a>
</div>
            ...
            <div class="box-body">
                ...
                <form id="create_form" action="<?php echo $form_url; ?>" method="post" accept-charset="utf-8">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-line">
                        <input autocomplete="off" id="code_name" class="form-control"  value="<?php echo $code_name; ?>" name="code_name" type="text" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                        <input autocomplete="off" id="code" class="form-control"  value="<?php echo $code; ?>" name="code" type="text" >
                        </div>
                    </div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="slct_drop_down" >
                            <select id="select_type" name="type">
                               ...
                               <option value="1" <?php echo $percentage_selected; ?>>Percentage</option>
                               <option value="0" <?php echo $fiexd_amount_selected; ?>> Fixed Amount</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="limited_pay" class="colors" >
                        <div class="form-group">
                            ...
                            <div class="form-line">
                            <input autocomplete="off" id="amount" class="form-control"  value="<?php echo $amount; ?>" name="amount" type="text" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="limited" class="colors" > 
                        <div class="form-group">
                            ...
                            <div class="form-line">
                            <input autocomplete="off" class="startdatepicker form-control"  value="<?php echo @$start_date; ?>" name="start_date" id="start_date" type="text"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                            <input autocomplete="off" class="enddatepicker form-control"  value="<?php echo @$end_date; ?>" name="end_date" type="text" id="end_date"   >
                            </div>
                        </div>
                    </div>       
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="radio" name="status" value="1" <?php echo $active; ?> id="active" class="with-gap radio-col-green" required="">
                            <label for="active">Active</label>
                            <input type="radio" name="status" value="0" id="deactive" class="with-gap radio-col-green" required="" <?php echo $deactive; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="radio" name="free_shipping" value="1" <?php echo $fre_ship_yes; ?> id="fre_ship_yes" class="with-gap radio-col-green" required="">
                            <label for="fre_ship_yes">YES</label>
                            <input type="radio" name="free_shipping" value="0" id="fre_ship_no" class="with-gap radio-col-green" required="" <?php echo $fre_ship_no; ?>>
