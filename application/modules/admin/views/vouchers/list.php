...
<div class="form-group">
  <!-- <a href="<?php //echo base_url(); ?>admin/payment/isyd_create" class="btn bg-light-green waves-effect"><span>Create</span></a> -->
</div>
...
<td>
  <a style="width: 50%" href="<?php echo $edit_link.$row['id']; ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float " role="button"><i class="material-icons">edit</i></a>

   <!-- <a href="<?php echo $tedit_link.$row['id']; ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float " role="button"><i class="material-icons">translate</i></a> -->
