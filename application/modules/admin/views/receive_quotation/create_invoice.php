  ...
  <?Php if (!empty($quotation_data)) { ?>
    <form id="submit_invoice" method="post">
      <div class="invoic_title">
        <?php echo lang('aPro_Forma_Invoice'); ?>
      </div>
      <div class="ref_num_invoc">
        <div class="ref_labela">
          <?php echo lang('Ref_Number'); ?>:
        </div>
        <input type="text" class="ref_numa" placeholder="Enter Ref Number" id="in_iref_no" name="in_iref_no"
          value="<?php echo $in_iref_no; ?>">
        <div class="clear"></div>
      </div>

      <div class="ref_num_invoc ref_num_invoc_date">
        <div class="ref_labela" style="    text-align: right;">
          <?php echo lang('Date'); ?>:
        </div>
        <input type="text" class="ref_numa" placeholder="Enter Date" id="in_date" name="in_date"
          value="<?Php echo $in_date; ?>" disabled>
        <div class="clear"></div>
      </div>
      ...
      <div class="cusmr_inf_wrap">
        <div class="custnr_adrea_name">
          <div class="ref_labela">
            <?php echo lang('aCustomer_Name'); ?>:
          </div>
          <input type="text" class="ref_numa" placeholder="Enter Customer Name" id="in_user_name" name="in_user_name"
        ...
        <div class="custnr_adrea_name">
          ...
          <textarea class="ref_numa ref_numa_text" placeholder="Enter Address" rows="4" id="in_address"
          ...
          <div class="custnr_adrea_name">
            ...
            <?php if ($in_status == 'Confirmed') { ?>
              <h3><span class="label label-success">
                  <?php echo lang('aYou_confirmed_quotation_request'); ?>
                </span></h3>
      ...
      <div class="seril_num_wrp">
        <div class="hed_lina_as">
          ...
          <div class="serlnum5">
            <?php echo lang('Price'); ?><span class="material-icons" aria-hidden="true" data-toggle="tooltip"
              data-placement="top" title="Quantity is 3 then price sholud be 300">warning</span>
          </div>
          <div class="clear"></div>
        </div>
      ...
      <div class="net_amnt_wrap">
        <div class="net_amnt_a">
          <div class="ref_labela">
            <?php echo lang('Net_Amount'); ?>:
          </div>
          <input type="text" class="ref_numa" placeholder="Enter Net Amount" id="in_net_total" name="in_net_total"
