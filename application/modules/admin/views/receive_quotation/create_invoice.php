...
<div class="main_invoc_a">
	...
	<div class="invoic_title"> <?php echo lang('aPro_Forma_Invoice'); ?></div>
		<div class="ref_num_invoc">
			...
			<input type="text" class="ref_numa" placeholder="Enter Ref Number"  id="in_iref_no" name="in_iref_no" value="<?php echo $in_iref_no; ?>" >
			<div class="clear"></div>
		</div>	

		<div class="ref_num_invoc ref_num_invoc_date">
			<div class="ref_labela" style="    text-align: right;" > <?php echo lang('Date'); ?>: </div>
			<input type="text" class="ref_numa" placeholder="Enter Date"  id="in_date" name="in_date" value="<?Php echo $in_date; ?>" disabled >
			<div class="clear"></div>
		</div>	
	...
	<div class="cusmr_inf_wrap">
		<div class="custnr_adrea_name">
			<div class="ref_labela"> <?php echo lang('aCustomer_Name'); ?>: </div>
			<input type="text" class="ref_numa" placeholder="Enter Customer Name" id="in_user_name" name="in_user_name" value="<?php echo $quotation_data[0]['user_name']; ?>">
			<input type="hidden" name="uid" value="<?php echo $quotation_data[0]['uid']; ?>">
			<div class="clear"></div>
		</div>	

		<div class="custnr_adrea_name">
			<div class="ref_labela"> <?php echo lang('Address'); ?>: </div>
			<textarea class="ref_numa ref_numa_text" placeholder="Enter Address" rows="4" id="in_address" name="in_address"><?php echo $quotation_data[0]['address']; ?></textarea>
			<div class="clear"></div>
		</div>
    <?php if(!empty($in_status)) { ?>
      <div class="custnr_adrea_name">
        ...
        <?php if($in_status=='Confirmed'){ ?>
          <h3><span class="label label-success"><?php echo lang('aYou_confirmed_quotation_request'); ?></span></h3>
        <?php }else if($in_status=='Cancelled'){ ?>
          <h3><span class="label label-danger">Buyer cancelled quotation request </span></h3>
        <?php }else if($in_status=='Rejected'){ ?>
          <h3><span class="label label-warning">You rejected quotation request</span></h3>
        <?php } ?>       
        <div class="clear"></div>
      </div>
    <?php }?>
	...
	<div class="seril_num_wrp">
		<div class="hed_lina_as">
			...
			<div class="serlnum5"><?php echo lang('Price'); ?><span class="material-icons" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Quantity is 3 then price sholud be 300">warning</span></div>	
			<div class="clear"></div>
		</div>

		<div class="table_form">
			<div class="serlnum1" > 
				<input type="text" id="in_sn" name="in_sn" value="<?php echo $quotation_data[0]['id']; ?>">
			</div>
			<div class="serlnum2"> 
				<input type="text" id="in_qty" name="in_qty" value="<?php echo $quotation_data[0]['qty']; ?>">
			</div>
			<div class="serlnum3">
				<input type="text" id="" name="" value="<?php echo $quotation_data[0]['unit_name']; ?>" disabled>
        <input type="hidden" name="in_unit" id="in_unit" value="<?php echo $quotation_data[0]['unit']; ?>">
			</div>
			<div class="serlnum4">
				<textarea rows="2" id="in_describtion" name="in_describtion"><?php echo $in_describtion; ?></textarea>
			</div>
			<div class="serlnum5">
				<input type="text" id="in_sku" name="in_sku" value="<?php echo $quotation_data[0]['pid']; ?>">
			</div>	
			<div class="serlnum5">
				<input type="text" id="in_price" name="in_price" value="<?php echo $in_price; ?>">
			</div>	
	...
	<div class="net_amnt_wrap">
		<div class="net_amnt_a">
			...
			<input type="text" class="ref_numa" placeholder="Enter Net Amount" id="in_net_total" name="in_net_total" value="<?php echo $in_price; ?>">
			<div class="clear"></div>
		</div>
