...
<div class="sraech">
    ...
    <a class="pro_create"
       href="<?php echo base_url($language . '/admin/subs_plans/sub_more_create') ?>">Create</a>
</div>
    ...
    if (!empty($data)) {
        foreach ($data as $key => $row) { ?>
            ...
            <tr>
                ...
                <td>
                    <a style="width: 30%; background-color: #4f0381 !important; "
                       href="<?php echo $edit_link . $row['id']; ?>"
                    ...
                    <a style="width: 30%; background-color: #44871b !important; margin:0px 3% !important; "
                       href="<?php echo $tedit_link . $row['id']; ?>"
                       class="btn bg-light-green btn-circle waves-effect waves-circle waves-float "
                       role="button"> تعديل <i class="material-icons">translate</i></a>

                    <a style="width: 30%; background-color: #ff375e !important;"
