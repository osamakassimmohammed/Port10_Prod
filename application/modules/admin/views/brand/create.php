...
<div class="col-md-12 brand_back_div" style="float: right;">
    <div class="button " style="float: right;margin-bottom: 0px; height: 10px; margin-top: -10px;">
      <a style="color: #23023b" href="<?php echo  base_url($language.'/admin/brand/index'); ?>" class="back_button"><?php echo lang('aBack_To_List'); ?></a>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default main_wrap_form">
                <div class="panel-heading" style="background: none;border: none;">
                    <span style="margin-left: 20px;font-size: 20px;"><?php echo lang($lable_nm); ?> </span>
                </div>
                <div class="panel-body">
                    <?php echo $form->open(); ?> 

                        <div class="form-group">
                            <label class="br_label" for="exampleInputEmail1"> <?php echo lang('aBrand_name'); ?></label>
                            <input style="width: 30%; border-radius: 20px" class="form-control" name="brand_name" placeholder="<?php echo lang('aBrand_name'); ?>" type="text" value="<?php echo $brand_name ?>" required="" autocomplete="off" >
                        </div>


                        <div class="form-group">
                            <label class="br_label" for="exampleInputPassword1"> <?php echo lang('aBrand_Image'); ?> </label>
                            ...
                            <div class="col-inner">
                                ...
                                <label for="file" class="file__drop br_label" data-image-uploader>
                                    <span class="text">&nbsp;</span>
                                    <div style="position: relative; width: 66px;height: 74px;margin-left: 20px;" id="img_div">
                                        <img data-image  src="<?php echo base_url("assets/admin/banner/$myimage"); ?>" style=" width: 100px;height: 70px; " id="dis_image" />
                                    ...
                                    if (!isset($edit))
                                    { ?>
                                        <span class="choose-images "><?php echo '<i style="font-size: 100px;" class="material-icons">linked_camera</i>'; ?>
                                        </span>
                                    <?php } ?>
