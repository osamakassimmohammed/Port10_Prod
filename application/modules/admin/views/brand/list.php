...
<table class="table table-bordered table-striped table-hover dataTable js-exportable">
  <thead>
    <tr>
      ...
      <th style="width: 10%;">
        <?php echo lang('aImage'); ?>
      </th>
      <th>
        <?php echo lang('aBrand_name'); ?>
      </th>
      <?php if ($seller_id == 1) { ?>
        <th>
    ...
    if (!empty($brand_data)) {
      foreach ($brand_data as $key => $row) { ?>
        ...
        <tr>
          ...
          <td>
            <?php if ($row['image'] != '') { ?>
              <a target="_blank" href="<?php echo base_url('assets/admin/banner/') . $row['image'] ?>"
                class="image-thumbnail"><img class="image-thumbnail img_brand"
                  src="<?php echo base_url('assets/admin/banner/') . $row['image'] ?>"></a>
            <?php } ?>
          </td>
          <td>
          ...
          <?php } ?>
          <td>
            <a style="width: 100%;" href="brand/edit/<?php echo $row['id'] ?>"
              class="btn bg-light-green btn-circle waves-effect waves-circle waves-float brand_edit" role="button"><i
                class="material-icons">edit</i><span class="material_label">
                <?php echo lang('aEdit'); ?>
              </span></a>
            <a style="width: 100%; margin-top:1rem !important" href="javascript:void(0)"
              class="btn bg-light-green btn-circle waves-effect waves-circle waves-float  detete_pro brand_delete"
              data-id="<?php echo $row['id']; ?>" role="button"><i class="material-icons">delete</i><span
                class="material_label">
                <?php echo lang('aDelete'); ?>
              </span></a>
