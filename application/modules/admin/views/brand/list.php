...
<div class="sraech">
    ...
    <?php if ($user->type == 'suppler' || $user->type == 'subsupplier') { ?>
        <a class="pro_create"
           href="<?php echo base_url($language . '/admin/brand/create') ?>"><?php echo lang('acreate_Brand'); ?></a>
    <?php } ?>
</div>
        ...
        foreach ($brand_data as $key => $row) { ?>
            ...
            <tr>
                ...
                <td>
                    <?php if ($row['image'] != '') { ?>
                        <a target="_blank"
                           href="<?php echo base_url('assets/admin/banner/') . $row['image'] ?>"
                ...
                <td>
                    ...
                    <a style=" margin:8px 0px !important; width: 100%; background: #44871b !important;"
                       ...
                       class="btn bg-light-green btn-circle waves-effect waves-circle waves-float brand_edit"
                       role="button"> تعديل <i class="material-icons">translate</i>
                        <!-- <span class="material_label"><?php echo lang('aEdit'); ?> --></span>
                    </a>
                    <?php if ($seller_id == 1) { ?>
    ...
    function creatTable(tabledata, flag_row) {
        ...
        if (tabledata != '') {
            ...
            $.each(tabledata, function (k, v) {
                ...
                trHTML += '<a style=" margin:8px 0px !important; width: 100%; background: #44871b !important;" href="brand/tedit/' + v.id + '" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float brand_edit" role="button">  تعديل    <i class="material-icons">translate</i><!-- <span class="material_label"><?php echo lang('aEdit'); ?> --></span></a>';
                <?php if($seller_id == 1)
                { ?>
