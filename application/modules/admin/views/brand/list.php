...
<div class="sraech">  
  ...
  <?php if($user->type=='suppler' || $user->type=='subsupplier'){ ?>
  <a class="pro_create" href="<?php echo base_url($language.'/admin/brand/create') ?>"><?php echo lang('acreate_Brand'); ?></a>
  <?php } ?>
</div>
...
<tr>
  ...
  <th><?php echo lang('aBrand_name'); ?></th>
  <?php if($seller_id==1){ ?>
...
//print_r($list);
  if (!empty($brand_data)){ foreach($brand_data as $key => $row) {?>

<tr>
<td><?php echo $key+1; ?></td>
<td>
 <?php if($row['image']!=''){ ?> 
<a target="_blank" href="<?php echo base_url('assets/admin/banner/').$row['image']?>" class="image-thumbnail"><img class="image-thumbnail img_brand" src="<?php echo base_url('assets/admin/banner/').$row['image']?>" ></a>
<?php } ?>
</td>
...
<td>
   ...
   <a style=" margin:8px 0px !important; width: 100%; background: #44871b !important;" href="brand/tedit/<?php echo $row['id'] ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float brand_edit" role="button">  عديل    <i class="material-icons">translate</i><!-- <span class="material_label"><?php echo lang('aEdit'); ?> --></span></a>
   <?php if($seller_id==1)
    { ?>    
