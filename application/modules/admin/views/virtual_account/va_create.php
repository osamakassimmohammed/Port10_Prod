      ...
      <div class="demo-masked-input">
         ...
         <div class="row">
            ...
            <div class="<?php echo $sel_class; ?> col-sm-3">
               ...
               // die;
               ?>
               <select id="main_seller_orders" name="seller_orders" class="get_sub_seller_orders" required>
                  ...
                  if (!empty($seller_orders)) {
                     foreach ($seller_orders as $cvalue) {
            ...
            <div class="col-sm-2">
               ...
               <input type="datetime-local" id="ShippingDateTime" min="<?php echo gmdate("Y-m-d\TH:i:s"); ?>"
            ...
            <div class="col-sm-2">
               ...
               <input type="datetime-local" id="PickupDate" min="<?php echo gmdate("Y-m-d\TH:i:s"); ?>" max=""
