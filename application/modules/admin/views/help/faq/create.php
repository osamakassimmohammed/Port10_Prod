<div class="col-md-12" style="float: right;">
    <div class="button  ">
        <a href="<?php echo base_url($language . '/admin/help'); ?>"
            ...
            <div class="panel panel-default main_wrap_form">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control space" id="question" name="question"
                               placeholder="Enter Question" type="text"
                               value="<?php echo $question ?>" autocomplete="off">
                    </div>
                    <div class="clear"></div>
                    <div class="form-group">
                        <label for="answer">Answer</label>
                        <textarea class="form-control space" id="answer" name="answer"
                                  rows="4" cols="50"><?php echo $answer ?></textarea>
                    </div>
                    <div class="clear"></div>
                        ...
                        <div class="col-inner">
                            ...
                            <label for="file" class="file__drop" data-image-uploader>
                                ...
                                <div
                                    ...
                                    id="img_div">
                                    <img data-image
                                         src="<?php echo base_url("assets/admin/faq/$myimage"); ?>"
