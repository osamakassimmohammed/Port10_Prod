            ...
            <tr>
                ...
                <td>
                    <a style="width: 100%; background-color: #4f0381 !important;"
                       href="help/edit/<?php echo $row['id'] ?>"
                    ...
                    <a style="width: 100%; margin: 00px 0px !important; background-color: #44871b !important; "
                       href="help/tedit/<?php echo $row['id'] ?>"
                       class="btn bg-light-green btn-circle waves-effect waves-circle waves-float second_a"
