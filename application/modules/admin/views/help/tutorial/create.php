...
<div class="col-md-12" style="float: right;">
    <div class="button  ">
      <a href="<?php echo  base_url($language.'/admin/help/tutorial'); ?>" class=" back_to_list btn btn-primary">Back to list</a>
    </div>
</div>
                ...
                <div class="panel-body">
                    <?php echo $form->open(); ?> 
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control space" id="heading" name="heading" placeholder="Enter Question" type="text" value="<?php echo $heading ?>"  autocomplete="off" >
                        </div>
                        <div class="form-group" style="width: 30%">
                            <label style="margin-bottom: 15px;"for="heading1"> Status</label>
                            <div class="clear"></div>
                            <label><input style="float: left; margin-top: 1px; margin-left: 2px; margin-right: 5px;" type="radio" name="status" value="active" <?php echo $active; ?>>Active</label>
                            <label><input style="float: left; margin-top: 1px; margin-left: 2px; margin-right: 5px; margin-left: 10px;" type="radio" name="status" value="deactive" <?php echo $deactive; ?>>Deactive</label>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea class="form-control space" id="description" name="description" rows="4" cols="50"><?php echo $description ?></textarea>
                        </div>   
                         <div class="form-group" style="width: 30%">
                            <label for="date_of_publish">Date Of Publish</label>
                            <input class="form-control" id="date_of_publish" name="date_of_publish" placeholder="Enter First Date Of Publish" type="text" value="<?php echo $date_of_publish ?>"  autocomplete="off" >
                        </div>                     
                        <div class="clear"></div>
                        <div class="form-group">
                         ...
                         <!--    <input type="hidden" id="photo_url" value="<?php //echo base_url('admin/file_handling/uploadFiless'); ?>" />
                            ...
                            <input type="file" id="file2"  name="video" value="<?php echo $video; ?>" accept='video/mp4' />
                            

                            <!-- <input type="hidden" name="image" id="file_name" value="<?php //echo $myimage; ?>" required="required"> -->
                        </div>
                        <?php if(!empty($video)){ ?>
                        <a target="_blank" href="<?php echo base_url('assets/admin/banner/').$video?>">Video</a>
                            <?php } ?>
                            ...
                            <div class="col-inner">
                                ...
                                <label for="file" class="file__drop" data-image-uploader>
                                    ...
                                    <div style="position: relative; width: 66px;height: 74px;margin-left: 20px;" id="img_div">
                                        <img data-image  src="<?php echo base_url("assets/admin/tutorial/$myimage"); ?>" style=" width: 100px;height: 70px; " id="dis_image" />
