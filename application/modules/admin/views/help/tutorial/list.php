...
//print_r($list);
  if (!empty($tutorial_data)){ foreach($tutorial_data as $key => $row) {?>

<tr>
<td><?php echo $key+1; ?></td>

<td><a target="_blank" href="<?php echo base_url('assets/admin/banner/').$row['video']?>">Video</a></td>
<td><?php echo $row['heading']?></td>
<td><?php echo $row['status']?></td>
<td><?php echo $row['date_of_publish']?></td>
<td><?php echo $row['created_date']?></td>
<td>
   <a style="width: 100%; background-color: #4f0381 !important;" href="help/tutorial_edit/<?php echo $row['id'] ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float " role="button"><i class="material-icons">edit</i><span class="material_label"><?php echo lang('aEdit'); ?></span></a>

   <a style="width: 100%; margin: 8px 0px !important; background-color: #44871b !important; " href="help/tutorial_tedit/<?php echo $row['id'] ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float " role="button">  عديل     <i class="material-icons">translate</i></a>
