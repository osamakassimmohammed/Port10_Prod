                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="vat" name="vat"
                                   placeholder="Enter Vat" type="text"
                                   value="<?php echo $vat ?>" required=""
                                   autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1"> SAR Rate (fixed
                                no) </label>
                            <input class="form-control" id="sar_rate" name="sar_rate"
                                   placeholder="Enter SAR Rate" type="text"
                                   value="<?php echo $sar_rate ?>" required=""
                                   autocomplete="off">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Port10 Commission
                                (%) </label>
                            <input class="form-control" id="commission"
                                   name="commission" placeholder="Enter Commission"
                                   type="text" value="<?php echo $commission ?>"
                                   required="" autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Bank Fees Payment Card
                                (%) </label>
                            <input class="form-control" id="bank_fees_online"
                                   name="bank_fees_online"
                                   placeholder="Enter Bank Fees Payment Card"
                                   type="text" value="<?php echo $bank_fees_online ?>"
                                   required="" autocomplete="off">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Bank Fees Virtual Account
                                Transfer (Fixed no) </label>
                            <input class="form-control" id="bank_fees_cod"
                                   name="bank_fees_cod"
                                   placeholder="Enter Bank Fees Virtual Account Transfer"
                                   type="text" value="<?php echo $bank_fees_cod ?>"
                                   required="" autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">SARIE (Transfer) Fee (Fixed
                                no) </label>
                            <input class="form-control" id="sarie_transfer_fees"
                                   name="sarie_transfer_fees"
                                   placeholder="Enter SARIE (Transfer) Fee" type="text"
                                   value="<?php echo $sarie_transfer_fees ?>"
                                   required="" autocomplete="off">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Rajhi Bank Fee (Fixed
                                no) </label>
                            <input class="form-control" id="rajhi_bank_fees"
                                   name="rajhi_bank_fees"
                                   placeholder="Enter Rajhi Bank Fee" type="text"
                                   value="<?php echo $rajhi_bank_fees ?>" required=""
                                   autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Cap (Fixed no) </label>
                            <input class="form-control" id="cap_rate" name="cap_rate"
                                   placeholder="Enter Cap" type="text"
                                   value="<?php echo $cap_rate ?>" required=""
                                   autocomplete="off">
                        </div>
