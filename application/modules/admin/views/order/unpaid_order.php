...
<div class="">
    <a style="" href="<?php echo base_url('admin/orders/csv_dwonload/Unpaid'); ?>"
        ...
        foreach ($orders as $key => $value) {
            ...
            <tr>
                ...
                <td><?php echo $currency;
                    echo " ";
                    echo $value['net_total'] - $value['coupon_price']; ?></td>
                <td><?php echo $value['payment_status']; ?></td>
                <td><?php echo $value['payment_mode']; ?></td>
                <td><?php echo $value['ori_order_status']; ?></td>

                <td style="width: 10%">
                    <a href="orders/view/<?php echo @$value['order_master_id'] ?>"
                       class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float fist_a"
                       role="button"><i class="material-icons">remove_red_eye</i></a>
                    <a href="invoice/pdf/<?php echo @$value['order_master_id'] ?>"
                       class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float second_a"
                       role="button"><i class="material-icons">save_alt</i></a>
                    <a style="width: 100%; margin-top: 12px !important;" target="_blank"
                       href="print_file/view/<?php echo @$value['order_master_id'] ?>"
                       class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float third_a"
                       role="button"><i class="material-icons">print</i></a>
                </td>
            </tr>
...
<script type="text/javascript">
    $(document).on("keyup", "#search_val", function () {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url("admin/orders/unpaid_order"); ?>",
    ...
    function creatTable(tabledata, flag_row) {
        ...
        if (tabledata != '') {
            ...
            $.each(tabledata, function (k, v) {
                ...
                // var total=v.net_total+v.coupon_price;
                ...
                trHTML += '<td>' + v.ori_order_status + '</td>';
