<div class="col-md-12"
    ...
    <a href="<?php echo base_url('') ?>/admin/orders" class="back_button">Back to
        list</a>
</div>
                            ...
                            <td><?php if ($data['payment_mode'] == 'cash-on-del') { ?>
                                    <select id="chage_payment_status">
                                        <?php foreach ($payment_status_arr as $psa_key => $psa_val) {
                                            ...
                                            ?>
                                            <option
                                                value="<?php echo $psa_val; ?>" <?php echo $Selected; ?>><?php echo $psa_val; ?></option>
                                        <?php } ?>
                                    </select>
                                    <button id="btn_payment" class="btn btn-success">
                                        Submit
                                    </button>
                                <?php } else {
                ...
                <div class="panel-body">
                    <table id="datatable-checkbox mytable"
                        ...
                        <tr>
                            ...
                            <td colspan=""><?php echo $currency;
                                echo " ";
                                echo $data['sub_total']; ?></td>
                        </tr>
                        <tr>
                            <td colspan="6">Fees</td>
                            <td colspan=""><?php echo $currency;
                                echo " ";
                                echo $data['commission'] + $data['transfer_fees'] + $data['bank_fees']; ?></td>
                        </tr>
                        <tr>
                            <td colspan="6">Vat</td>
                            <td colspan=""><?php echo $currency;
                        ...
                        <tr>
                            ...
                            <td colspan=""><?php echo $currency;
                                echo " ";
                                echo $data['net_total'] - $data['coupon_price']; ?></td>
                        </tr>
                        <!--  <tr>
        ...
        if (payment_status == 'Paid' || payment_status == 'Unpaid') {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'order_master_id': '<?php echo @$data['order_master_id']; ?>'
                },
