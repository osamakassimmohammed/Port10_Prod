...
<div class="">  
  <a style="" href="<?php echo base_url('admin/orders/csv_dwonload/Delivered'); ?>" class="btn bg-light-green waves-effect"><span>Download</span></a> 
</div>
      ...
      $currency = $value['currency'];
        ...
        <tr>
            ...
            <td style="width: 10%">
                ...
                <a target="_blank"  href="print_file/view/<?php echo @$value['order_master_id'] ?>" class="width100 btn bg-light-green btn-circle waves-effect waves-circle waves-float third_a" role="button"><i class="material-icons">print</i></a>
            </td>
        </tr>
