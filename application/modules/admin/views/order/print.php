...
<div class="invoice-box"
     style="max-width: 100%; margin: auto; padding: 5px; border: 0px solid #000; font-size: 12px; line-height: 24px; font-family:  'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; color: #000; margin-top: 00px; margin-bottom: 00px;">
    <table style="width: 100%; line-height: inherit; text-align: left;  "
        ...
        <tr class="top">
            <td style="padding: 5px; vertical-align: top;" colspan="5">
                <table style="width: 100%; line-height: inherit; text-align: left;">
                    <tr style="    ">
                        <td style="    padding-bottom: 00px; text-align:center;"
                            class="title">
                            <img
                                src="<?php echo base_url("assets/admin/images/print.png") ?>"
                    ...
                    <tr style="font-size: 8px; text-align:center; ">
                        <td style=" text-align:center; line-height:10px; ">
                            ...
                            <span
                                style="font-size: 10px; display:inline-block; width:100%;  text-align:center; line-height:10px;  "> Customer Care : +91 965 708 5708 </span>
                        </td>
                    </tr>
                    <tr style="">
                        ...
                        <td style="padding: 0px; float: left; text-align: left;  border-top:1px solid #000; width:100%; line-height:20px; display: inline-block; padding-top: 20px; vertical-align: top; ">
                            Invoice #: <?php echo $order_data[0]['display_order_id']; ?>
                            <br>
                            Created: <?php echo date('d M Y H:i:s', strtotime($order_data[0]['order_datetime'])); ?>
                            <br>
                            <!-- Order Status: <?php echo $order_data[0]['order_status']; ?><br>-->
                            Order
                            Payment: <?php echo $order_data[0]['payment_status']; ?>
                        </td>
                    ...
                    <tr style="">
                        <td style="padding-top: 5px; font-weight: 600; color:#000; font-size: 16px;     line-height: 16px; ">
                            ...
                            <br/>
                            <span
                                style="font-size: 12px; color:#000; font-weight: 600; display: inline-block; line-height: 15px; margin-top: 0px; width: 100%; "><?php echo $order_data[0]['building_name']; ?>
                                <?php echo $order_data[0]['landmark']; ?>
                           </span>

                            <span
                                style="font-size: 12px; color:#000; font-weight: 600; display: inline-block; line-height: 15px; margin-top: 0px; width: 100%; "><?php echo $order_data[0]['address']; ?>
                           </span>

                            <span
                                style="font-size: 12px; color:#000; font-weight: 600; display: inline-block; line-height: 15px; margin-top: 0px; width: 100%; ">
