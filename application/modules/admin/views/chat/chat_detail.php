        ...
        <div class="messaging">
          ...
          <div class="inbox_msg">
            ...
            <div class="backtitl_detl chat_list">
              <a href="<?php echo base_url('admin/chat') ?>" class="back_icon_as" >
            ...
            <div class="mesgs">              
              ...
              <div class="msg_history" id="app_message" >
               <?php foreach ($user_data[0]['chat_data'] as $cd_key => $cd_val) { 
                  ...
                  { ?>
                    <div class="outgoing_msg" id="single_msg<?php echo $cd_val['id']; ?>">
                      <div class="sent_msg">
                        <p><?php echo $cd_val['message']; ?></p>
                        <span class="time_date"><?php echo  date('h:i' ,strtotime($cd_val['created_date'])); ?>    | <?php echo  date('M d' ,strtotime($cd_val['created_date'])); ?></span> 
                      </div>
                    </div>
                <?php  }else{ ?>
                    <div class="incoming_msg" id="single_msg<?php echo $cd_val['id']; ?>">
                      <!-- <div class="incoming_msg_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div> -->
                      <div class="received_msg">
                        <div class="received_withd_msg">
                          <p><?php echo $cd_val['message']; ?></p>
                          <span class="time_date"><?php echo  date('h:i' ,strtotime($cd_val['created_date'])); ?>    | <?php echo  date('M d' ,strtotime($cd_val['created_date'])); ?></span></div>
                      </div>
                    </div>
                <?php } } ?> 
                <script type="text/javascript">
              ...
              <div class="type_msg">
                <div class="input_msg_write">
                  <form id="send_form">
                    ...
                    <input type="text" id="type_text" class="write_msg space" placeholder="Type a message" />
            ...
            <?php }else{ ?>
              <h2 class="text-center text-danger">No message found</h2>
            <?php } ?>
          </div>
        <?php }else{ ?>
          <h2 class="text-center text-danger">No Compose message found</h2>
        <?php } }else{ ?>
          <h2 class="text-center text-danger">Your account is deactive please contact to admin</h2>
        <?php } }else{ ?>
          <h2 class="text-center text-danger">Please login or invalid user </h2>
        <?php } ?>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    function message_send(message,compose_idg,creceiver)
    {
        ...
        data: {message:message,'compose_id':compose_idg,creceiver:creceiver,'send_by':send_by,'send_to':send_to},            
