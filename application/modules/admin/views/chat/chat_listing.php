...
<link rel="stylesheet"
      href="<?php echo base_url('assets/frontend/css/') ?>chat_style.css">
<div class="chat-page">
                        ...
                        if ($user_data[0]['status'] == true) {
                                    ...
                                    <div class="chat-window">
                                            ...
                                            <form class="chat-search">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           placeholder="<?php echo lang('asearch'); ?>">
                                                    <button type="button" id="com_btn"
                                                            class="btn msg-send-btn"><?php echo lang('aCompose'); ?></button>
                                                    <!-- data-toggle="modal//" data-target="#contc_id//" -->
                                                </div>
                                                ...
                                                <div class="chat-scroll">
                                                    ...
                                                    foreach ($user_data[0]['compose_data'] as $cd_key => $cd_val) {
                                                        ...
                                                        <a href="javascript:void(0);"
                                                           class="media chat_list user_click <?php echo $user_active; ?>"
                                                           data-id="<?php echo $cd_val['id']; ?>">
                                                            <div class="media-img-wrap">
                                                                <div
                                                                    class="avatar avatar-away">
                                                                    <img
                                                                        src="<?php echo base_url('assets/admin/usersdata/') . $cd_val['logo']; ?>"
                                                                        alt="<?php echo $cd_val['first_name']; ?>"
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div
                                                                        class="user-name"><?php echo $cd_val['first_name']; ?></div>
                                                                    <div
                                                                        class="user-last-chat"><?php echo $cd_val['subject']; ?></div>
                                                                </div>
                                                                <div>
                                        ...
                                        <div class="chat-cont-right">
                                            ...
                                            foreach ($user_data[0]['compose_data'] as $cd_key => $cd_val) {
                                                ...
                                                ?>
                                                <div
                                                    class="chat-body mesgs <?php echo $show_message_div;
                                                    echo $seen_class; ?>"
                                                    data-id="<?php echo $cd_val['id']; ?>"
                                                    id="sh_chat<?php echo $cd_val['id']; ?>">
                                                    <div class="chat-scroll"
                                                         id="chat_scroll<?php echo $cd_val['id']; ?>">
                                                        <ul class="list-unstyled"
                                                            id="app_message<?php echo $cd_val['id']; ?>">
                                                            <li class="media sent">
                                                                <div
                                                            ...
                                                            <?php if (!empty($cd_val['chat_data'])) {
                                                                foreach ($cd_val['chat_data'] as $chd_key => $chd_val) {
                                                                    ...
                                                                    if ($user_data[0]['id'] == $chd_val['user_id']) { ?>
                                                                        <li class="media sent"
                                                                            id="single_msg<?php echo $chd_val['id']; ?>">
                                                                            <div
                                                                                class="avatar">
                                                                                <img
                                                                                    src="<?php echo base_url('assets/admin/usersdata/') . $user_data[0]['logo']; ?>"
                                                                                    alt="User Image"
                                                                                    class="avatar-img rounded-circle">
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <?php } else { ?>
                                                                                            <img
                                                                                                class="chat_img"
                                                                                                src="<?php echo base_url('assets/admin/chat/') . $chd_val['message']; ?>">
                                                                                        <?php } ?>
                                                ...
                                                <div
                                                    class="chat-footer mesgs <?php echo $show_message_div;
                                                    echo $seen_class; ?>"
                                                    id="sh_chat2<?php echo $cd_val['id']; ?>">
                                                    <form class="msg_form"
                                                          data-id="<?php echo $cd_val['id']; ?>"
                                                          data-creceiver="<?php echo $cd_val['usid']; ?>"
                                                          data-send_to="<?php echo $cd_val['send_to']; ?>"
                                                          data-send_by="<?php echo $user_data[0]['send_by']; ?>">
                                                        <textarea class="space" name=""
                                                                  id="type_text<?php echo $cd_val['id']; ?>"
                                                                  cols="30" rows="5"
                                                                  style="height: 100px; width: 100%; border-color: #e3e3e3;"
                                                                  data-id="<?php echo $cd_val['id']; ?>"></textarea>
                                                        <div
                                                            class="input-group sent-msg-btn">
                                                            <div
                                                                class="input-group-prepend">
                                                                <div
                                                                    class="btn-file btn">
                                                                    <img
                                                                        src="<?php echo base_url('assets/frontend/images/paper-clip.png'); ?>"
                                                                        alt=""
                                                                        style="width: 20px;">
                                                                    <input type="file"
                                                                           class="chat_pic"
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                        class="btn msg-send-btn send_btn"
                                                                        id="send_btnhs<?php echo $cd_val['id']; ?>"
                                                                        data-id="<?php echo $cd_val['id']; ?>"
                                                                        data-creceiver="<?php echo $cd_val['usid']; ?>"
                                                                        data-send_to="<?php echo $cd_val['send_to']; ?>"
                                                                        data-send_by="<?php echo $user_data[0]['send_by']; ?>"><?php echo lang('Send'); ?></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                            ...
                            <?php } else { ?>
                                ...
                                <a href="javascript:void(0)"
                                   ...
                                   id="hsc_error"> <?php echo lang('No_message_found'); ?></a>

                            <?php }
                        } else { ?>
                            <a href="javascript:void(0)"
                               class="chat_list text-center text-danger" id="hsc_error">
                                Your account is deactive please contact to admin</a>

                        <?php }
                    } else { ?>
                        <a href="javascript:void(0)"
                           class="chat_list text-center text-danger" id="hsc_error"> No
                            message found</a>
                    <?php } ?>
                </div>
            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="singl_input_qutn" name="user_id"
                                    id="cseller_id">
                                <option
                                    value="0"><?php echo lang('aPlease_select_vendor'); ?></option>
                        ...
                        <div class="col-md-12 mesg_lablas">
                            ...
                            <textarea class="form-control message_text_are space"
                                      ...
                                      rows="6" id="cmessage" name="message"></textarea>
                        </div>
