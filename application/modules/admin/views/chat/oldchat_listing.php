            ...
            <form class="theme-form" id="compose_form" method="post" enctype="multipart/form-data">
               <div class="form-row">
                  ...
                  <div class="col-md-12 mesg_lablas">
                     ...
                     <textarea class="form-control message_text_are space" placeholder="Wrire Your Message" rows="6"
                        ...
                        if ($user_data[0]['status'] == true) {
                           if (!empty($user_data[0]['compose_data'])) {
                              foreach ($user_data[0]['compose_data'] as $cd_key => $cd_val) { ?>
                                 ...
                                 <a href="<?php echo base_url('admin/chat/detail/') . $cd_val['id']; ?>" class="chat_list"
                                    ...
                                    <div class="chat_people">
                                       ...
                                       <div class="chat_ib">
                                          <h5>
                                             <?php echo $cd_val['first_name']; ?> <span class="chat_date">
                                                <?php echo date('M d', strtotime($cd_val['ccreated_date'])); ?>
                                             </span>
                                          </h5>
                                          <div class="subject_wrp">
                                             <div class="subject_titl"> Subject <span>:</span></div>
                                             <div class="subject_text">
                                                <?php echo $cd_val['subject']; ?>
                                             </div>
                                             <div class="clear"></div>
                                          </div>
                                          <div class="clear"></div>
                                          <div class="subject_wrp">
                                             ...
                                             <div class="subject_text">
                                                <?php echo $cd_val['compose_message']; ?>
                                             </div>
                                             <div class="clear"></div>
                                          </div>
                                       </div>
                              ...
                              <a href="javascript:void(0)" class="chat_list text-center text-danger" id="hsc_error"> No message
                                 found</a>
                           <?php }
                        } else { ?>
                           <a href="javascript:void(0)" class="chat_list text-center text-danger" id="hsc_error"> Your account
                              is deactive please contact to admin</a>
                        <?php }
                     } else { ?>
                        <a href="javascript:void(0)" class="chat_list text-center text-danger" id="hsc_error"> No message
                           found</a>
