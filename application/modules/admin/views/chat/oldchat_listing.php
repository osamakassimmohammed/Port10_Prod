         ...
         <form class="theme-form" id="compose_form" method="post" enctype="multipart/form-data">
            <div class="form-row">
               ...
               <div class="col-md-12 mesg_lablas">
                  ...
                  <textarea class="form-control message_text_are space" placeholder="Wrire Your Message"  rows="6" id="cmessage" name="message"></textarea>
               </div>
                    ...
                    <?php if(!empty($user_data))
                    {
                      if($user_data[0]['status']==true)
                      {
                        if(!empty($user_data[0]['compose_data'])){
                         ...
                         <a href="<?php echo base_url('admin/chat/detail/').$cd_val['id']; ?>" class="chat_list" id="compose<?php echo $cd_val['id']; ?>">
