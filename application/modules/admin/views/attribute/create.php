   ...
   <div class="col-md-6">
      <div class="box box-primary">
        ...
        <form id="form" name="form" method="post">
           <div class="box-body">
              <!-- <?php echo $form->open(); ?> -->
                 <input type="text" name="name_a" id="name_a"  class="form-control" placeholder="Attribute Name">
                 <br>
                 <input type="text"  name="item" id="item" class="form-control" placeholder="item_priority">
                 <br>
                 <input type="reset" class="btn btn-default" name="add" id="add" value="ADD">
           </div>
           <br>
           <!-- <?php echo $form->close(); ?> -->
