...
if (isset($tedit)) {
//$meta_key = $edit['meta_key'];
    $item_name = $tedit['item_name'];
// $i_priority = $tedit['i_priority'];
// $item_value = $tedit['item_value'];
    $myimage = $tedit['image'];
}
?>
<div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <!-- <div class="form-group">
                        <label for="groups">i_priority</label>
                        <div>
                        <?php echo $form->bs3_text('i_priority ', 'i_priority', $i_priority, array('required' => '')); ?>
                        </div>
                    </div> -->
                ...
                <!-- <div class="form-group">
                        <label for="groups">item_value</label>
                        <div>
                        <?php echo $form->bs3_text('item_value ', 'item_value', $item_value, array('required' => '')); ?>
                        </div>
                    </div> -->
                ...
                <?php if (!empty($myimage)) { ?>
                    ...
                    <input type="hidden" name="image" id="file_name"
                           value="<?php echo $myimage; ?>" <?php if (empty($myimage)) echo "required"; ?>>
                    <div class="row" style="margin-left: 0px;">
                        ...
                        <div class="col-25">
                            <div class="col-inner">
                                ...
                                <label for="file" class="file__drop"
                                       data-image-uploader>
                                    ...
                                    <div
                                        ...
                                        id="img_div">
                                        <img data-image
                                             src="<?php echo base_url("assets/frontend/images/home/" . $myimage); ?>"
                                             style="width: 100px;height: 75px;padding: 10px 0;"/>
                                    </div>
                                    <?php if (!isset($tedit)) { ?>
                                    <span id="span_hide"
                                          class="choose-image"><?php echo "Choose Image"; ?>
                                        <?php } ?>
                                </span>
                                </label>
                            </div>
