...
<script
    src='<?php echo base_url(); ?>assets/grocery_crud/themes/datatables/jquery-datatable/extensions/pdfmake.min.js'></script>
<script
    src='<?php echo base_url(); ?>assets/grocery_crud/themes/datatables/jquery-datatable/extensions/buttons.html5.min.js'></script>
<script
    src='<?php echo base_url(); ?>assets/grocery_crud/themes/datatables/jquery-datatable/extensions/buttons.print.min.js'></script>
...
<?php echo str_replace('#', '', $row['attribute_code']) ?>
            ...
            <td class="actions" style="width: 8%">
                <a data-id="<?php echo $row['id']; ?>"
                   class="cat_submit btn bg-light-green btn-circle waves-effect waves-circle waves-float "
                   role="button">
                ...
                <a data-id="<?php echo $row['id']; ?>"
                   class="btn bg-light-green btn-circle delete-service"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="">
                    ...
                    <input type="hidden" class="input_class" id="add_size_id"
                           name="a_id" value="20">
                    <input type="text" class="input_class" id="add_size_name"
                           name="item_name" autocomplete="off" required>
                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="">
                    <label>Color</label>
                    <input type="hidden" class="input_class" id="add_color_id"
                           name="a_id" value="19">
                    <input type="text" class="input_class" id="add_color_name"
                           name="item_name" autocomplete="off" required>
                </div>

                <div class="">
                    <label>Select color</label>
                    <input type="color" style="height: 40px; padding: 2px;"
                           class="input_class" id="add_color_arrt" name="attribute_code"
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" id="add_color_btn">
                    Submit
                </button>
            </div>
        </div>
...
<div class="modal fade " id="myModal11" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="">
                    <div class="category-item categry_pop_item"
                         id="sub_cat_listing"></div>

                    <div class="serch_pop_btn_wrp" style="clear: both;">
                        <button type="submit" id="search_submit"
                                class="serch_list_btn_a">Update
                        </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="">
                    ...
                    <input type="hidden" class="input_class" id="add_weight_id"
                           name="a_id" value="21">
                    <input type="text" class="input_class" id="add_weight_name"
                           name="item_name" autocomplete="off" required>
                </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success " id="add_weight_btn">
                    Submit
                </button>
            </div>
        </div>
    ...
    $(document).on("click", ".serch_list_btn_a", function () {
        ...
        if (class_a_id !== '' && class_value !== "") {
            $.ajax({
                ...
                data: {
                    id: class_id,
                    item_name: class_value,
                    attribute_code: class_attribute_code
                },
                success: function (response) {
