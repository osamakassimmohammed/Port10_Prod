                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="entity_name"
                                   value="<?php echo $user->entity_name ?>"
                                   placeholder="<?php echo lang('Entity_Name'); ?>"
                                   id="sestiblishment" class="form-control ">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="username"
                                   ...
                                   id="scr_number" class="form-control "
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="street_name"
                                   ...
                                   id="sstreet_name" class="form-control ">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="building_no"
                                   ...
                                   id="sbuilding_no" class="form-control ">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-line focused">
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="postal_code"
                                   ...
                                   id="spostal_code" class="form-control "
                                   onkeypress="return isNumberKey(event)">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="country"
                                   ...
                                   id="scountry" class="form-control " readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-line focused">
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="vat_number"
                                   ...
                                   id="svat_number" class="form-control "
                                   onkeypress="return isNumberKey(event)">
                        </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="iban"
                                   value="<?php echo $user->iban ?>"
                                   placeholder="<?php echo lang('IBAN'); ?>" id="siban"
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="first_name"
                                   ...
                                   id="sfirst_name" class="form-control ">
                        </div>
                    </div>
                ...
                <?php } else { ?>
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="first_name"
                                   value="<?php echo $user->first_name ?>"
                                   placeholder="First name" id="sfirst_name"
                                   class="form-control ">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="last_name"
                                   ...
                                   id="slast_name" class="form-control ">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-line focused">
                            ...
                            <input type="text" name="username"
                                   value="<?php echo $user->username ?>"
                                   placeholder="<?php echo lang('User_Name'); ?>"
                                   id="susername" class="form-control ">
                        </div>
                    </div>
                <?php } ?>
                <div class="clear"></div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-line">
                                <input type="file" name="logo" value="" required=""
                                       autocomplete="off"
                                       class="form-control image_check">
                            </div>
                            <img id="blah" class="blah" width="200px" height="200px"
                                 src="<?php echo base_url('assets/admin/usersdata/') . @$user->logo; ?>"
                                 alt="your image"/>
                            <div class="clear"></div>
                            <div class="col-sm-12" style="margin: 0px;padding: 0px;">
                                <button type="submit" style="margin-top: 10px"
                                        class="btn btn-primary col-sm-12"><?php echo lang('aUpload_Profile'); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h4 style="margin-left: 0px;"
                        class="box-title"><?php echo lang('aChange_Password'); ?></h4>
                </div>
                <br>
                <div class="row">
                    <?php echo $form2->open(); ?>
                    <div class="col-sm-12">
                        <div class="form-line focused">
                            ...
                            <input type="text" id="pro_new_password" name="new_password"
                                   value=""
                    ...
                    <div class="col-sm-12">
                        <div class="form-line focused">
                            ...
                            <input type="text" id="pro_retype_password"
                                   name="retype_password" value=""
                                   placeholder="<?php echo lang('aRetype_Password'); ?>"
                                   class="form-control ">
                        </div>
                    </div>
                    <div class="clear"></div>
