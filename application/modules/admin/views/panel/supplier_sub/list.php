...
<div class="form-group">
    ...
    <?php if (!empty($subq)) { ?>
        <?php if ($users_data[0]['subs_status'] == 'expired') { ?>
            <span><?php echo lang('aYour_Plan_Status'); ?>:<span
                    class="label label-danger"><?php echo lang('aExpired'); ?></span></span>
        <?php } else if ($users_data[0]['subs_status'] == 'trial') { ?>
            <span><?php echo lang('aYour_Plan_Status'); ?>:<span
                    class="label label-primary"><?php echo lang('aTrial'); ?></span></span>
        <?php } else { ?>
            <span><?php echo lang('aYour_Plan_Status'); ?>:<span
                    class="label label-success"><?php echo lang('aActive'); ?></span></span>
        <?php } ?>
    <?php } ?>
</div>
...
<?php if (!empty($subq)) { ?>
    <a class="sub_btn" style="float: right;margin-bottom: 10px;"
       href="<?php echo base_url($language . '/price') ?>"
       class="btn bg-light-green waves-effect"><span><?php echo lang('aRenew_Subscription'); ?></span></a>
<?php } ?>
