...
<td><a href="seller/orders/<?php echo $row['uide'];?>" class="btn btn-info"><?php echo $row['order_count'];?></a></td>
<td><a href="" class="btn btn-info"><?php echo $row['send_quotation_count'];?></a></td>
<td><?php echo $row['access_permission'];?></td>
<td><?php echo $row['created_on'];?></td>
<td>
  <a href="panel/create_sub_seller/<?php echo $row['id'] ?>" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float fist_a" role="button"><i class="material-icons">edit</i><span class="material_label">Edit</span></a>
</td>
</tr>
<?php } } else { ?>
...
<script type="text/javascript">
    ...
    $('#loading').show();     
      $.ajax({
           type: 'POST',
           url: "<?php echo base_url($language."/admin/panel/sub_supplier_list"); ?>",
     ...
     function creatTable(tabledata,flag_row) {
      ...
      $.each(tabledata, function( k, v ) {   
           ...
           if(v.active=="1")
           {
            ...
            trHTML+='<button class="btn btn-danger" >Deactive</button>';
           }
           trHTML+='</td>';
           ...
           trHTML+='<td><a href="seller/orders/'+v.uide+'" class="btn btn-info">'+v.order_count+'</a></td>'; 
           trHTML+='<td><a href="" class="btn btn-info">'+v.send_quotation_count+'</a></td>'; 
           trHTML+='<td>'+v.access_permission+'</td>'; 
           trHTML+='<td>'+v.created_on+'</td>';        
          
          trHTML+='<td><a href="<?php echo base_url($language);?>/admin/panel/create_sub_seller/'+v.id+'/" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float fist_a" role="button"><i class="material-icons">edit</i><span class="material_label">Edit</span></a></td>';    
