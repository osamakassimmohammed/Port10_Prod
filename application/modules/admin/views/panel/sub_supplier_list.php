    ...
    if (!empty($users_data)) {
        foreach ($users_data as $key => $row) { ?>
            ...
            <tr>
                ...
                <td><a href="seller/orders/<?php echo $row['uide']; ?>"
                       class="btn btn-info"><?php echo $row['order_count']; ?></a></td>
                <td><a href=""
                       class="btn btn-info"><?php echo $row['send_quotation_count']; ?></a>
                </td>
                <td><?php echo $row['access_permission']; ?></td>
                <td><?php echo $row['created_on']; ?></td>
                <td>
                    <a href="panel/create_sub_seller/<?php echo $row['id'] ?>"
