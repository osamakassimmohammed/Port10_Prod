...
<div class="row">
    ...
    <div class="col-md-12 col-md-8asas">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form action="" id="account_pro_update" method="post"
                    ...
                    <div class="col-sm-3">
                        <div class="form-line focused">
                            ...
                            <select class="form-control " id="saccess_permission"
                                    name="access_permission[]" multiple>
                                ...
                                <?php if (!empty($permission_arr)) {
                                    foreach ($permission_arr as $pcl_key => $pcl_val) {
                                        ...
                                        ?>
                                        <option
                                            value="<?php echo $pcl_key; ?>" <?php echo $bselected; ?>><?php echo $pcl_val; ?></option>
                                    <?php }
                                } ?>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-line focused">
                            ...
                            <input type="password" id="pro_new_password"
                    ...
                    <div class="col-sm-3">
                        <div class="form-line focused">
                            ...
                            <input type="password" id="pro_retype_password"
                    ...
                    <div class="col-sm-4">
                        <div class="form-line">
                            <input type="file" name="logo" value="" autocomplete="off"
                                   class="form-control image_check" accept="image/*"/>
                        </div>
                        <img id="blah" class="blah" width="200px" height="200px"
                             src="<?php echo base_url('assets/admin/usersdata/') . $logo; ?>"
                             alt="your image"/>
                        <div class="clear"></div>
                    </div>
