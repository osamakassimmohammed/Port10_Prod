                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select placeholder="" id="cus_type" name="type" disabled>
                            ...
                            <option value="1" <?php echo $radio_selected; ?> >Radio
                            </option>
                            <option value="2" <?php echo $check_selected; ?>>check box
                            </option>
                        </select>
                    </div>
                    <?php
                    ...
                    foreach ($pcustomize_data[0]['pcustomize_attr'] as $pcus_key => $pcus_val) {
                        ...
                        <div class="row" class="append_custom">
                            ...
                            <div class="col-sm-4 remove<?php echo $pcus_val['id']; ?>">
                                ...
                                <div class="form-group form-float form-group-lg">
                                    <div class="form-line">
                                        <input type="text" name="price_bh[]"
                                               value="<?php echo $pcus_val['price_bh']; ?>"
                                               placeholder="Product Name" id="title"
                                               autocomplete="off"
                                               class="form-control att_priceb ">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 remove<?php echo $pcus_val['id']; ?>">
                                ...
                                <div class="form-group form-float form-group-lg">
                                    <div class="form-line">
                                        <input type="text" name="price_ad[]"
                                               value="<?php echo $pcus_val['price_ad']; ?>"
                                               placeholder="Product Name" id="title"
                                               autocomplete="off"
                                               class="form-control att_pricea ">
                                    </div>
                                </div>
                            </div>
                        </div>
