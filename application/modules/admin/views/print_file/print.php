...
<table>
    <tr>
        <td colspan="3">
            <span>Name: </span><span><?php echo $data[0]['first_name']; ?></span></td>
        <td>
            <span>Invoice id: </span><span> <?php echo $data[0]['order_master_id']; ?></span>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="2"><?php echo $currency . ' ';
            echo $data[0]['commission'] + $data[0]['transfer_fees'] + $data[0]['bank_fees']; ?></td>
    </tr>
