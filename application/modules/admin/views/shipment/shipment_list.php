...
<div class="sraech">
  ...
  <?php if ($user->type == 'suppler' || $user->type == 'subsupplier' || $user->type == '') { ?>
    <a class="pro_create" href="<?php echo base_url($language . '/admin/shipments/shipmentCreate') ?>"><?php echo lang('acreate_Shipment'); ?></a>
  <?php } ?>
</div>
<table class="table table-bordered table-striped table-hover dataTable js-exportable">
  <thead>
    <tr>
      ...
      <th style="width: 10%;">
        <?php echo lang('Shipment_Id'); ?>
      </th>
      <th style="width: 10%;">
        <?php echo lang('shipping_date'); ?>
      </th>
      <th style="width: 10%;">
  ...
  <tbody id="table_body">
    ...
    if (!empty($shipment_data)) {
      foreach ($shipment_data as $key => $row) { ?>
        ...
        <tr>
          ...
          <td>
            <?php echo $row['order_master_id'] ?>
          </td>
          <td>
            <?php echo $row['logistics_shipment_id'] ?>
          </td>
          <td>
            <?php echo $row['shipping_date_time'] ?>
          </td>
          <td>
            <?php echo $row['status'] ?>
          </td>
          ...
          <!-- <td>
            ...
            <a style=" margin:8px 0px !important; width: 100%; background: #44871b !important;"
              href="brand/tedit/<?php echo $row['id'] ?>"
              class="btn bg-light-green btn-circle waves-effect waves-circle waves-float brand_edit" role="button"> عديل <i
                class="material-icons">translate</i><?php echo lang('aEdit'); ?></span></a>
            <?php if ($seller_id == 1) { ?>
