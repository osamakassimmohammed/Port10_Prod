...
<div class="sraech">  
  ...
  <a class="pro_create" href="<?php echo base_url($language.'/admin/shipments/labelCreate') ?>"><?php echo lang('acreate_Label'); ?></a>
  <?php } ?>
</div>
...
<tr>
  ...
  <th style="width: 10%;"><?php echo lang('aDisplay_Order_Id'); ?></th>
  <th style="width: 10%;"><?php echo lang('Shipment_Id'); ?></th>        
  <th style="width: 10%;"><?php echo lang('aWeight'); ?></th>        
  <?php if($seller_id==1){ ?>
...
//print_r($list);
  if (!empty($label_data)){ foreach($label_data as $key => $row) {?>

<tr>
<td><?php echo $key+1; ?></td>
<td><?php echo $row['order_id']?></td>
<td><?php echo $row['shipment_id']?></td>
<td><?php echo $row['weight']?></td>   <?php if($seller_id==1){ ?>
