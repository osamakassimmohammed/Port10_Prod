<div class="col-md-12" style="float: right;    margin-bottom: 0px;    height: 10px; margin-top: -10px;">
      <a href="<?php echo base_url($language) ?>/admin/shipments" class="back_button"><?php echo lang('aBack_To_List'); ?></a>
</div>
      ...
      <div class="demo-masked-input">
         ...
         <div class="row">            
            ...
            <!-- <div class="<?php echo $sel_class; ?> col-sm-3">
               <label for="category"><?php echo lang('aDisplay_Order_Id'); ?></label>
               <select id="main_category" name="category" class="get_sub_category" >
                  <?php
                  if (!isset($edit)) { ?>
                  <option value="0"><?php echo lang('Select_Order'); ?></option>
                  <?php } ?>
                  <?php
                  if (!empty($category)) {
                     // echo "<pre>";
            ...
            <?php if (!empty($supplier_data) && $seller_id == 1) { ?>
                     <div class="<?php echo $sel_class; ?> col-sm-3">
                        ...
                        <label for="seller_orders"><?php echo lang('aOrders'); ?></label>
         ...
         <!--  this comment for to hide sub sub category -->
           ...
           <?php endif ?>
            ...
            <div class="col-sm-6">
               <label for="category"><?php echo lang('Transaction_Reference_Note'); ?></label>
               <textarea id="ckeditor10" name="Transaction_Reference_Note"  ><?php echo $description; ?></textarea>
            </div>
            <div class="col-sm-6">
               <label for="specification"><?php echo lang('Shipment_Reference_Note'); ?></label>
               <textarea id="specification" name="Shipment_Reference_Note"  ><?php echo $specification; ?></textarea>
            </div>                   
            <div class="col-sm-4">
               <div class="form-group">
                  <label for="groups"><?php echo lang('aStatus'); ?></label>
                  <div>
                     <?php echo $form->bs3_radio(lang('aPending'), 'status', 'Pending', array('required' => '', 'id' => "radio1"), $status_deactive); ?>
                     <?php echo $form->bs3_radio(lang('aReady'), 'status', 'Ready', array('required' => ''), $status_active); ?>
                  </div>
               </div>
            </div>
            <!-- <div class="col-sm-4">
            ...
            <div class="col-md-3 col-sm-4">
               <label for="ShippingDateTime"><?php echo lang('shipping_date'); ?></label><br>
               <input type="datetime-local" id="ShippingDateTime" min="<?php echo gmdate(""); ?>" name="ShippingDateTime" required>
            </div>
            <div class="col-md-3 col-sm-4">
               <label for="DueDate"><?php echo lang('shipping_due_date'); ?></label><br>
               <input type="datetime-local" id="DueDate" name="DueDate" min = "" required>
            </div>
...
<script type="text/javascript">
   ...
   function myFunction() {
   min_date = document.getElementById("ShippingDateTime").value;  
   }
</script>
