        ...
        if (!empty($today_order)) {
            foreach ($today_order as $row) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php $now = date('l dS \o\f F Y ,  h:i:s', strtotime($row['order_datetime']));
                        echo $now; ?>
                    ...
                    <td class="actions">
                        ...
                        <a href="<?php echo base_url(); ?>admin/orders/view/<?php echo $row['order_master_id'] ?>"
...
<div class="">
    ...
    <?php if (count($top_selled) > 8) { ?>
        <a class="btn btn-info top_view"
           href="<?php echo base_url('admin/dashbord/all_topsold'); ?>">View All</a>
        <div class="clear"></div>
    <?php } ?>
                ...
                <div class="col-sm-3">
                    <div class="thumbnail card top_seling_sectn">
                        <div class="header pading_top_header header_with_desrctpn">
                            <h3 class="p_name_h3">
                                Product <?php echo ' Sold ' . $top_selled[$i]['pro_count'] . ' times .'; ?> </h3>
