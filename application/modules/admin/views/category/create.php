<div class="col-md-12" style="float: right;    margin-bottom: 0px;    height: 10px; margin-top: -10px;">
      <a href="<?php echo base_url($language) ?>/admin/category" class="back_button">Back to list</a>
</div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <?php echo $form->open(); ?>
                    ...
                    <?php $cn = "Category Name"; if($type == "vendor") $cn = "Category Name";
                    ...
                    <select class="form-control show-tick " name="parent" data-placeholder="Choose Parent Category" <?php if ($vendor == 1) {
                        echo "required";
                    } ?>>
                        <option />
                        <?php
                            ...
                            <div class="col-inner">
                                ...
                                <label for="file" class="file__drop" data-image-uploader>
                                    ...
                                    <div style="position: relative; width: 66px;height: 74px;margin-left: 20px;" id="img_div">
                                        <img data-image  src="<?php echo base_url("assets/admin/category/$myimage"); ?>" style=" width: 100px;height: 70px; " id="dis_image" />
                                    ...
                                    <?php 
                                if (!isset($edit)) { ?>
                                    <span class="choose-image"><?php echo "Choose Category Image"; ?>
                                 <?php } ?>         
                                    </span>
                                </label>
                            </div>
                    ...
                    <div class="row" style="margin-left: 0px;display: none;">
                        ...
                        <div class="col-25" >
                            <div class="col-inner">
                                <?php //print_r($myimage); ?>
                                <input type="file" style="display: none" id="file2" name="banner_image" class="image_check" data-class="dis_image2" value="" />
                                <label for="file2" class="file__drop">
                                    <span class="text">&nbsp;</span>
                                    <div style="position: relative; width: 66px;height: 74px;margin-left: 20px;" id="img_div2">
                                        <img data-image  src="<?php echo base_url("assets/admin/category/$banner_image"); ?>" style=" width: 100px;height: 70px; " id="dis_image2" /> 
                                        <!-- <div class="preloader pl-size-l" style="position: absolute;margin-top: 14px;margin-left: 19px;" id="img_loader"> -->
                                            <!-- <div class="spinner-layer pl-light-green">
                                                <div class="circle-clipper left">
                                                    <div class="circle"></div>
                                    ...
                                    <?php 
                                if (!isset($edit)) { ?>
                                    <span class="choose-image" id="hide_show_tag" style="margin-top: 45px"><?php echo "Choose Category Banner"; ?>
                                 <?php } ?>         
                                    </span>
                                </label>
                            </div>
