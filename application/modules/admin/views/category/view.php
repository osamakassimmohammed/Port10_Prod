...
<style type="text/css">
	span.actions{display:inline-block;float: right;}
	.list-group-item{display: block;width: 100%;padding: 5px 10px 25px;}
	.bg-light-green {background-color: #ad0425 !important;}
	.card {width: 100%;}
</style>