            ...
            <div class="panel panel-default main_wrap_form">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="width: 30%">
                        <label for="bstart_date"> Select Seller</label>
                        <select id="fseller_id" name="seller_id" class="form-control">
                            <option value="0">Select Seller</option>
                            <?php if (!empty($supplier_data)) {
                                foreach ($supplier_data as $key => $val) { ?>
                                    <option
                                        value="<?php echo $val['id']; ?>"><?php echo $val['first_name']; ?></option>
                                <?php }
                            } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group" style="width: 30%">
                        ...
                        <input class="form-control" id="bstart_date" name="start_date"
                               placeholder="Select Start Date" type="text" value=""
                               autocomplete="off">
                    </div>

                    <div class="form-group" style="width: 30%">
                        <label for="bend_date"> End Date</label>
                        <input class="form-control" id="bend_date" name="end_date"
                               placeholder="Select End Date" type="text" value=""
                               autocomplete="off">
                    </div>
