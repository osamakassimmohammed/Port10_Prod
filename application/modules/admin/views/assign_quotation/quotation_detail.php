			...
			<select multiple name="assign_vender[]" id="assign_vender">
				...
				<?php if(!empty($seller_list)){ 
					...
					{ 
						...
						?>
						<option value="<?php echo $sl_val['id']; ?>" <?php echo $selected; ?>><?php echo $sl_val['first_name']; ?></option>
				<?php	}
				} ?>
			</select>
		</div>
    ...
    if(assign_vender==null)
    {
      ...
      $('#loading').show();      
        $.ajax({
          ...
          data: {'assign_vender':assign_vender,'req_id':"<?php echo $quotation_data[0]['id']; ?>"},
