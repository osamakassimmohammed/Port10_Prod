...
<div class="col-md-12" style="float: right;    margin-bottom: 50px;    height: 10px; margin-top: 0px;">
...
//print_r($list);
  if (!empty($image_data)){ foreach($image_data as $key => $row) {?>

<tr>
<td><?php echo $key+1; ?></td>
<td>
 <?php if($row['image']!=''){ ?> 
<a target="_blank" href="<?php echo base_url('assets/admin/products/').$row['image']?>" class="image-thumbnail"><img class="image-thumbnail img_brand" src="<?php echo base_url('assets/admin/products/').$row['image']?>" ></a>
<?php } ?>
</td>
