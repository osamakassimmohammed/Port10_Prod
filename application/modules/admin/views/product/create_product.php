      ...
      <div class="demo-masked-input">
         ...
         <div class="row">
            ...
            <div class="col-sm-4" style="">
               <label for="short_description"><?php echo lang('aPlease_enter_short_description'); ?></label>
               <div class="form-group">
                  <div class="form-line">
                     <input type="text" name="short_description" id="short_description" class="form-control space" value="<?php echo $short_description; ?>" placeholder="<?php echo lang('aPlease_enter_short_description'); ?>.">
                  </div>
               </div>
            </div> 
         </div>
         ...
         <div class="row">            
            <div class="col-sm-3">
               ...
               <div class="form-group form-float form-group-lg">
                  <div class="form-line"><input type="text" name="sku_code" value="<?php echo $sku_code; ?>" placeholder="<?php echo lang('SKU_Information'); ?>" id="sku_code" autocomplete="off" class="form-control space" onkeypress="return isNumberKey(event)">
                  </div>
               </div>            
            </div> 
         ...
         <!--  this comment for to hide sub sub category -->
            ...
            <?php foreach ($pcustomize_list as $ckey => $cvalue): 
                if($cvalue['type']==3){ $ctype="Check Box Paid"; } elseif($cvalue['type']==2) { $ctype="Check Box Free"; }else { $ctype="Radio"; }  ?>
               <div class="col-sm-6">
               <p><?php echo $cvalue['title']; ?> (<?php echo $ctype; ?>)</p>
           ...
           <?php endif ?>
            ...
            <div class="col-sm-6">
               <label for="specification"><?php echo lang('aSpecification'); ?></label>
            ...
            <div class="col-sm-4">
             ...
             <div  style="display: none" class="col-sm-3">
               <div class="form-group">
                  ...
                  <div>
                     <input  type="checkbox" id="special_menu" name="special_menu" value="1" class="with-gap radio-col-green" <?php echo $special_menu; ?> >
               <label for="special_menu" style="margin-left: -20px">Special Menu</label>                     
                  </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 " style=""> 
               <label for="category"><?php echo lang('aMin_Order_Quantity'); ?></label>
               <div class="form-group form-float form-group-lg">
                  <div class="form-line">
                  <input type="text" name="min_order_quantity" value="<?php echo $min_order_quantity; ?>" placeholder="<?php echo lang('aMin_Order_Quantity'); ?>" id="min_order_quantity" class="form-control ">
                  </div>
               </div>            
            </div>
            ...
            <div class="col-sm-4">
               <label for="shipment_by"><?php echo lang('aReady_for_shipment_by'); ?></label>
            ...
            <div class="col-sm-2" style="margin-top: 25px;">
               <div class="form-group">                  
                 <div>
                     <input type="checkbox" name="is_delivery_available" id="is_delivery_available" value="1" class="with-gap radio-col-green" <?php echo $is_delivery; ?>> <label for="is_delivery_available"><?php echo lang('aDelivery_Available'); ?></label>                                                          
                  </div>
               </div>
            </div>
            <div class="col-sm-2" style="margin-top: 25px;">
               <div class="form-group">                  
                 <div>                       
                     ...
                     <input type="checkbox" name="is_sample_order" id="is_sample_order" value="1" class="with-gap radio-col-green" <?php echo $is_sample; ?>> <label for="is_sample_order"><?php echo lang('Sample_Order'); ?></label>                             
                  </div>
               </div>
            </div>
            ...
            <div class="col-sm-4">
               ...
               <select  placeholder="" id="packaging_type" name="packaging_type" >
                   <?php
                     if(!isset($edit)){ ?>
                     <option value="0"><?php echo lang('aselect_Packaging_Type'); ?></option>
                  <?php }  ?>
                  <?php                                        
                     if (!empty($pack_arr))
                     {  
            ...
            <div class="col-sm-4">
             ...
             <div class="col-sm-4">
               ...
               <select  placeholder="" id="city" name="city" >
                   <?php
                     if(!isset($edit)){ ?>
                     <option value="0"><?php echo lang('Select_City'); ?></option>
                  <?php }  ?>
                  <?php                                        
                     if (!empty($city_list))
                     {  
            ...
            <div class="col-sm-4">
               <label for="warehouse_location"><?php echo lang('aWarehouse_location'); ?></label>
               <input type="text" name="warehouse_location" value="<?php echo $warehouse_location; ?>" placeholder="<?php echo lang('aWarehouse_location'); ?>" id="searchInput" autocomplete="off" class="form-control space">
            </div>
            ...
            <!-- <div class="clear"></div> -->
            <div class="col-sm-4">
               <label for="unite"><?php echo lang('aRequirement_for_Loading'); ?></label>
               <select  placeholder="" id="req_loading" name="req_loading" >
                   <?php
                     if(!isset($edit)){ ?>
                     <option value="0"><?php echo lang('aSelect_Loading'); ?></option>
                  <?php }  ?>
                  <?php                                        
            ...
            <div class="col-sm-4">
               <label for="unite"><?php echo lang('aVehical_Requirement'); ?> </label>
               <select  placeholder="" id="vehical_requirement" name="vehical_requirement" >
                   <?php
                     if(!isset($edit)){ ?>
                     <option value="0"><?php echo lang('aSelect_Vehical_Requirement'); ?></option>
                  <?php }  ?>
                  <?php                                        
            ...
            <div class="col-sm-4">
               <label for="unite"><?php echo lang('aIs_this_Hazardous_material'); ?></label>
             ...
             <div class="col-sm-4" style="<?php echo $is_hazardous_class; ?>" id="div_hazardous_specify">
               <label for="warehouse_location"><?php echo lang('aHazardous_Specify'); ?></label>
               <input type="text" name="hazardous_specify" value="<?php echo $hazardous_specify; ?>" placeholder="<?php echo lang('aHazardous_Specify'); ?>" id="hazardous_specify" autocomplete="off" class="form-control space">
            </div>
                     ...
                     if (isset($edit)) {
                        if(!empty($p_attr))
                        {
                           ...
                           $size_id[]=$p_attr2['item_id'];
                              ...
                              ?>
                  <div class="shattbute" id="<?php echo $p_attr2['item_id']; ?>"><label><?php echo $p_attr2['item_name']; ?></label>

                     <label class="attribute_p">Qty<input type="text" class="form-control" name="attribute_qty[]" value="<?php echo $p_attr2['qty']; ?>" required></label>

                     <label style="display: none" class="attribute_p">Qty<input type="text" class="form-control" name="attribute_id_size[]" value="<?php echo $p_attr2['id_size']; ?>" required></label>

                     <label style="display: none" class="attribute_p">Our Food Price<input type="text" class="form-control" name="attribute_price[]" value="<?php echo $p_attr2['price']; ?>" ></label>
                     <label style="display: none" class="attribute_p">Market  Price<input type="text"  name="attribute_sale_price[]" class="form-control" value="<?php echo $p_attr2['sale_price']; ?>"></label>
                  </div>
                  <?php } } }  
                     ?>
            ...
            <div class="col-sm-12">
               ...
               <input type="hidden" name="product_image" id="file_name" value="<?php echo $product_image; ?>" <?php if(empty($product_image)) echo "required"; ?> >
               <div class="col-25">
                  <div class="col-inner">
                     ...
                     <?php
                        ...
                        <img data-image src="<?php echo $image_url; ?>" style="width: 100px;height: 100px;padding: 10px 0;" />
                     <span id="product_image_hide" class="choose-image"><?php echo "Choose Product Image"; ?></span>
                     </label>
                  </div>
         ...
         <input type="hidden" id="img_url" value="admin/products/" />
         <input type="hidden" id="image_gallery" name="image_gallery" value="<?php echo !empty($image_gallery)? ','.$image_gallery:''; ?>" required />
         <div class="row prepend_img">
            ...
            <div class="col-sm-3">
               <div class="col-inner">
                  <input type="file" id="file" value="<?php //echo $product_image; ?>" accept="image/png, image/gif, image/jpeg"  />
         ...
         <div class="col-sm-12" style="padding: 0px;">
            <button type="submit" class="btn btn-primary"><?php echo lang('aSubmit'); ?></button>
        </div>
...
<style type="text/css">
   ...
   .wizard ul > li, .tabcontrol ul > li{width: auto !important}
   #description{border-bottom: 1px solid #ccc}
   .bootstrap-tagsinput input{font-size: 14px;color: #777;}
