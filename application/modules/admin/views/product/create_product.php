...
<div class="row clearfix">
   <div class="col-md-12">
      <div class="demo-masked-input">
         ...
         <div class="row">
            <div class="col-sm-4">
               <label for="product_name"><?php echo lang('product_name'); ?><span class="required">*</span></label>
               <?php echo $form->bs3_text(lang('product_name'), 'product_name', $product_name, array("autocomplete" => "off","class"=>"space",'onkeypress' => "return alpha(event)"),"","","^[a-zA-Z0-9_ ]*$"); ?>
            </div>
            <div class="col-sm-4">
               <label for="tags"><?php echo lang('aSearch_Tag'); ?></label>
               <?php echo $form->bs3_text(lang('aSearch_Tag'), 'tags', $tags, array("autocomplete" => "off","class"=>"space",'onkeypress' => "return alpha(event)"),"","","^[a-zA-Z0-9_ ]*$"); ?>
            </div>
            <div class="col-sm-4" style="">
               <label for="short_description">
                  <?php echo lang('aPlease_enter_short_description'); ?><span class="required">*</span>
               </label>
               <div class="form-group">
                  <div class="form-line">
                     <input type="text" name="short_description" id="short_description" class="form-control space"
         ...
         <div class="row">
            <div class="col-sm-3">
               <label for="sku_code">
                  <?php echo lang('SKU_Information'); ?><span class="required">*</span>
               </label>
               <div class="form-group form-float form-group-lg">
                  <div class="form-line"><input type="text" name="sku_code" value="<?php echo $sku_code; ?>"
                        placeholder="<?php echo lang('SKU_Information'); ?>" id="sku_code" autocomplete="off"
                        class="form-control space" onkeypress="return isNumberKey(event)">
                  </div>
               </div>
            </div>
            <div class="col-sm-3" style="">
               <label for="brand">
                  <?php echo lang('Brand'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="pro_brand" name="brand">

                  <option value="0">
                     <?php echo lang('aSelect_brand'); ?>
                  </option>
                  <?php
                  if (!empty($brand_data)) {
                     foreach ($brand_data as $bd_key => $bd_valu) {
                        ...
                        ?>
                        <option value="<?php echo $bd_valu['id']; ?>" <?php echo $barnd_selected; ?>><?php echo $bd_valu['brand_name']; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <div class="<?php echo $sel_class; ?> col-sm-3">
               <label for="category">
                  <?php echo lang('aCategory'); ?><span class="required">*</span>
               </label>
               ...
               <select placeholder="" id="shope_sub_category" name="subcategory">
                  ...
                  if (!empty($sub_category)) {
                     foreach ($sub_category as $itkey => $itvalue) {
                        ...
                        ?>
                        <option value="<?php echo $itvalue['id']; ?>" <?php echo $category2; ?>><?php echo $itvalue['display_name']; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <?php if (!empty($supplier_data) && $seller_id == 1) { ?>
               <div class="<?php echo $sel_class; ?>" style="">
                  <label for="category">Select Supplier</label><span class="required">*</span>
            ...
            <?php if (!empty($pcustomize_list)): ?>
               <?php foreach ($pcustomize_list as $ckey => $cvalue):
                  ...
                  <div class="col-sm-6">
                     ...
                     <select multiple id="<?php echo $cvalue['id'] ?>" name="customize_att[]" class="">
                        <?php if (!empty($cvalue['sub_attri'])): ?>
                           <?php foreach ($cvalue['sub_attri'] as $sckey => $scvalue):
                              ...
                              if (in_array($scvalue['id'], $sled_cus_list)) {
                                 if ($cvalue['type'] == 3) { ?>
                                    <option value="<?php echo $cvalue['id'] ?>,<?php echo $scvalue['id']; ?>" selected><?php echo $scvalue['name']; ?>(<?php echo "A-" . $scvalue['price_ad'] . ", B-" . $scvalue['price_bh'] ?>)</option>
                                 <?php } else { ?>
                                    <option value="<?php echo $cvalue['id'] ?>,<?php echo $scvalue['id']; ?>" selected><?php echo $scvalue['name']; ?></option>
                                 <?php } ?>
                              <?php } else {
                                 if ($cvalue['type'] == 3) { ?>
                                    <option value="<?php echo $cvalue['id'] ?>,<?php echo $scvalue['id']; ?>"><?php echo $scvalue['name']; ?> (<?php echo "A-" . $scvalue['price_ad'] . ", B-" . $scvalue['price_bh'] ?>)</option>

                                 <?php } else { ?>
                                    <option value="<?php echo $cvalue['id'] ?>,<?php echo $scvalue['id']; ?>"><?php echo $scvalue['name']; ?></option>
            ...
            <div class="col-sm-6">
               <label for="category">
                  <?php echo lang('aDescription'); ?><span class="required">*</span>
               </label>
               <textarea id="ckeditor10" name="description"><?php echo $description; ?></textarea>
            </div>
            <div class="col-sm-6">
               <label for="specification">
                  <?php echo lang('aSpecification'); ?><span class="required">*</span>
               </label>
               <textarea id="specification" name="specification"><?php echo $specification; ?></textarea>
            </div>
            <div class="col-sm-4">
               <div class="form-group">
                  <label for="groups">
                     <?php echo lang('aStatus'); ?><span class="required">*</span>
                  </label>
                  <div>
                     <?php echo $form->bs3_radio(lang('aActive'), 'status', '1', array('required' => '', 'id' => "radio1"), $status_active); ?>
            ...
            <div class="col-sm-4 "> <!-- hss_price -->
               <label for="unite">
                  <?php echo lang('aProduct_Unite'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="unite" name="unite"> <!-- multiple -->
                  <?php
                  if (!isset($edit)) { ?>
                     <option value="0"> <?php echo lang('select_Product_Unite'); ?></option>
                  <?php } ?>
                  <?php
                  if (!empty($unit_list)) {
                     foreach ($unit_list as $unit_key => $unit_value) {
                        ...
                        ?>
                        <option value="<?php echo $unit_value['id']; ?>" <?php echo $unit_selected; ?>><?php echo $unit_value['unit_name']; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <div class="col-sm-4 "> <!-- hss_price -->
               <label for="category">
                  <?php echo lang('aMarket_Price'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('aMarket_Price'), 'price', $price, array("class" => "space", 'onkeypress' => "return isNumberKey(event)"), "", "14"); ?>
            </div>
            <div class="col-sm-4 " style=""> <!-- hss_price  -->
               <label for="category">
                  <?php echo lang('aOur_Price'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('aOur_Price'), 'sale_price', $sale_price, array("class" => "space", 'onkeypress' => "return isNumberKey(event)"), "", "14"); ?>
            </div>
            <div class="col-sm-4 " style="">
               <label for="category">
                  <?php echo lang('aMin_Order_Quantity'); ?><span class="required">*</span>
               </label>
               <div class="form-group form-float form-group-lg">
                  <div class="form-line">
                     <input maxlength="4" type="text" name="min_order_quantity"
                        value="<?php echo $min_order_quantity; ?>"
                        placeholder="<?php echo lang('aMin_Order_Quantity'); ?>" id="min_order_quantity"
            ...
            <div class="col-sm-4 hs_qty "> <!-- hss_price -->
               <div class="form-group">
                  <label for="groups">
                     <?php echo lang('aStock_Status'); ?><span class="required">*</span>
                  </label>
                  <div>
            ...
            <div class="col-sm-4 hs_qty "> <!-- hss_price -->
               <label for="stock">
                  <?php echo lang('aQuantity_in_Stock'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('aQuantity_in_Stock'), 'stock', $stock, array("autocomplete" => "off", "class" => "space", "onkeypress" => "return isNumberKey(event)"), "", "9"); ?>
            </div>

            <div class="col-sm-4">
               <label for="shipment_by">
                  <?php echo lang('aReady_for_shipment_by'); ?>
               </label>
               <?php echo $form->bs3_text(lang("ship_days"), 'shipment_by', $shipment_by, array("autocomplete" => "off", "class" => "space", "onkeypress" => "return isNumberKey(event)"), "", "12"); ?>
            </div>

            <div class="col-sm-2" style="margin-top: 25px;">
               <div class="form-group">
                  <div>
                     <input type="checkbox" name="is_delivery_available" id="is_delivery_available" value="1"
                        class="with-gap radio-col-green" <?php echo $is_delivery; ?>> <label
                        for="is_delivery_available">
                        <?php echo lang('aDelivery_Available'); ?>
                     </label>
                  </div>
               </div>
            </div>
            <div class="col-sm-2" style="margin-top: 25px;">
               <div class="form-group">
                  <div>
                     ...
                     <input type="checkbox" name="is_sample_order" id="is_sample_order" value="1"
                        class="with-gap radio-col-green" <?php echo $is_sample; ?>> <label for="is_sample_order">
                        <?php echo lang('Sample_Order'); ?>
                     </label>
                  </div>
               </div>
            </div>
            ...
            <div class="col-sm-4">
               <label for="unite">
                  <?php echo lang('aPackaging_Type'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="packaging_type" name="packaging_type">
                  <?php
                  if (!isset($edit)) { ?>
                     <option value="0">
                        <?php echo lang('aselect_Packaging_Type'); ?>
                     </option>
                  <?php } ?>
                  <?php
                  if (!empty($pack_arr)) {
                     foreach ($pack_arr as $pa_key => $pa_value) {
                        ...
                        ?>
                        <option value="<?php echo $pa_value; ?>" <?php echo $pk_selected; ?>><?php echo $pa_value; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <div class="col-sm-2">
               <label for="unite">
                  <?php echo lang('aWeight_Unit'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="weight_unit" name="weight_unit">
                  <?php
                  if (!isset($edit)) { ?>
                     <option value="0">
                        <?php echo lang('aSelect_Weight_Unit'); ?>
                     </option>
                  <?php } ?>
                  <?php
                  if (!empty($weight_unit_arr)) {
                     foreach ($weight_unit_arr as $ha_key => $ha_val) {
                        ...
                        ?>
                        <option value="<?php echo $ha_key; ?>" <?php echo $ha_selected; ?>><?php echo $ha_val; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            <div class="col-sm-2">
               <label for="weight">
                  <?php echo lang('aWeight'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('aWeight'), 'weight', $weight, array("autocomplete" => "off", "class" => "space", "onkeypress" => "return isNumberKey(event)")); ?>
            </div>

            <!-- <div class="col-sm-2">
               <label for="unite"><?php echo lang('aLength_Unit'); ?><span class="required">*</span> </label>
               <select  placeholder="" id="weight_unit" name="weight_unit" >
                   <?php
                   if (!isset($edit)) { ?>
                     <option value="0"><?php echo lang('aSelect_Weight_Unit'); ?></option>
                  <?php } ?>
                  <?php
                  if (!empty($weight_unit_arr)) {
                     foreach ($weight_unit_arr as $ha_key => $ha_val) {
            ...
            <div class="col-sm-4">
               <label for="length">
                  <?php echo lang('alength'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('alength'), 'length', $length, array("autocomplete" => "off", "class" => "space", "onkeypress" => "return isNumberKey(event)"), "", "5"); ?>
            </div>

            <!-- <div class="col-sm-2">
               <label for="unite"><?php echo lang('aWidth_Unit'); ?><span class="required">*</span> </label>
               <select  placeholder="" id="weight_unit" name="weight_unit" >
                   <?php
                   if (!isset($edit)) { ?>
                     <option value="0"><?php echo lang('aSelect_Weight_Unit'); ?></option>
            ...
            <div class="col-sm-4">
               <label for="width">
                  <?php echo lang('awidth'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('awidth'), 'width', $width, array("autocomplete" => "off", "class" => "space", "onkeypress" => "return isNumberKey(event)"), "", "5"); ?>
            </div>

            <!-- <div class="col-sm-2">
               <label for="unite"><?php echo lang('aHeight_Unit'); ?><span class="required">*</span> </label>
               <select  placeholder="" id="weight_unit" name="weight_unit" >
                   <?php
                   if (!isset($edit)) { ?>
                     <option value="0"><?php echo lang('aSelect_Weight_Unit'); ?></option>
            ...
            <div class="col-sm-4">
               <label for="height">
                  <?php echo lang('aheight'); ?><span class="required">*</span>
               </label>
               <?php echo $form->bs3_text(lang('aheight'), 'height', $height, array("autocomplete" => "off", "class" => "space", "onkeypress" => "return isNumberKey(event)"), "", "5"); ?>
            </div>

            <div class="col-sm-4">
               <label for="unite">
                  <?php echo lang('aCity'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="city" name="city">
                  ...
                  if (!empty($city_list)) {
                     foreach ($city_list as $cl_key => $cl_val) {
                        ...
                        ?>
                        <option value="<?php echo $cl_val['city_name']; ?>" <?php echo $city_selected; ?>><?php echo $cl_val['city_name']; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <div class="col-sm-4">
               <label for="warehouse_location">
                  <?php echo lang('aWarehouse_location'); ?>
               </label>
               <input type="text" name="warehouse_location" value="<?php echo $warehouse_location; ?>"
                  placeholder="<?php echo lang('aWarehouse_location'); ?>" id="searchInput" autocomplete="off"
            ...
            <div class="col-sm-4">
               <label for="unite">
                  <?php echo lang('aRequirement_for_Loading'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="req_loading" name="req_loading">
                  <?php
                  if (!isset($edit)) { ?>
                     <option value="0">
                        <?php echo lang('aSelect_Loading'); ?>
                     </option>
                  <?php } ?>
                  <?php
                  if (!empty($req_loading_arr)) {
                     foreach ($req_loading_arr as $rla_key => $rla_val) {
                        ...
                        ?>
                        <option value="<?php echo $rla_val; ?>" <?php echo $req_selected; ?>><?php echo $rla_val; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <div class="col-sm-4">
               <label for="unite">
                  <?php echo lang('aVehical_Requirement'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="vehical_requirement" name="vehical_requirement">
                  <?php
                  if (!isset($edit)) { ?>
                     <option value="0">
                        <?php echo lang('aSelect_Vehical_Requirement'); ?>
                     </option>
                  <?php } ?>
                  <?php
                  if (!empty($vehical_arr)) {
                     foreach ($vehical_arr as $ha_key => $ha_val) {
                        ...
                        ?>
                        <option value="<?php echo $ha_val; ?>" <?php echo $ha_selected; ?>><?php echo $ha_val; ?></option>
                     <?php }
                  } ?>
               </select>
            </div>
            ...
            <div class="col-sm-4">
               <label for="unite">
                  <?php echo lang('aIs_this_Hazardous_material'); ?><span class="required">*</span>
               </label>
               <select placeholder="" id="is_hazardous" name="is_hazardous">
                  <?php
                  if (!isset($edit)) { ?>
                     <option value="0"><?php echo lang('aaaselect_hazardous'); ?></option>
                  <?php } ?>
                  <?php
            ...
            <div class="col-sm-4" style="<?php echo $is_hazardous_class; ?>" id="div_hazardous_specify">
               <label for="warehouse_location">
                  <?php echo lang('aHazardous_Specify'); ?><span class="required">*</span>
               </label>
               <input type="text" name="hazardous_specify" value="<?php echo $hazardous_specify; ?>"
                  placeholder="<?php echo lang('aHazardous_Specify'); ?>" id="hazardous_specify" autocomplete="off"
                  class="form-control space">
            </div>
               ...
               if (isset($edit)) {
                  if (!empty($p_attr)) {
                     foreach ($p_attr as $key => $p_attr2) {
                        ...
                        ?>
                        <div class="shattbute" id="<?php echo $p_attr2['item_id']; ?>"><label>
                              <?php echo $p_attr2['item_name']; ?>
                           </label>

                           <label class="attribute_p">Qty<input type="text" class="form-control" name="attribute_qty[]"
                                 value="<?php echo $p_attr2['qty']; ?>" required></label>

                           <label style="display: none" class="attribute_p">Qty<input type="text" class="form-control"
                                 name="attribute_id_size[]" value="<?php echo $p_attr2['id_size']; ?>" required></label>

                           <label style="display: none" class="attribute_p">Our Food Price<input type="text" class="form-control"
                                 name="attribute_price[]" value="<?php echo $p_attr2['price']; ?>"></label>
                           <label style="display: none" class="attribute_p">Market Price<input type="text"
                                 name="attribute_sale_price[]" class="form-control"
            ...
            <div class="col-sm-12">
               <h5>
                  <?php echo lang('aProduct_Images'); ?><span class="required">*</span>
               </h5>
               <input type="hidden" id="photo_url1"
                  value="<?php echo base_url('admin/file_handling/uploadFiless'); ?>" />
               <input type="hidden" id="img_url" value="admin/products/" />
               <input type="hidden" name="product_image" id="file_name" value="<?php echo $product_image; ?>" <?php if (empty($product_image))
                     echo "required"; ?>>
               <div class="col-25">
                  <div class="col-inner">
                     <input type="file" id="file1" accept="image/png, image/gif, image/jpeg" />
                     <label for="file1" class="file__drop" data-image-uploader1>
                        ...
                        <span id="product_image_hide" class="choose-image">
         ...
         <h5>
            <?php echo lang('aProduct_Images_Gallery'); ?><span class="required">*</span>
         </h5>
         ...
         <input type="hidden" id="image_gallery" name="image_gallery"
            value="<?php echo !empty($image_gallery) ? ',' . $image_gallery : ''; ?>" required />
         <div class="row prepend_img">
            ...
            <div class="col-sm-3">
               <div class="col-inner">
                  <input type="file" id="file" value="<?php //echo $product_image; ?>"
...
<script type="text/javascript">
   $(document).on("change", "#main_category", function () {
      var cat_id = $(this).val();
      <?php $language= $this->uri->segment(1);?>
      if (cat_id != 0) {
         $("#loading").show();
         $.ajax({
            type: 'POST',
            url: "<?php echo base_url().$language .'/admin/product/get_subcategory_data' ; ?>",
            data: { cat_id: cat_id },
