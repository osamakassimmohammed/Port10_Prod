<div class="row">
  <a style="" href="<?php echo base_url('admin/product/csv_dwonload/') ?>" class="btn bg-light-green waves-effect"><span>Download</span></a>
      ...
      <div class="col-sm-3">
         <div class="thumbnail card top_seling_sectn">
            <div class="header pading_top_header header_with_desrctpn">
               <h3 class="p_name_h3">Product <?php echo ' View '.$value['user_view'].' times .'; ?> </h3>
               <p class="p_name"><?php echo $value['product_name']; ?></p>
               <div class="clear"></div>
            </div>            
            <a href="<?Php echo base_url().$pro_url.$value['id']; ?>"><img class="images top_seling_img" src="<?php echo $image_url; ?>"></a>
         </div>
      </div>
   <?php } }else{
