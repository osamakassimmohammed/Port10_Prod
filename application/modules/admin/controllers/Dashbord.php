...
class Dashbord extends Admin_Controller
{
	...
	public function supplier_manual()
	{
		$this->load->view('supplier-manual');
	}

	public function supplier_manual_arbic()
	{
		$language = $this->uri->segment(1);
		$this->load->view('arabic-supplier-manual', $language);
	}
