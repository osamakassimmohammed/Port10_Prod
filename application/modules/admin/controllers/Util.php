...
class Util extends Admin_Controller
{
    ...
    public function restore_db($file)
    {
        ...
        if ($file == 'latest')
            ...
            $path = FCPATH . 'assets/sql/backup/' . $file;
