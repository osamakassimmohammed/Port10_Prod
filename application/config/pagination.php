...
$config['next_tag_open'] = '<li class="page-item">';            // default: '<div>'
$config['next_tag_close'] = '</li>';            // default: '</div>'

// Customizing the "Previous" Link
$config['prev_link'] = '&lt;';            // default: '&lt;'
$config['prev_tag_open'] = '<li class="page-item">';            // default: '<div>'
$config['prev_tag_close'] = '</li>';            // default: '</div>'

// Customizing the "Current Page" Link
$config['cur_tag_open'] = '<li class="page-item active"><a class="page-link" href="#" onclick="return false;">';    // default: '<b>'
$config['cur_tag_close'] = '</a></li>';        // default: '</b>'

// Customizing the "Digit" Link
$config['num_tag_open'] = '<li class="page-item">';            // default: '<div>'
