      ...
      <div class="container">
         <section class="small-section border-section border-top-0">
            <div class="row">
               ...
               <div class="col-lg-6">
                  <form action="" class="form-inline subscribe-form auth-form needs-validation" method="post" id="subscribe_form">
               ...
               <div class="sub-title">
                  ...
                  <div class="footer-contant">
                     <ul>
                        ...
                        <li><a href="<?php echo base_url($language.'/page/index/terms-of-service') ?>">Terms Of Service</a></li>
               ...
               <div class="sub-title">
                  ...
                  <div class="footer-contant">
                     <ul>
                        ...
                        <li><a href="<?php echo base_url($language.'/home/listing/70') ?>">Construction & Commercial Equipment</a></li>
                        <li><a href="<?php echo base_url($language.'/home/listing/82') ?>"> Metals, Chemicals & Raw Materials</a></li>
                        <li><a href="<?php echo base_url($language.'/home/listing/99') ?>"> Paper and Packaging</a></li>
                        <li><a href="<?php echo base_url($language.'/home/listing/110') ?>"> Automotive  -  Support  Resources</a></li>
            ...
            <div class="col">
               ...
               <div class="sub-title">
                  ...
                  <div class="footer-contant">
                     <ul class="contact-list">
                        <li><i class="fa fa-map-marker"></i><?php echo @$footer_content[0]['location']; ?>
                        </li>
                        <li><i class="fa fa-phone"></i>Call Us: <a href="tel:<?php echo @$footer_content[0]['mobile_no']; ?>"><?php echo @$footer_content[0]['mobile_no']; ?></a></li>
                        <li><i class="fa fa-envelope-o"></i>Email Us: <a href="mailto:<?php echo @$footer_content[0]['email_id']; ?>"><?php echo @$footer_content[0]['email_id']; ?></a></li>                        
                     </ul>
                  </div>
               </div>
            </div>
             ...
             <div class="col">
              ...
              <div class=" footer_socl_logo">
               ...
               <div class="footer-contant">
                  <div class="footer-logo"><img src="http://port10.persausive.in/assets/frontend/images/icon/foot_logo.png" alt=""></div>
                  <p>                  </p>
         ...
         <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12">
               <div class="footer-end">
                  <p><i class="fa fa-copyright" aria-hidden="true"></i> 2021 All rights reserved <a href="<?php echo base_url($language.'/page/index/privacy-policy') ?>" >Privacy Policy</a> <a href="<?php echo base_url($language.'/page/index/terms-of-service') ?>">Terms and Conditions</a>
                  </p>
               </div>
            </div>
            <div class="col-xl-6 col-md-6 col-sm-12">
               <div class="payment-card-bottom">
                  <p><span>CR Number :<?php echo @$footer_content[0]['cr_number']; ?></span>  <span>VAT Number :<?php echo @$footer_content[0]['vat_number']; ?></span></p>    
               </div>
            </div>
         </div>
      </div>
                  ...
                  <div class="col-12">
                     <div class="modal-bg">
                        ...
                        <div class="offer-content">
                           ...
                           <h2>newsletter</h2>
                           <form action="" class="auth-form needs-validation" method="post"
                              id="">
                              <div class="form-group mx-sm-3">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <div class="form_wrap_qutn">
                ...
                <div class="signl_form">
                  <div class="singl_label"> Google location <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="In case of delivery to specific destination, enter coordinates."></i> </div>
                ...
                <div class="signl_form signl_form_full">
                  ...
                  <textarea class="singl_input_qutn" rows="5" style="height: auto;" id="qinformation" name="information" ></textarea>
                </div>
