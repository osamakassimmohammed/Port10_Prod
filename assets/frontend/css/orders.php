      ...
      <div class="row">
         ...
         <div class="col-sm-6">
            <nav aria-label="breadcrumb" class="theme-breadcrumb">
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo base_url($language) ?>">Home</a></li>
               ...
               <table class="table cart-table table-responsive-xs ">
                  <thead>
                     <tr class="table-head">
                        ...
                        <th scope="col" class="th_crt5">Transaction <br> Reference</th>
                     ...
                     <tr class="remove_prom1m7">
                        <td class="th_crt2">
                           <div class="img_sec_lft">
                              <a href="<?php echo base_url($language.'/home/detail/').$oi_val['product_id']; ?>"><img src="<?php echo base_url('assets/admin/products/').$oi_val['product_image']; ?>" alt=""></a>   
                              <div class="clear"></div>
                              
                           </div>
                           <div class="nme_sec_right">
                              <a class="prdct_name_cart" href="<?php echo base_url($language.'/home/detail/').$oi_val['product_id']; ?>"> <span> <?php echo $oi_val['product_name']; ?> </span> </a>
                           </div>
                        </td>

                        <td  class="th_crt4"> <h2 class="date_a" ><?php echo date('d - M - Y' ,strtotime($oi_val['created_date'])); ?></h2> </td>
                        ...
                        <td class="th_crt5">
                           <h2> <a href="<?php echo base_url($language.'/order/reorder/').$oi_val['item_id']; ?>" class="invoic reorder_btn" > Reorder </a> </h2>
                        </td>

                        <td class="th_crt5">
                           <h2> <a href="<?php echo base_url($language.'/home/detail/').$oi_val['product_id']; ?>" class="invoic" > Write Review </a> </h2>
                        </td>

                        <td class="th_crt5">
                           <h2> <a href="<?php echo base_url('invoice/product/').$oi_val['item_id']; ?>" class="invoic" > Invoice </a> </h2>
                        </td>
                     </tr>
                     <?php } ?>
