<?php
	...
	$this->set_css($this->default_theme_path.'/datatables/jquery-datatable/dataTables.bootstrap.css');
...
<?php 
	...
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/jquery.dataTables.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/dataTables.bootstrap.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/dataTables.buttons.min.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/buttons.flash.min.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/jszip.min.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/pdfmake.min.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/vfs_fonts.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/buttons.html5.min.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/extensions/buttons.print.min.js');
	$this->set_js($this->default_theme_path.'/datatables/jquery-datatable/jquery-datatable.js');
	 ?>